...
#dialog-close {
  ...
  ${d}
  `,o.prepend(u),o.appendChild(e),o.appendChild(n),o},f=s=>{const t=document.querySelector(s),{left:e,top:n,right:i,bottom:r}=t.getBoundingClientRect();let o="left",u="top",h=i+50,p=n;return window.innerWidth-i<400&&(o="right",h=window.innerWidth-e+50),window.innerHeight-n<300&&(u="bottom",p=r),{x:h,y:p,positionX:o,positionY:u}},y={immdiate:!1,force:!1};class a extends HTMLElement{constructor(t){super(),this.handler=t;const e=b(t),n=this.attachShadow({mode:"closed"});n.appendChild(e),this.root=n}changeVisiable(t){t.visible?this.style.display="block":this.style.display="none"}changeDialog(t,e){const{x:n,y:i,positionX:r,positionY:o}=f(t.step.el);e.style.top=null,e.style.bottom=null,e.style.left=null,e.style.right=null,e.style[r]=n+"px",e.style[o]=i+"px"}changeContent(t,e){const n=e.querySelector(".title"),i=e.querySelector(".content");n.innerHTML=t.step.title,i.innerHTML=t.step.content}changeButton(t,e){const n=e.querySelector("#prev"),i=e.querySelector("#next");t.index===0?n.setAttribute("disabled","disabled"):n.removeAttribute("disabled"),t.index===this.handler.guids.length-1?i.innerHTML="\u5173\u95ED":i.innerHTML="\u4E0B\u4E00\u6B65"}saveSnapAndChange(t){const e=document.querySelector(t.step.el);this.snap={el:t.step.el,style:e.style.border},e.style.border="2px solid red"}restoreSnap(){var e;const t=document.querySelector((e=this.snap)==null?void 0:e.el);t&&(t.style.border=this.snap.style)}render(t){var n,i;if((i=(n=globalThis==null?void 0:globalThis.process)==null?void 0:n.env)!=null&&i.TEST)return;this.saveSnapAndChange(t),this.changeVisiable(t);const e=this.root.querySelector("#dialog");this.changeDialog(t,e),this.changeContent(t,e),this.changeButton(t,e)}}window.customElements.get("young-beginner-guid")||window.customElements.define("young-beginner-guid",a);class x{constructor(t,e={}){this.index=0,this.immdiate=!1,this.force=!1,this.guids=t,e=Object.assign(y,e),this.immdiate=e.immdiate,this.force=e.force,this.el=new a(this),window.addEventListener("load",()=>{this.immdiate&&this.show()})}show(t=0,e=!0){this.el.isConnected||document.body.appendChild(this.el),this.index=t,this.el.restoreSnap(),this.el.render({visible:e,index:t,step:this.guids[t]})}next(){this.index<this.guids.length-1&&(this.index++,this.show(this.index))}prev(){this.index>0&&(this.index--,this.show(this.index))}hide(){this.show(this.index,!1),this.el.restoreSnap()}destory(){this.index=0,document.body.removeChild(this.el),this.el.restoreSnap()}}l.YoungBeginnerGuid=a,l.YoungBeginnerGuidController=x,Object.defineProperties(l,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
