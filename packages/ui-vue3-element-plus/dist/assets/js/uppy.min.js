...
exports.Compressor = exports.Box = exports.BasePlugin = exports.AwsS3Multipart = exports.AwsS3 = exports.Audio = void 0;
exports.Core = HM;
exports.views = exports.server = exports.locales = exports.debugLogger = exports.Zoom = exports.XHRUpload = exports.Webcam = exports.Url = exports.Uppy = exports.Unsplash = exports.UIPlugin = exports.Tus = exports.Transloadit = exports.ThumbnailGenerator = exports.StatusBar = exports.ScreenCapture = exports.RemoteSources = exports.ReduxStore = exports.ReduxDevTools = exports.ProgressBar = exports.OneDrive = exports.Instagram = exports.Informer = exports.ImageEditor = exports.GooglePhotos = exports.GoogleDrive = exports.GoldenRetriever = exports.Form = exports.FileInput = exports.Facebook = exports.Dropbox = exports.DropTarget = exports.DragDrop = exports.DefaultStore = exports.Dashboard = void 0;
...
var ve = (i, e) => () => (e || i((e = {
  ...
  vc = (i, e) => {
    for (var t in e) zl(i, t, {
      get: e[t],
      enumerable: !0
    });
  },
  x1 = (i, e, t, r) => {
    if (e && typeof e == "object" || typeof e == "function") for (let s of S1(e)) !_1.call(i, s) && s !== t && zl(i, s, {
      get: () => e[s],
      enumerable: !(r = w1(e, s)) || r.enumerable
    });
    return i;
  };
var be = (i, e, t) => (t = i != null ? b1(P1(i)) : {}, x1(e || !i || !i.__esModule ? zl(t, "default", {
  value: i,
  enumerable: !0
}) : t, i));
var bc = ve((PE, Hf) => {
  Hf.exports = o(function () {
    var e = {},
      t = e._fns = {};
    e.emit = o(function (a, u, l, h, d, p, y) {
      var b = r(a);
      b.length && s(a, b, [u, l, h, d, p, y]);
    }, "emit"), e.on = o(function (a, u) {
      t[a] || (t[a] = []), t[a].push(u);
    }, "on"), e.once = o(function (a, u) {
      function l() {
        u.apply(this, arguments), e.off(a, l);
      }
      o(l, "one"), this.on(a, l);
    }, "once"), e.off = o(function (a, u) {
      var l = [];
      if (a && u) {
        var h = this._fns[a],
          d = 0,
          p = h ? h.length : 0;
        for (d; d < p; d++) h[d] !== u && l.push(h[d]);
      }
    ...
    function r(n) {
      ...
      for (d; d < p; d++) {
        var y = h[d];
        if (y === "*" && (a = a.concat(t[y])), l.length === 2 && l[0] === y) {
          a = a.concat(t[y]);
          break;
        }
      }
...
var Vf = ve((CE, qf) => {
  var R1 = typeof global == "object" && global && global.Object === Object && global;
  qf.exports = R1;
});
var wc = ve((AE, Wf) => {
  var k1 = Vf(),
...
var rm = ve((NE, im) => {
  var em = Sc(),
    tm = Object.prototype,
    q1 = tm.hasOwnProperty,
    V1 = tm.toString,
    pn = em ? em.toStringTag : void 0;
  function W1(i) {
    var e = q1.call(i, pn),
      t = i[pn];
    try {
    ...
    var s = V1.call(i);
    return r && (e ? i[pn] = t : delete i[pn]), s;
  }
  o(W1, "getRawTag");
  im.exports = W1;
});
...
var um = ve((zE, lm) => {
  ...
  function ew(i) {
    return i == null ? i === void 0 ? Z1 : J1 : am && am in Object(i) ? Y1(i) : Q1(i);
  }
  o(ew, "baseGetTag");
  lm.exports = ew;
});
...
var ym = ve((GE, gm) => {
  ...
  function dw(i) {
    ...
    i = nw(i);
    var t = uw.test(i);
    return t || cw.test(i) ? hw(i.slice(2), t ? 2 : 8) : lw.test(i) ? mm : +i;
  }
  o(dw, "toNumber");
  gm.exports = dw;
});
var _c = ve((XE, bm) => {
  ...
  function yw(i, e, t) {
    ...
    e = vm(e) || 0, pw(t) && (d = !!t.leading, p = "maxWait" in t, n = p ? mw(vm(t.maxWait) || 0, e) : n, y = "trailing" in t ? !!t.trailing : y);
    function b(q) {
      var G = r,
        te = s;
    ...
    o(b, "invokeFunc");
    function S(q) {
      return h = q, u = setTimeout(_, e), d ? b(q) : a;
    }
    o(S, "leadingEdge");
    function T(q) {
      var G = q - l,
        te = q - h,
        re = e - G;
      return p ? gw(re, n - te) : re;
    }
    o(T, "remainingWait");
    function O(q) {
      var G = q - l,
        te = q - h;
      return l === void 0 || G >= e || G < 0 || p && te >= n;
    }
    o(O, "shouldInvoke");
    function _() {
      var q = Pc();
    ...
    function K() {
      ...
      if (r = arguments, s = this, l = q, G) {
        ...
        if (p) return clearTimeout(u), u = setTimeout(_, e), b(l);
      }
      return u === void 0 && (u = setTimeout(_, e)), a;
    }
...
var ql = ve((QE, wm) => {
  ...
  function Sw(i, e, t) {
    ...
    return bw(t) && (r = "leading" in t ? !!t.leading : r, s = "trailing" in t ? !!t.trailing : s), vw(i, e, {
      leading: r,
      maxWait: e,
      trailing: s
    });
...
var Cm = ve((S3, Om) => {
  ...
  o(Em, "WildcardMatcher");
  Em.prototype.match = function (i) {
    var e = !0,
      t = this.parts,
      r,
      s = t.length,
    ...
    if (typeof i == "string" || i instanceof String) {
      if (!this.hasWild && this.text != i) e = !1;else {
        for (n = (i || "").split(this.separator), r = 0; e && r < s; r++) t[r] !== "*" && (r < n.length ? e = t[r] === n[r] : e = !1);
        e = e && n;
      }
    } else if (typeof i.splice == "function") for (e = [], r = i.length; r--;) this.match(i[r]) && (e[e.length] = i[r]);else if (typeof i == "object") {
      e = {};
...
var sg = ve((dO, rg) => {
  ...
  _i.prototype.retry = function (i) {
    ...
    if (t === void 0) if (this._cachedTimeouts) this._errors.splice(0, this._errors.length - 1), t = this._cachedTimeouts.slice(-1);else return !1;
    var r = this;
  ...
  _i.prototype.attempt = function (i, e) {
  ...
  _i.prototype.try = function (i) {
    console.log("Using RetryOperation.try() is deprecated"), this.attempt(i);
  };
  _i.prototype.start = function (i) {
    console.log("Using RetryOperation.start() is deprecated"), this.attempt(i);
  };
  _i.prototype.start = _i.prototype.try;
  _i.prototype.errors = function () {
    return this._errors;
  };
  _i.prototype.attempts = function () {
    return this._attempts;
  };
  _i.prototype.mainError = function () {
  ...
  _s.wrap = function (i, e, t) {
    ...
    for (var s = 0; s < t.length; s++) {
      var n = t[s],
        a = i[n];
      i[n] = o(function (l) {
        var h = _s.operation(e),
          d = Array.prototype.slice.call(arguments, 1),
          p = d.pop();
        d.push(function (y) {
          h.retry(y) || (y && (arguments[0] = h.mainError()), p.apply(this, arguments));
        }), h.attempt(function () {
          l.apply(i, d);
        });
...
var Sg = ve((uC, Gc) => {
  ...
  function Dn() {}
  o(Dn, "Events");
  Object.create && (Dn.prototype = Object.create(null), new Dn().__proto__ || (Nt = !1));
  function xS(i, e, t) {
  ...
  Lt.prototype.eventNames = o(function () {
    ...
    for (r in t = this._events) _S.call(t, r) && e.push(Nt ? r.slice(1) : r);
  ...
  Lt.prototype.emit = o(function (e, t, r, s, n, a) {
    ...
    if (l.fn) {
      ...
      for (p = 1, d = new Array(h - 1); p < h; p++) d[p - 1] = arguments[p];
      l.fn.apply(l.context, d);
    } else {
      var y = l.length,
        b;
      for (p = 0; p < y; p++) switch (l[p].once && this.removeListener(e, l[p].fn, void 0, !0), h) {
        case 1:
        ...
        case 2:
          ...
          break;
        case 3:
          l[p].fn.call(l[p].context, t, r);
          break;
        case 4:
          l[p].fn.call(l[p].context, t, r, s);
          break;
        default:
          if (!d) for (b = 1, d = new Array(h - 1); b < h; b++) d[b - 1] = arguments[b];
          l[p].fn.apply(l[p].context, d);
      }
    }
    return !0;
  }, "emit");
  ...
  Lt.prototype.removeListener = o(function (e, t, r, s) {
    ...
    if (!t) return nu(this, n), this;
    var a = this._events[n];
    if (a.fn) a.fn === t && (!s || a.once) && (!r || a.context === r) && nu(this, n);else {
      for (var u = 0, l = [], h = a.length; u < h; u++) (a[u].fn !== t || s && !a[u].once || r && a[u].context !== r) && l.push(a[u]);
      l.length ? this._events[n] = l.length === 1 ? l[0] : l : nu(this, n);
    }
    return this;
  }, "removeListener");
  Lt.prototype.removeAllListeners = o(function (e) {
    var t;
    return e ? (t = Nt ? Nt + e : e, this._events[t] && nu(this, t)) : (this._events = new Dn(), this._eventsCount = 0), this;
  }, "removeAllListeners");
  Lt.prototype.off = Lt.prototype.removeListener;
  Lt.prototype.addListener = Lt.prototype.on;
  Lt.prefixed = Nt;
  Lt.EventEmitter = Lt;
  typeof Gc < "u" && (Gc.exports = Lt);
});
var li = ve((HC, vu) => {
  (function () {
    "use strict";
    ...
    function e() {
      for (var t = [], r = 0; r < arguments.length; r++) {
        ...
        if (s) {
          var n = typeof s;
          if (n === "string" || n === "number") t.push(s);else if (Array.isArray(s)) {
            if (s.length) {
              var a = e.apply(null, s);
              a && t.push(a);
            }
          } else if (n === "object") if (s.toString === Object.prototype.toString) for (var u in s) i.call(s, u) && s[u] && t.push(u);else t.push(s.toString());
        }
      }
      return t.join(" ");
    }
    o(e, "classNames"), typeof vu < "u" && vu.exports ? (e.default = e, vu.exports = e) : typeof define == "function" && typeof define.amd == "object" && define.amd ? define("classnames", [], function () {
      return e;
    }) : window.classNames = e;
  })();
});
var Ly = ve((Q4, Iy) => {
  Iy.exports = o(function (e, t) {
    if (e === t) return !0;
...
var av = ve((pd, fd) => {
  (function (i, e) {
    typeof pd == "object" && typeof fd < "u" ? fd.exports = e() : typeof define == "function" && define.amd ? define(e) : (i = i || self, i.Cropper = e());
  })(pd, function () {
    "use strict";
    ...
    function i(v) {
      ...
      return typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? i = o(function (f) {
        return typeof f;
      }, "_typeof") : i = o(function (f) {
    ...
    function r(v, f, g) {
      return f && t(v.prototype, f), g && t(v, g), v;
    }
    o(r, "_createClass");
    function s(v, f, g) {
      return f in v ? Object.defineProperty(v, f, {
        value: g,
        enumerable: !0,
        configurable: !0,
        writable: !0
    ...
    function a(v) {
      for (var f = 1; f < arguments.length; f++) {
        ...
        f % 2 ? n(Object(g), !0).forEach(function (m) {
          s(v, m, g[m]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(v, Object.getOwnPropertyDescriptors(g)) : n(Object(g)).forEach(function (m) {
    ...
    function d(v, f) {
      if (v) {
        if (typeof v == "string") return p(v, f);
        ...
        if (g === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(g)) return p(v, f);
      }
    }
    o(d, "_unsupportedIterableToArray");
    function p(v, f) {
      (f == null || f > v.length) && (f = v.length);
      for (var g = 0, m = new Array(f); g < f; g++) m[g] = v[g];
      return m;
    }
    o(p, "_arrayLikeToArray");
    function y() {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var b = typeof window < "u" && typeof window.document < "u",
      S = b ? window : {},
      T = b && S.document.documentElement ? "ontouchstart" in S.document.documentElement : !1,
      ...
      cs = "zoom",
      jr = "image/jpeg",
      hs = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/,
      ds = /^data:/,
      ps = /^data:image\/jpeg;base64,/,
      zr = /^img|canvas$/i,
      lt = {
        viewMode: 0,
        dragMode: A,
    ...
    function sr(v) {
      ...
      try {
        var f = v.constructor,
          g = f.prototype;
        return f && g && Dl.call(g, "isPrototypeOf");
      } catch {
        return !1;
      }
    }
    ...
    function Ll(v) {
      return Array.from ? Array.from(v) : Il.call(v);
    }
    o(Ll, "toArray");
    function Ve(v, f) {
      return v && St(f) && (Array.isArray(v) || he(v.length) ? Ll(v).forEach(function (g, m) {
        f.call(v, g, m, v);
      }) : $i(v) && Object.keys(v).forEach(function (g) {
        f.call(v, v[g], g, v);
      })), v;
    }
    o(Ve, "forEach");
    var Ae = Object.assign || o(function (f) {
        for (var g = arguments.length, m = new Array(g > 1 ? g - 1 : 0), x = 1; x < g; x++) m[x - 1] = arguments[x];
        return $i(f) && m.length > 0 && m.forEach(function (w) {
          $i(w) && Object.keys(w).forEach(function (F) {
            f[F] = w[F];
          });
        }), f;
      }, "assign"),
      fc = /\.\d*(?:0|9){12}\d*$/;
    function qi(v) {
      var f = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1e11;
      return fc.test(v) ? Math.round(v * f) / f : v;
    }
    o(qi, "normalizeDecimalNumber");
    var Nl = /^width|height|left|top|marginLeft|marginTop$/;
    function Ci(v, f) {
      var g = v.style;
      Ve(f, function (m, x) {
        Nl.test(x) && he(m) && (m = "".concat(m, "px")), g[x] = m;
      });
    }
    o(Ci, "setStyle");
    function an(v, f) {
      return v.classList ? v.classList.contains(f) : v.className.indexOf(f) > -1;
    }
    o(an, "hasClass");
    function We(v, f) {
      if (f) {
        ...
        g ? g.indexOf(f) < 0 && (v.className = "".concat(g, " ").concat(f)) : v.className = f;
      }
    }
    o(We, "addClass");
    function ti(v, f) {
      if (f) {
        ...
        if (v.classList) {
          v.classList.remove(f);
          return;
        }
        v.className.indexOf(f) >= 0 && (v.className = v.className.replace(f, ""));
      }
    }
    o(ti, "removeClass");
    function or(v, f, g) {
    ...
    var Ml = /([a-z\d])([A-Z])/g;
    function Fo(v) {
      return v.replace(Ml, "$1-$2").toLowerCase();
    }
    o(Fo, "toParamCase");
    function Eo(v, f) {
      return $i(v[f]) ? v[f] : v.dataset ? v.dataset[f] : v.getAttribute("data-".concat(Fo(f)));
    }
    o(Eo, "getData");
    function Oo(v, f, g) {
      $i(g) ? v[f] = g : v.dataset ? v.dataset[f] = g : v.setAttribute("data-".concat(Fo(f)), g);
    }
    o(Oo, "setData");
    function fs(v, f) {
      if ($i(v[f])) try {
        ...
        v.dataset[f] = void 0;
      } else v.removeAttribute("data-".concat(Fo(f)));
    }
    o(fs, "removeData");
    var ln = /\s\s*/,
      un = function () {
    ...
    function gt(v, f, g) {
      var m = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {},
        x = g;
      f.trim().split(ln).forEach(function (w) {
        if (!un) {
          var F = v.listeners;
          F && F[w] && F[w][g] && (x = F[w][g], delete F[w][g], Object.keys(F[w]).length === 0 && delete F[w], Object.keys(F).length === 0 && delete v.listeners);
        }
      ...
      f.trim().split(ln).forEach(function (w) {
        if (m.once && !un) {
          ...
          x = o(function () {
            ...
            for (var j = arguments.length, M = new Array(j), I = 0; I < j; I++) M[I] = arguments[I];
            g.apply(v, M);
          }, "handler"), U[w] || (U[w] = {}), U[w][g] && v.removeEventListener(w, U[w][g], m), U[w][g] = x, v.listeners = U;
        }
    ...
    function wi(v, f, g) {
      var m;
      return St(Event) && St(CustomEvent) ? m = new CustomEvent(f, {
        detail: g,
        bubbles: !0,
        cancelable: !0
      }) : (m = document.createEvent("CustomEvent"), m.initCustomEvent(f, !0, !0, g)), v.dispatchEvent(m);
    }
    o(wi, "dispatchEvent");
    function Rf(v) {
      var f = v.getBoundingClientRect();
      return {
        left: f.left + (window.pageXOffset - document.documentElement.clientLeft),
    ...
    function kf(v) {
      var f = v.match(Z0);
      return f !== null && (f[1] !== mc.protocol || f[2] !== mc.hostname || f[3] !== mc.port);
    }
    o(kf, "isCrossOriginURL");
    function Uf(v) {
      var f = "timestamp=".concat(new Date().getTime());
      return v + (v.indexOf("?") === -1 ? "?" : "&") + f;
    }
    o(Uf, "addTimestamp");
    function cn(v) {
      var f = v.rotate,
        ...
        w = v.translateY,
        F = [];
      he(x) && x !== 0 && F.push("translateX(".concat(x, "px)")), he(w) && w !== 0 && F.push("translateY(".concat(w, "px)")), he(f) && f !== 0 && F.push("rotate(".concat(f, "deg)")), he(g) && g !== 1 && F.push("scaleX(".concat(g, ")")), he(m) && m !== 1 && F.push("scaleY(".concat(m, ")"));
    ...
    function e1(v) {
      var f = a({}, v),
        g = [];
      return Ve(v, function (m, x) {
        delete f[x], Ve(f, function (w) {
    ...
    function Hr(v) {
      var f = v.aspectRatio,
        g = v.height,
        m = v.width,
        x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "contain",
        w = nn(m),
        F = nn(g);
      if (w && F) {
        var U = g * f;
        x === "contain" && U > m || x === "cover" && U < m ? g = m / f : m = g * f;
      } else w ? g = m / f : F && (m = g * f);
      return {
        width: m,
        height: g
      };
    }
    o(Hr, "getAdjustedSizes");
    function i1(v) {
      var f = v.width,
        g = v.height,
        m = v.degree;
    ...
    function r1(v, f, g, m) {
      var x = f.aspectRatio,
        ...
        gc = Math.min(ys.width, Math.max(jl.width, fe)),
        yc = Math.min(ys.height, Math.max(jl.height, De)),
        Lf = Hr({
          aspectRatio: x,
          width: xe,
          height: Si
        ...
        Mf = Math.min(Lf.width, Math.max(Nf.width, w)),
        Bf = Math.min(Lf.height, Math.max(Nf.height, F)),
        y1 = [-Mf / 2, -Bf / 2, Mf, Bf];
      return Vi.width = qi(gc), Vi.height = qi(yc), Kt.fillStyle = ut, Kt.fillRect(0, 0, gc, yc), Kt.save(), Kt.translate(gc / 2, yc / 2), Kt.rotate(V * Math.PI / 180), Kt.scale(M, H), Kt.imageSmoothingEnabled = st, Kt.imageSmoothingQuality = ii, Kt.drawImage.apply(Kt, [v].concat(u(y1.map(function (v1) {
        return Math.floor(qi(v1));
      })))), Kt.restore(), Vi;
    }
    ...
    function s1(v, f, g) {
      var m = "";
      g += f;
      for (var x = f; x < g; x += 1) m += Df(v.getUint8(x));
      return m;
    }
    ...
    function n1(v) {
      var f = v.replace(o1, ""),
        ...
        x = new Uint8Array(m);
      return Ve(x, function (w, F) {
        x[F] = g.charCodeAt(F);
      }), m;
    }
    o(n1, "dataURLToArrayBuffer");
    function a1(v, f) {
      for (var g = [], m = 8192, x = new Uint8Array(v); x.length > 0;) g.push(Df.apply(null, Ll(x.subarray(0, m)))), x = x.subarray(m);
      return "data:".concat(f, ";base64,").concat(btoa(g.join("")));
    }
    o(a1, "arrayBufferToDataURL");
    function l1(v) {
      var f = new DataView(v),
        g;
      try {
        var m, x, w;
        if (f.getUint8(0) === 255 && f.getUint8(1) === 216) for (var F = f.byteLength, U = 2; U + 1 < F;) {
          if (f.getUint8(U) === 255 && f.getUint8(U + 1) === 225) {
            x = U;
            break;
          }
          U += 1;
        ...
        if (x) {
          ...
          if (s1(f, V, 4) === "Exif") {
            var M = f.getUint16(j);
            if (m = M === 18761, (m || M === 19789) && f.getUint16(j + 2, m) === 42) {
              var I = f.getUint32(j + 4, m);
              I >= 8 && (w = j + I);
            }
          }
        }
        if (w) {
          var H = f.getUint16(w, m),
            ye,
            fe;
          for (fe = 0; fe < H; fe += 1) if (ye = w + fe * 12 + 2, f.getUint16(ye, m) === 274) {
            ye += 8, g = f.getUint16(ye, m), f.setUint16(ye, 1, m);
            break;
          }
        }
      } catch {
    ...
    var c1 = {
        ...
        initContainer: o(function () {
          ...
          this.containerData = w, Ci(x, {
            width: w.width,
            height: w.height
          }), We(f, C), ti(x, C);
        }, "initContainer"),
        initCanvas: o(function () {
          var f = this.containerData,
            g = this.imageData,
            ...
            V = f.width,
            j = f.height;
          f.height * U > f.width ? m === 3 ? V = f.height * U : j = f.width / U : m === 3 ? j = f.width / U : V = f.height * U;
          var M = {
            aspectRatio: U,
            naturalWidth: w,
            naturalHeight: F,
          ...
          M.left = (f.width - V) / 2, M.top = (f.height - j) / 2, M.oldLeft = M.left, M.oldTop = M.top, this.canvasData = M, this.limited = m === 1 || m === 2, this.limitCanvas(!0, !0), this.initialImageData = Ae({}, g), this.initialCanvasData = Ae({}, M);
        }, "initCanvas"),
        limitCanvas: o(function (f, g) {
          var m = this.options,
          ...
          if (f) {
            ...
            U > 1 ? (M = Math.max(M, x.width), I = Math.max(I, x.height), U === 3 && (I * V > M ? M = I * V : I = M / V)) : U > 0 && (M ? M = Math.max(M, j ? F.width : 0) : I ? I = Math.max(I, j ? F.height : 0) : j && (M = F.width, I = F.height, I * V > M ? M = I * V : I = M / V));
            var H = Hr({
              aspectRatio: V,
              width: M,
              height: I
            });
            M = H.width, I = H.height, w.minWidth = M, w.minHeight = I, w.maxWidth = 1 / 0, w.maxHeight = 1 / 0;
          }
          if (g) if (U > (j ? 0 : 1)) {
            var ye = x.width - w.width,
              fe = x.height - w.height;
            w.minLeft = Math.min(0, ye), w.minTop = Math.min(0, fe), w.maxLeft = Math.max(0, ye), w.maxTop = Math.max(0, fe), j && this.limited && (w.minLeft = Math.min(F.left, F.left + (F.width - w.width)), w.minTop = Math.min(F.top, F.top + (F.height - w.height)), w.maxLeft = F.left, w.maxTop = F.top, U === 2 && (w.width >= x.width && (w.minLeft = Math.min(0, ye), w.maxLeft = Math.max(0, ye)), w.height >= x.height && (w.minTop = Math.min(0, fe), w.maxTop = Math.max(0, fe))));
          } else w.minLeft = -w.width, w.minTop = -w.height, w.maxLeft = x.width, w.maxTop = x.height;
        }, "limitCanvas"),
        renderCanvas: o(function (f, g) {
          ...
          if (g) {
            ...
            m.left -= (V - m.width) / 2, m.top -= (j - m.height) / 2, m.width = V, m.height = j, m.aspectRatio = F / U, m.naturalWidth = F, m.naturalHeight = U, this.limitCanvas(!0, !1);
          }
        ...
        initCropBox: o(function () {
          var f = this.options,
            g = this.canvasData,
            m = f.aspectRatio || f.initialAspectRatio,
            x = Number(f.autoCropArea) || .8,
            w = {
              width: g.width,
              height: g.height
            };
          m && (g.height * m > g.width ? w.height = w.width / m : w.width = w.height * m), this.cropBoxData = w, this.limitCropBox(!0, !0), w.width = Math.min(Math.max(w.width, w.minWidth), w.maxWidth), w.height = Math.min(Math.max(w.height, w.minHeight), w.maxHeight), w.width = Math.max(w.minWidth, w.width * x), w.height = Math.max(w.minHeight, w.height * x), w.left = g.left + (g.width - w.width) / 2, w.top = g.top + (g.height - w.height) / 2, w.oldLeft = w.left, w.oldTop = w.top, this.initialCropBoxData = Ae({}, w);
        }, "initCropBox"),
        limitCropBox: o(function (f, g) {
          var m = this.options,
            x = this.containerData,
            w = this.canvasData,
            F = this.cropBoxData,
          ...
          if (f) {
            var j = Number(m.minCropBoxWidth) || 0,
              ...
              I = U ? Math.min(x.width, w.width, w.width + w.left, x.width - w.left) : x.width,
              H = U ? Math.min(x.height, w.height, w.height + w.top, x.height - w.top) : x.height;
            j = Math.min(j, x.width), M = Math.min(M, x.height), V && (j && M ? M * V > j ? M = j / V : j = M * V : j ? M = j / V : M && (j = M * V), H * V > I ? H = I / V : I = H * V), F.minWidth = Math.min(j, I), F.minHeight = Math.min(M, H), F.maxWidth = I, F.maxHeight = H;
          }
          g && (U ? (F.minLeft = Math.max(0, w.left), F.minTop = Math.max(0, w.top), F.maxLeft = Math.min(x.width, w.left + w.width) - F.width, F.maxTop = Math.min(x.height, w.top + w.height) - F.height) : (F.minLeft = 0, F.minTop = 0, F.maxLeft = x.width - F.width, F.maxTop = x.height - F.height));
        }, "limitCropBox"),
        renderCropBox: o(function () {
          var f = this.options,
            g = this.containerData,
            m = this.cropBoxData;
          (m.width > m.maxWidth || m.width < m.minWidth) && (m.left = m.oldLeft), (m.height > m.maxHeight || m.height < m.minHeight) && (m.top = m.oldTop), m.width = Math.min(Math.max(m.width, m.minWidth), m.maxWidth), m.height = Math.min(Math.max(m.height, m.minHeight), m.maxHeight), this.limitCropBox(!1, !0), m.left = Math.min(Math.max(m.left, m.minLeft), m.maxLeft), m.top = Math.min(Math.max(m.top, m.minTop), m.maxTop), m.oldLeft = m.left, m.oldTop = m.top, f.movable && f.cropBoxMovable && Oo(this.face, B, m.width >= g.width && m.height >= g.height ? W : R), Ci(this.cropBox, Ae({
            width: m.width,
            height: m.height
          }, cn({
            translateX: m.left,
      ...
      h1 = {
        initPreview: o(function () {
          var f = this.element,
            ...
            w = f.alt || "The image to preview",
            F = document.createElement("img");
          if (g && (F.crossOrigin = g), F.src = x, F.alt = w, this.viewBox.appendChild(F), this.viewBoxImage = F, !!m) {
            var U = m;
            typeof m == "string" ? U = f.ownerDocument.querySelectorAll(m) : m.querySelector && (U = [m]), this.previews = U, Ve(U, function (V) {
              var j = document.createElement("img");
              Oo(V, D, {
                width: V.offsetWidth,
                height: V.offsetHeight,
                html: V.innerHTML
              }), g && (j.crossOrigin = g), j.src = x, j.alt = w, j.style.cssText = 'display:block;width:100%;height:auto;min-width:0!important;min-height:0!important;max-width:none!important;max-height:none!important;image-orientation:0deg!important;"', V.innerHTML = "", V.appendChild(j);
            });
          }
        }, "initPreview"),
        resetPreview: o(function () {
          Ve(this.previews, function (f) {
            var g = Eo(f, D);
            Ci(f, {
              width: g.width,
              height: g.height
            }), f.innerHTML = g.html, fs(f, D);
          });
        }, "resetPreview"),
        preview: o(function () {
          var f = this.imageData,
            g = this.canvasData,
            m = this.cropBoxData,
            x = m.width,
            w = m.height,
            F = f.width,
            U = f.height,
            V = m.left - g.left - f.left,
            j = m.top - g.top - f.top;
          !this.cropped || this.disabled || (Ci(this.viewBoxImage, Ae({
            width: F,
            height: U
          }, cn(Ae({
            translateX: -V,
            translateY: -j
          }, f)))), Ve(this.previews, function (M) {
            var I = Eo(M, D),
              H = I.width,
              ye = I.height,
              fe = H,
              De = ye,
              _e = 1;
            x && (_e = H / x, De = w * _e), w && De > ye && (_e = ye / w, fe = x * _e, De = ye), Ci(M, {
              width: fe,
              height: De
            }), Ci(M.getElementsByTagName("img")[0], Ae({
              width: F * _e,
              height: U * _e
            }, cn(Ae({
              translateX: -V * _e,
      ...
      d1 = {
        bind: o(function () {
          var f = this.element,
            g = this.options,
            m = this.cropper;
          St(g.cropstart) && Ut(f, ge, g.cropstart), St(g.cropmove) && Ut(f, Ce, g.cropmove), St(g.cropend) && Ut(f, Q, g.cropend), St(g.crop) && Ut(f, Y, g.crop), St(g.zoom) && Ut(f, cs, g.zoom), Ut(m, Rt, this.onCropStart = this.cropStart.bind(this)), g.zoomable && g.zoomOnWheel && Ut(m, rr, this.onWheel = this.wheel.bind(this), {
            passive: !1,
            capture: !0
          }), g.toggleDragModeOnDblclick && Ut(m, ue, this.onDblclick = this.dblclick.bind(this)), Ut(f.ownerDocument, qe, this.onCropMove = this.cropMove.bind(this)), Ut(f.ownerDocument, oe, this.onCropEnd = this.cropEnd.bind(this)), g.responsive && Ut(window, rt, this.onResize = this.resize.bind(this));
        }, "bind"),
        unbind: o(function () {
          var f = this.element,
            g = this.options,
            m = this.cropper;
          St(g.cropstart) && gt(f, ge, g.cropstart), St(g.cropmove) && gt(f, Ce, g.cropmove), St(g.cropend) && gt(f, Q, g.cropend), St(g.crop) && gt(f, Y, g.crop), St(g.zoom) && gt(f, cs, g.zoom), gt(m, Rt, this.onCropStart), g.zoomable && g.zoomOnWheel && gt(m, rr, this.onWheel, {
            passive: !1,
            capture: !0
          }), g.toggleDragModeOnDblclick && gt(m, ue, this.onDblclick), gt(f.ownerDocument, qe, this.onCropMove), gt(f.ownerDocument, oe, this.onCropEnd), g.responsive && gt(window, rt, this.onResize);
        }, "unbind")
      },
      p1 = {
        resize: o(function () {
          if (!this.disabled) {
            ...
            if (x !== 1 || g.offsetHeight !== m.height) {
              var w, F;
              f.restore && (w = this.getCanvasData(), F = this.getCropBoxData()), this.render(), f.restore && (this.setCanvasData(Ve(w, function (U, V) {
                w[V] = U * x;
              })), this.setCropBoxData(Ve(F, function (U, V) {
                F[V] = U * x;
              })));
            }
          }
        ...
        dblclick: o(function () {
          this.disabled || this.options.dragMode === N || this.setDragMode(an(this.dragBox, Pe) ? k : A);
        }, "dblclick"),
        wheel: o(function (f) {
          var g = this,
            m = Number(this.options.wheelZoomRatio) || .1,
            x = 1;
          this.disabled || (f.preventDefault(), !this.wheeling && (this.wheeling = !0, setTimeout(function () {
            g.wheeling = !1;
          }, 50), f.deltaY ? x = f.deltaY > 0 ? 1 : -1 : f.wheelDelta ? x = -f.wheelDelta / 120 : f.detail && (x = f.detail > 0 ? 1 : -1), this.zoom(-x * m, f)));
        }, "wheel"),
        cropStart: o(function (f) {
          var g = f.buttons,
            m = f.button;
          if (!(this.disabled || (f.type === "mousedown" || f.type === "pointerdown" && f.pointerType === "mouse") && (he(g) && g !== 1 || he(m) && m !== 0 || f.ctrlKey))) {
            var x = this.options,
              w = this.pointers,
              F;
            f.changedTouches ? Ve(f.changedTouches, function (U) {
              w[U.identifier] = Bl(U);
            }) : w[f.pointerId || 0] = Bl(f), Object.keys(w).length > 1 && x.zoomable && x.zoomOnTouch ? F = K : F = Eo(f.target, B), hs.test(F) && wi(this.element, ge, {
              originalEvent: f,
              action: F
            }) !== !1 && (f.preventDefault(), this.action = F, this.cropping = !1, F === $ && (this.cropping = !0, We(this.dragBox, L)));
          }
        }, "cropStart"),
        cropMove: o(function (f) {
          var g = this.action;
          if (!(this.disabled || !g)) {
            var m = this.pointers;
            f.preventDefault(), wi(this.element, Ce, {
              originalEvent: f,
              action: g
            }) !== !1 && (f.changedTouches ? Ve(f.changedTouches, function (x) {
              Ae(m[x.identifier] || {}, Bl(x, !0));
            }) : Ae(m[f.pointerId || 0] || {}, Bl(f, !0)), this.change(f));
          }
        }, "cropMove"),
        cropEnd: o(function (f) {
          if (!this.disabled) {
            var g = this.action,
              m = this.pointers;
            f.changedTouches ? Ve(f.changedTouches, function (x) {
              delete m[x.identifier];
            }) : delete m[f.pointerId || 0], g && (f.preventDefault(), Object.keys(m).length || (this.action = ""), this.cropping && (this.cropping = !1, or(this.dragBox, L, this.cropped && this.options.modal)), wi(this.element, Q, {
              originalEvent: f,
              action: g
            }));
          }
      ...
      f1 = {
        change: o(function (f) {
          var g = this.options,
            ...
            st = !0,
            nr;
          !V && f.shiftKey && (V = I && H ? I / H : 1), this.limited && (De = w.minLeft, _e = w.minTop, ut = De + Math.min(x.width, m.width, m.left + m.width), yt = _e + Math.min(x.height, m.height, m.top + m.height));
          ...
          switch (U) {
            case R:
              ...
              break;
            case q:
              if (X.x >= 0 && (ye >= ut || V && (M <= _e || fe >= yt))) {
                st = !1;
                break;
              }
              xe(q), I += X.x, I < 0 && (U = G, I = -I, j -= I), V && (H = I / V, M += (w.height - H) / 2);
              break;
            case re:
              if (X.y <= 0 && (M <= _e || V && (j <= De || ye >= ut))) {
                st = !1;
                break;
              }
              xe(re), H -= X.y, M += X.y, H < 0 && (U = te, H = -H, M -= H), V && (I = H * V, j += (w.width - I) / 2);
              break;
            case G:
              if (X.x <= 0 && (j <= De || V && (M <= _e || fe >= yt))) {
                st = !1;
                break;
              }
              xe(G), I -= X.x, j += X.x, I < 0 && (U = q, I = -I, j -= I), V && (H = I / V, M += (w.height - H) / 2);
              break;
            case te:
              if (X.y >= 0 && (fe >= yt || V && (j <= De || ye >= ut))) {
                st = !1;
                break;
              }
              xe(te), H += X.y, H < 0 && (U = re, H = -H, M -= H), V && (I = H * V, j += (w.width - I) / 2);
              break;
            case Ee:
              if (V) {
                if (X.y <= 0 && (M <= _e || ye >= ut)) {
              ...
              } else xe(re), xe(q), X.x >= 0 ? ye < ut ? I += X.x : X.y <= 0 && M <= _e && (st = !1) : I += X.x, X.y <= 0 ? M > _e && (H -= X.y, M += X.y) : (H -= X.y, M += X.y);
              I < 0 && H < 0 ? (U = we, H = -H, I = -I, M -= H, j -= I) : I < 0 ? (U = Re, I = -I, j -= I) : H < 0 && (U = $e, H = -H, M -= H);
              break;
            case Re:
              if (V) {
                if (X.y <= 0 && (M <= _e || j <= De)) {
                ...
                xe(re), H -= X.y, M += X.y, I = H * V, j += w.width - I;
              } else xe(re), xe(G), X.x <= 0 ? j > De ? (I -= X.x, j += X.x) : X.y <= 0 && M <= _e && (st = !1) : (I -= X.x, j += X.x), X.y <= 0 ? M > _e && (H -= X.y, M += X.y) : (H -= X.y, M += X.y);
              I < 0 && H < 0 ? (U = $e, H = -H, I = -I, M -= H, j -= I) : I < 0 ? (U = Ee, I = -I, j -= I) : H < 0 && (U = we, H = -H, M -= H);
              break;
            case we:
              if (V) {
                if (X.x <= 0 && (j <= De || fe >= yt)) {
              ...
              } else xe(te), xe(G), X.x <= 0 ? j > De ? (I -= X.x, j += X.x) : X.y >= 0 && fe >= yt && (st = !1) : (I -= X.x, j += X.x), X.y >= 0 ? fe < yt && (H += X.y) : H += X.y;
              I < 0 && H < 0 ? (U = Ee, H = -H, I = -I, M -= H, j -= I) : I < 0 ? (U = $e, I = -I, j -= I) : H < 0 && (U = Re, H = -H, M -= H);
              break;
            case $e:
              if (V) {
                if (X.x >= 0 && (ye >= ut || fe >= yt)) {
                  st = !1;
                  break;
                }
                xe(q), I += X.x, H = I / V;
              } else xe(te), xe(q), X.x >= 0 ? ye < ut ? I += X.x : X.y >= 0 && fe >= yt && (st = !1) : I += X.x, X.y >= 0 ? fe < yt && (H += X.y) : H += X.y;
              I < 0 && H < 0 ? (U = Re, H = -H, I = -I, M -= H, j -= I) : I < 0 ? (U = we, I = -I, j -= I) : H < 0 && (U = Ee, H = -H, M -= H);
              break;
            case W:
              this.move(X.x, X.y), st = !1;
              break;
            case K:
              this.zoom(e1(F), f), st = !1;
              break;
            case $:
              if (!X.x || !X.y) {
                st = !1;
              ...
              nr = Rf(this.cropper), j = ii.startX - nr.left, M = ii.startY - nr.top, I = w.minWidth, H = w.minHeight, X.x > 0 ? U = X.y > 0 ? $e : Ee : X.x < 0 && (j -= I, U = X.y > 0 ? we : Re), X.y < 0 && (M -= H), this.cropped || (ti(this.cropBox, C), this.cropped = !0, this.limited && this.limitCropBox(!0, !0));
              break;
          }
          st && (w.width = I, w.height = H, w.left = j, w.top = M, this.action = U, this.renderCropBox()), Ve(F, function (ct) {
            ct.startX = ct.endX, ct.startY = ct.endY;
          });
        }, "change")
      },
      m1 = {
        crop: o(function () {
          return this.ready && !this.cropped && !this.disabled && (this.cropped = !0, this.limitCropBox(!0, !0), this.options.modal && We(this.dragBox, L), ti(this.cropBox, C), this.setCropBoxData(this.initialCropBoxData)), this;
        }, "crop"),
        reset: o(function () {
        ...
        clear: o(function () {
          return this.cropped && !this.disabled && (Ae(this.cropBoxData, {
            ...
            width: 0,
            height: 0
          }), this.cropped = !1, this.renderCropBox(), this.limitCanvas(!0, !0), this.renderCanvas(), ti(this.dragBox, L), We(this.cropBox, C)), this;
        }, "clear"),
        replace: o(function (f) {
          var g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
          return !this.disabled && f && (this.isImg && (this.element.src = f), g ? (this.url = f, this.image.src = f, this.ready && (this.viewBoxImage.src = f, Ve(this.previews, function (m) {
            m.getElementsByTagName("img")[0].src = f;
          }))) : (this.isImg && (this.replaced = !0), this.options.data = null, this.uncreate(), this.load(f))), this;
        }, "replace"),
        enable: o(function () {
          return this.ready && this.disabled && (this.disabled = !1, ti(this.cropper, Le)), this;
        }, "enable"),
        disable: o(function () {
          return this.ready && !this.disabled && (this.disabled = !0, We(this.cropper, Le)), this;
        }, "disable"),
        destroy: o(function () {
          var f = this.element;
          return f[_] ? (f[_] = void 0, this.isImg && this.replaced && (f.src = this.originalUrl), this.uncreate(), this) : this;
        }, "destroy"),
        move: o(function (f) {
          var g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : f,
            m = this.canvasData,
            x = m.left,
            w = m.top;
          return this.moveTo(xo(f) ? f : x + Number(f), xo(g) ? g : w + Number(g));
        }, "move"),
        moveTo: o(function (f) {
          var g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : f,
            m = this.canvasData,
            x = !1;
          return f = Number(f), g = Number(g), this.ready && !this.disabled && this.options.movable && (he(f) && (m.left = f, x = !0), he(g) && (m.top = g, x = !0), x && this.renderCanvas(!0)), this;
        }, "moveTo"),
        zoom: o(function (f, g) {
          var m = this.canvasData;
          return f = Number(f), f < 0 ? f = 1 / (1 - f) : f = 1 + f, this.zoomTo(m.width * f / m.naturalWidth, null, g);
        }, "zoom"),
        zoomTo: o(function (f, g, m) {
          var x = this.options,
            w = this.canvasData,
            F = w.width,
            U = w.height,
            V = w.naturalWidth,
            j = w.naturalHeight;
          if (f = Number(f), f >= 0 && this.ready && !this.disabled && x.zoomable) {
            var M = V * f,
              I = j * f;
            if (wi(this.element, cs, {
              ratio: f,
              oldRatio: F / V,
              originalEvent: m
            }) === !1) return this;
            if (m) {
              var H = this.pointers,
                ye = Rf(this.cropper),
                fe = H && Object.keys(H).length ? t1(H) : {
                  pageX: m.pageX,
                  pageY: m.pageY
                };
              w.left -= (M - F) * ((fe.pageX - ye.left - w.left) / F), w.top -= (I - U) * ((fe.pageY - ye.top - w.top) / U);
            } else sr(g) && he(g.x) && he(g.y) ? (w.left -= (M - F) * ((g.x - w.left) / F), w.top -= (I - U) * ((g.y - w.top) / U)) : (w.left -= (M - F) / 2, w.top -= (I - U) / 2);
            w.width = M, w.height = I, this.renderCanvas(!0);
          }
          return this;
        }, "zoomTo"),
        rotate: o(function (f) {
          return this.rotateTo((this.imageData.rotate || 0) + Number(f));
        }, "rotate"),
        rotateTo: o(function (f) {
          return f = Number(f), he(f) && this.ready && !this.disabled && this.options.rotatable && (this.imageData.rotate = f % 360, this.renderCanvas(!0, !0)), this;
        }, "rotateTo"),
        scaleX: o(function (f) {
          var g = this.imageData.scaleY;
          return this.scale(f, he(g) ? g : 1);
        }, "scaleX"),
        scaleY: o(function (f) {
          var g = this.imageData.scaleX;
          return this.scale(he(g) ? g : 1, f);
        }, "scaleY"),
        scale: o(function (f) {
          var g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : f,
            m = this.imageData,
            x = !1;
          return f = Number(f), g = Number(g), this.ready && !this.disabled && this.options.scalable && (he(f) && (m.scaleX = f, x = !0), he(g) && (m.scaleY = g, x = !0), x && this.renderCanvas(!0, !0)), this;
        }, "scale"),
        getData: o(function () {
          ...
          if (this.ready && this.cropped) {
            ...
            if (Ve(F, function (M, I) {
              F[I] = M / U;
            }), f) {
              var V = Math.round(F.y + F.height),
                j = Math.round(F.x + F.width);
              F.x = Math.round(F.x), F.y = Math.round(F.y), F.width = j - F.x, F.height = V - F.y;
            }
          } else F = {
            x: 0,
            y: 0,
          ...
          return g.rotatable && (F.rotate = m.rotate || 0), g.scalable && (F.scaleX = m.scaleX || 1, F.scaleY = m.scaleY || 1), F;
        }, "getData"),
        setData: o(function (f) {
          var g = this.options,
            m = this.imageData,
            x = this.canvasData,
            w = {};
          if (this.ready && !this.disabled && sr(f)) {
            var F = !1;
            g.rotatable && he(f.rotate) && f.rotate !== m.rotate && (m.rotate = f.rotate, F = !0), g.scalable && (he(f.scaleX) && f.scaleX !== m.scaleX && (m.scaleX = f.scaleX, F = !0), he(f.scaleY) && f.scaleY !== m.scaleY && (m.scaleY = f.scaleY, F = !0)), F && this.renderCanvas(!0, !0);
            var U = m.width / m.naturalWidth;
            he(f.x) && (w.left = f.x * U + x.left), he(f.y) && (w.top = f.y * U + x.top), he(f.width) && (w.width = f.width * U), he(f.height) && (w.height = f.height * U), this.setCropBoxData(w);
          }
          return this;
        }, "setData"),
        ...
        setCanvasData: o(function (f) {
          var g = this.canvasData,
            m = g.aspectRatio;
          return this.ready && !this.disabled && sr(f) && (he(f.left) && (g.left = f.left), he(f.top) && (g.top = f.top), he(f.width) ? (g.width = f.width, g.height = f.width / m) : he(f.height) && (g.height = f.height, g.width = f.height * m), this.renderCanvas(!0)), this;
        }, "setCanvasData"),
        getCropBoxData: o(function () {
          var f = this.cropBoxData,
            g;
        ...
        setCropBoxData: o(function (f) {
          var g = this.cropBoxData,
            m = this.options.aspectRatio,
            x,
            w;
          return this.ready && this.cropped && !this.disabled && sr(f) && (he(f.left) && (g.left = f.left), he(f.top) && (g.top = f.top), he(f.width) && f.width !== g.width && (x = !0, g.width = f.width), he(f.height) && f.height !== g.height && (w = !0, g.height = f.height), m && (x ? g.height = g.width / m : w && (g.width = g.height * m)), this.renderCropBox()), this;
        }, "setCropBoxData"),
        getCroppedCanvas: o(function () {
          var f = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          if (!this.ready || !window.HTMLCanvasElement) return null;
          var g = this.canvasData,
            m = r1(this.image, this.imageData, g, f);
          ...
          var M = U / V,
            I = Hr({
              ...
              height: f.maxHeight || 1 / 0
            }),
            H = Hr({
              aspectRatio: M,
              width: f.minWidth || 0,
              height: f.minHeight || 0
            }, "cover"),
            ye = Hr({
              aspectRatio: M,
              width: f.width || (j !== 1 ? m.width : U),
              height: f.height || (j !== 1 ? m.height : V)
            }),
            fe = ye.width,
            De = ye.height;
          fe = Math.min(I.width, Math.max(H.width, fe)), De = Math.min(I.height, Math.max(H.height, De));
          var _e = document.createElement("canvas"),
            ut = _e.getContext("2d");
          _e.width = qi(fe), _e.height = qi(De), ut.fillStyle = f.fillColor || "transparent", ut.fillRect(0, 0, fe, De);
          var yt = f.imageSmoothingEnabled,
            st = yt === void 0 ? !0 : yt,
            nr = f.imageSmoothingQuality;
          ut.imageSmoothingEnabled = st, nr && (ut.imageSmoothingQuality = nr);
          var ii = m.width,
            X = m.height,
            xe = w,
            ct = F,
            ...
            $r,
            Vi;
          xe <= -U || xe > ii ? (xe = 0, Si = 0, ms = 0, $r = 0) : xe <= 0 ? (ms = -xe, xe = 0, Si = Math.min(ii, U + xe), $r = Si) : xe <= ii && (ms = 0, Si = Math.min(U, ii - xe), $r = Si), Si <= 0 || ct <= -V || ct > X ? (ct = 0, ar = 0, gs = 0, Vi = 0) : ct <= 0 ? (gs = -ct, ct = 0, ar = Math.min(X, V + ct), Vi = ar) : ct <= X && (gs = 0, ar = Math.min(V, X - ct), Vi = ar);
          var Kt = [xe, ct, Si, ar];
          if ($r > 0 && Vi > 0) {
            var ys = fe / U;
            Kt.push(ms * ys, gs * ys, $r * ys, Vi * ys);
          }
          return ut.drawImage.apply(ut, [m].concat(u(Kt.map(function (jl) {
            return Math.floor(qi(jl));
          })))), _e;
        }, "getCroppedCanvas"),
        setAspectRatio: o(function (f) {
          var g = this.options;
          return !this.disabled && !xo(f) && (g.aspectRatio = Math.max(0, f) || NaN, this.ready && (this.initCropBox(), this.cropped && this.renderCropBox())), this;
        }, "setAspectRatio"),
        setDragMode: o(function (f) {
          var g = this.options,
            m = this.dragBox,
            x = this.face;
          if (this.ready && !this.disabled) {
            var w = f === A,
              F = g.movable && f === k;
            f = w || F ? f : N, g.dragMode = f, Oo(m, B, f), or(m, Pe, w), or(m, z, F), g.cropBoxMovable || (Oo(x, B, f), or(x, Pe, w), or(x, z, F));
          }
          return this;
        }, "setDragMode")
      },
      ...
      If = function () {
        function v(f) {
          ...
          if (e(this, v), !f || !zr.test(f.tagName)) throw new Error("The first argument is required and must be an <img> or <canvas> element.");
          this.element = f, this.options = Ae({}, lt, sr(g) && g), this.cropped = !1, this.disabled = !1, this.pointers = {}, this.ready = !1, this.reloading = !1, this.replaced = !1, this.sized = !1, this.sizing = !1, this.init();
        }
        return o(v, "Cropper"), r(v, [{
          key: "init",
          value: o(function () {
            var g = this.element,
            ...
            if (!g[_]) {
              if (g[_] = this, m === "img") {
                if (this.isImg = !0, x = g.getAttribute("src") || "", this.originalUrl = x, !x) return;
                x = g.src;
              } else m === "canvas" && window.HTMLCanvasElement && (x = g.toDataURL());
              this.load(x);
            }
          }, "init")
        }, {
          ...
          value: o(function (g) {
            ...
            if (g) {
              ...
              if (ds.test(g)) {
                ps.test(g) ? this.read(n1(g)) : this.clone();
                return;
              }
              var F = new XMLHttpRequest(),
                U = this.clone.bind(this);
              this.reloading = !0, this.xhr = F, F.onabort = U, F.onerror = U, F.ontimeout = U, F.onprogress = function () {
                F.getResponseHeader("content-type") !== jr && F.abort();
              }, F.onload = function () {
                m.read(F.response);
              }, F.onloadend = function () {
                m.reloading = !1, m.xhr = null;
              }, w.checkCrossOrigin && kf(g) && x.crossOrigin && (g = Uf(g)), F.open("GET", g), F.responseType = "arraybuffer", F.withCredentials = x.crossOrigin === "use-credentials", F.send();
            }
          }, "load")
        }, {
          key: "read",
          value: o(function (g) {
            ...
            m.rotatable && (x.rotate = F), m.scalable && (x.scaleX = U, x.scaleY = V), this.clone();
          }, "read")
        }, {
          key: "clone",
          value: o(function () {
            var g = this.element,
              ...
              x = g.crossOrigin,
              w = m;
            this.options.checkCrossOrigin && kf(m) && (x || (x = "anonymous"), w = Uf(m)), this.crossOrigin = x, this.crossOriginUrl = w;
            var F = document.createElement("img");
            x && (F.crossOrigin = x), F.src = w || m, F.alt = g.alt || "The image to crop", this.image = F, F.onload = this.start.bind(this), F.onerror = this.stop.bind(this), We(F, P), g.parentNode.insertBefore(F, g.nextSibling);
          }, "clone")
        }, {
          key: "start",
          value: o(function () {
            ...
            var x = S.navigator && /(?:iPad|iPhone|iPod).*?AppleWebKit/i.test(S.navigator.userAgent),
              w = o(function (j, M) {
                Ae(g.imageData, {
                  naturalWidth: j,
                  naturalHeight: M,
            ...
            this.sizingImage = F, F.onload = function () {
              w(F.width, F.height), x || U.removeChild(F);
            }, F.src = m.src, x || (F.style.cssText = "left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;", U.appendChild(F));
          }, "start")
        }, {
          key: "stop",
          value: o(function () {
          ...
          key: "unbuild",
          value: o(function () {
            this.ready && (this.ready = !1, this.unbind(), this.resetPreview(), this.cropper.parentNode.removeChild(this.cropper), ti(this.element, C));
          }, "unbuild")
        }, {
          key: "uncreate",
          value: o(function () {
    ...
    return Ae(If.prototype, c1, h1, d1, p1, f1, m1), If;
  });
});
var Nv = ve((W7, $u) => {
  "use strict";
  ...
  $u.exports = Bd;
  $u.exports.isMobile = Bd;
  $u.exports.default = Bd;
  var v_ = /(android|bb\d+|meego).+mobile|armv7l|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series[46]0|samsungbrowser|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i,
    b_ = /CrOS/,
    w_ = /android|ipad|playbook|silk/i;
  function Bd(i) {
    i || (i = {});
    let e = i.ua;
    ...
    let t = v_.test(e) && !b_.test(e) || !!i.tablet && w_.test(e);
...
var Cb = ve(_p => {
  ...
  function N5(i, e) {
    ...
    var t = [],
      ...
      s;
    typeof e != "string" && (e = "?");
    for (s in i) if (D5.call(i, s)) {
      if (r = i[s], !r && (r === null || r === I5 || isNaN(r)) && (r = ""), s = Ob(s), r = Ob(r), s === null || r === null) continue;
      t.push(s + "=" + r);
    }
...
var Lb = ve((cL, Ib) => {
  ...
  var Tb = Fb(),
    ...
    z5 = /^[a-zA-Z]:/;
  function Fp(i) {
    return (i || "").toString().replace(M5, "");
  }
  o(Fp, "trimLeft");
  var xp = [["#", "hash"], ["?", "query"], o(function (e, t) {
      return Ji(t.protocol) ? e.replace(/\\/g, "/") : e;
    }, "sanitize"), ["/", "pathname"], ["@", "auth", 1], [NaN, "host", void 0, 1, 1], [/:(\d*)$/, "port", void 0, 1], [NaN, "hostname", void 0, 1, 1]],
    Ab = {
      hash: 1,
      query: 1
    };
  function Ub(i) {
    ...
    var r = {},
      s = typeof i,
      n;
    if (i.protocol === "blob:") r = new Zi(unescape(i.pathname), {});else if (s === "string") {
      r = new Zi(i, {});
      for (n in Ab) delete r[n];
    } else if (s === "object") {
      for (n in i) n in Ab || (r[n] = i[n]);
      r.slashes === void 0 && (r.slashes = B5.test(i.href));
    }
    return r;
  }
  o(Ub, "lolcation");
  ...
  function Db(i, e) {
    ...
    var t = j5.exec(i),
      ...
      a = 0,
      u;
    return s ? n ? (u = t[2] + t[3] + t[4], a = t[2].length + t[3].length) : (u = t[2] + t[4], a = t[2].length) : n ? (u = t[3] + t[4], a = t[3].length) : u = t[4], r === "file:" ? a >= 2 && (u = u.slice(2)) : Ji(r) ? u = t[4] : r ? s && (u = u.slice(2)) : a >= 2 && Ji(e.protocol) && (u = t[4]), {
      protocol: r,
      slashes: s || Ji(r),
      slashesCount: a,
      rest: u
  ...
  o(H5, "resolve");
  function Zi(i, e, t) {
    if (i = Fp(i), i = i.replace(Rb, ""), !(this instanceof Zi)) return new Zi(i, e, t);
    var r,
      s,
      n,
      a,
      ...
      p = this,
      y = 0;
    for (d !== "object" && d !== "string" && (t = e, e = null), t && typeof t != "function" && (t = Ju.parse), e = Ub(e), s = Db(i || "", e), r = !s.protocol && !s.slashes, p.slashes = s.slashes || r && e.slashes, p.protocol = s.protocol || e.protocol || "", i = s.rest, (s.protocol === "file:" && (s.slashesCount !== 2 || z5.test(i)) || !s.slashes && (s.protocol || s.slashesCount < 2 || !Ji(p.protocol))) && (h[3] = [/(.*)/, "pathname"]); y < h.length; y++) {
      if (a = h[y], typeof a == "function") {
        i = a(i, p);
        continue;
      }
      n = a[0], l = a[1], n !== n ? p[l] = i : typeof n == "string" ? (u = n === "@" ? i.lastIndexOf(n) : i.indexOf(n), ~u && (typeof a[2] == "number" ? (p[l] = i.slice(0, u), i = i.slice(u + a[2])) : (p[l] = i.slice(u), i = i.slice(0, u)))) : (u = n.exec(i)) && (p[l] = u[1], i = i.slice(0, u.index)), p[l] = p[l] || r && a[3] && e[l] || "", a[4] && (p[l] = p[l].toLowerCase());
    }
  ...
  function $5(i, e, t) {
    ...
    switch (i) {
      case "query":
        typeof e == "string" && e.length && (e = (t || Ju.parse)(e)), r[i] = e;
        break;
      case "port":
        r[i] = e, Tb(e, r.protocol) ? e && (r.host = r.hostname + ":" + e) : (r.host = r.hostname, r[i] = "");
        break;
      case "hostname":
        r[i] = e, r.port && (e += ":" + r.port), r.host = e;
        break;
      case "host":
        r[i] = e, kb.test(e) ? (e = e.split(":"), r.port = e.pop(), r.hostname = e.join(":")) : (r.hostname = e, r.port = "");
        break;
      case "protocol":
    ...
    for (var a = 0; a < xp.length; a++) {
      var u = xp[a];
      u[4] && (r[u[1]] = r[u[1]].toLowerCase());
    }
    return r.auth = r.password ? r.username + ":" + r.password : r.username, r.origin = r.protocol !== "file:" && Ji(r.protocol) && r.host ? r.protocol + "//" + r.host : "null", r.href = r.toString(), r;
  }
  o($5, "set");
  function q5(i) {
    (!i || typeof i != "function") && (i = Ju.stringify);
    var e,
      t = this,
      r = t.host,
      s = t.protocol;
    s && s.charAt(s.length - 1) !== ":" && (s += ":");
    var n = s + (t.protocol && t.slashes || Ji(t.protocol) ? "//" : "");
    return t.username ? (n += t.username, t.password && (n += ":" + t.password), n += "@") : t.password ? (n += ":" + t.password, n += "@") : t.protocol !== "file:" && Ji(t.protocol) && !r && t.pathname !== "/" && (n += "@"), (r[r.length - 1] === ":" || kb.test(t.hostname) && !t.port) && (r += ":"), n += r + t.pathname, e = typeof t.query == "object" ? i(t.query) : t.query, e && (n += e.charAt(0) !== "?" ? "?" + e : e), t.hash && (n += t.hash), n;
  }
  o(q5, "toString");
  Zi.prototype = {
    set: $5,
...
var Vp = ve((PN, qp) => {
  ...
  yi.prototype.off = yi.prototype.removeListener = yi.prototype.removeAllListeners = yi.prototype.removeEventListener = function (i, e) {
    if (this._callbacks = this._callbacks || {}, arguments.length == 0) return this._callbacks = {}, this;
    var t = this._callbacks["$" + i];
    if (!t) return this;
    if (arguments.length == 1) return delete this._callbacks["$" + i], this;
    for (var r, s = 0; s < t.length; s++) if (r = t[s], r === e || r.fn === e) {
      t.splice(s, 1);
      break;
    }
...
var D0 = ve((Of, Cf) => {
  (function (i, e) {
    typeof Of == "object" && typeof Cf < "u" ? Cf.exports = e() : typeof define == "function" && define.amd ? define(e) : (i = typeof globalThis < "u" ? globalThis : i || self, i.Compressor = e());
  })(Of, function () {
    "use strict";
    ...
    function e(D) {
      for (var A = 1; A < arguments.length; A++) {
        ...
        A % 2 ? i(Object(k), !0).forEach(function (N) {
          n(D, N, k[N]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(D, Object.getOwnPropertyDescriptors(k)) : i(Object(k)).forEach(function (N) {
          Object.defineProperty(D, N, Object.getOwnPropertyDescriptor(k, N));
        });
      }
      return D;
    }
    ...
    function s(D, A, k) {
      return A && r(D.prototype, A), k && r(D, k), Object.defineProperty(D, "prototype", {
        writable: !1
      }), D;
    }
    o(s, "_createClass");
    ...
    function a() {
      return a = Object.assign ? Object.assign.bind() : function (D) {
        for (var A = 1; A < arguments.length; A++) {
          var k = arguments[A];
          for (var N in k) Object.prototype.hasOwnProperty.call(k, N) && (D[N] = k[N]);
        }
        return D;
    ...
    (function (D) {
      typeof window > "u" || function (A) {
        var k = A.HTMLCanvasElement && A.HTMLCanvasElement.prototype,
          ...
          Q = A.BlobBuilder || A.WebKitBlobBuilder || A.MozBlobBuilder || A.MSBlobBuilder,
          Ce = /^data:((.*?)(;charset=.*?)?)(;base64)?,/,
          ge = (N || Q) && A.atob && A.ArrayBuffer && A.Uint8Array && function (ue) {
            var ce, Ue, Ne, Rt, qe, oe, kt, rt, rr;
            if (ce = ue.match(Ce), !ce) throw new Error("invalid data URI");
            for (Ue = ce[2] ? ce[1] : "text/plain" + (ce[3] || ";charset=US-ASCII"), Ne = !!ce[4], Rt = ue.slice(ce[0].length), Ne ? qe = atob(Rt) : qe = decodeURIComponent(Rt), oe = new ArrayBuffer(qe.length), kt = new Uint8Array(oe), rt = 0; rt < qe.length; rt += 1) kt[rt] = qe.charCodeAt(rt);
            return N ? new Blob([Y ? kt : oe], {
              type: Ue
            }) : (rr = new Q(), rr.append(oe), rr.getBlob(Ue));
          };
        A.HTMLCanvasElement && !k.toBlob && (k.mozGetAsFile ? k.toBlob = function (ue, ce, Ue) {
          var Ne = this;
          setTimeout(function () {
            Ue && k.toDataURL && ge ? ue(ge(Ne.toDataURL(ce, Ue))) : ue(Ne.mozGetAsFile("blob", ce));
          });
        } : k.toDataURL && ge && (k.msToBlob ? k.toBlob = function (ue, ce, Ue) {
          var Ne = this;
          setTimeout(function () {
            (ce && ce !== "image/png" || Ue) && k.toDataURL && ge ? ue(ge(Ne.toDataURL(ce, Ue))) : ue(Ne.msToBlob(ce));
          });
    ...
    var d = h.exports,
      p = o(function (A) {
        return typeof Blob > "u" ? !1 : A instanceof Blob || Object.prototype.toString.call(A) === "[object Blob]";
      }, "isBlob"),
      y = {
        strict: !0,
        checkOrientation: !0,
    ...
    var G = S.btoa;
    function te(D, A) {
      for (var k = [], N = 8192, Y = new Uint8Array(D); Y.length > 0;) k.push(K.apply(null, _(Y.subarray(0, N)))), Y = Y.subarray(N);
    ...
    function re(D) {
      ...
      try {
        var N, Y, Q;
        if (A.getUint8(0) === 255 && A.getUint8(1) === 216) for (var Ce = A.byteLength, ge = 2; ge + 1 < Ce;) {
        ...
        if (Y) {
          ...
          if (q(A, ue, 4) === "Exif") {
            ...
            if (N = Ue === 18761, (N || Ue === 19789) && A.getUint16(ce + 2, N) === 42) {
        ...
        if (Q) {
          var Rt = A.getUint16(Q, N),
            qe,
            oe;
          for (oe = 0; oe < Rt; oe += 1) if (qe = Q + oe * 12 + 2, A.getUint16(qe, N) === 274) {
            qe += 8, k = A.getUint16(qe, N), A.setUint16(qe, 1, N);
            break;
          }
        }
      } catch {
    ...
    function we(D) {
      ...
      if (Q && Ce) {
        var ge = k * A;
        (Y === "contain" || Y === "none") && ge > N || Y === "cover" && ge < N ? k = N / A : N = k * A;
    ...
    function Pe(D) {
      for (var A = _(new Uint8Array(D)), k = A.length, N = [], Y = 0; Y + 3 < k;) {
        var Q = A[Y],
          Ce = A[Y + 1];
        if (Q === 255 && Ce === 218) break;
        if (Q === 255 && Ce === 216) Y += 2;else {
    ...
    var C = S.ArrayBuffer,
      ...
      B = function () {
        function D(A, k) {
          t(this, D), this.file = A, this.exif = [], this.image = new Image(), this.options = e(e({}, y), k), this.aborted = !1, this.result = null, this.init();
        }
        return o(D, "Compressor"), s(D, [{
          key: "init",
          value: o(function () {
            var k = this,
              N = this.file,
            ...
            var Ce = Q === "image/jpeg",
              ...
              ue = Ce && Y.retainExif;
            if (E && !ge && !ue) this.load({
              url: E.createObjectURL(N)
            });else {
              var ce = new P();
              this.reader = ce, ce.onload = function (Ue) {
                var Ne = Ue.target,
                  Rt = Ne.result,
                  qe = {},
                  oe = 1;
                ge && (oe = re(Rt), oe > 1 && a(qe, Ee(oe))), ue && (k.exif = Pe(Rt)), ge || ue ? !E || oe > 1 ? qe.url = te(Rt, Q) : qe.url = E.createObjectURL(N) : qe.url = Rt, k.load(qe);
              }, ce.onabort = function () {
                k.fail(new Error("Aborted to read the image with FileReader."));
              }, ce.onerror = function () {
                k.fail(new Error("Failed to read the image with FileReader."));
              }, ce.onloadend = function () {
                k.reader = null;
              }, ge || ue ? ce.readAsArrayBuffer(N) : ce.readAsDataURL(N);
            }
          }, "init")
        }, {
          key: "load",
          value: o(function (k) {
            ...
            }, S.navigator && /(?:iPad|iPhone|iPod).*?AppleWebKit/i.test(S.navigator.userAgent) && (Q.crossOrigin = "anonymous"), Q.alt = Y.name, Q.src = k.url;
          }, "load")
        }, {
          key: "draw",
          value: o(function (k) {
            var N = this,
              ...
              cs = (oe.resize === "contain" || oe.resize === "cover") && T(oe.width) && T(oe.height),
              jr = Math.max(oe.maxWidth, 0) || 1 / 0,
              hs = Math.max(oe.maxHeight, 0) || 1 / 0,
              ds = Math.max(oe.minWidth, 0) || 0,
              ps = Math.max(oe.minHeight, 0) || 0,
              zr = Y / Q,
              lt = oe.width,
              mt = oe.height;
            if (rr) {
            ...
            jr = xo.width, hs = xo.height;
            var $i = we({
              aspectRatio: zr,
              width: ds,
              height: ps
            }, "cover");
            if (ds = $i.width, ps = $i.height, cs) {
              var Dl = we({
                aspectRatio: zr,
                width: lt,
                height: mt
              }, oe.resize);
              lt = Dl.width, mt = Dl.height;
            } else {
              var sr = we({
                  aspectRatio: zr,
                  width: lt,
            ...
            lt = Math.floor($e(Math.min(Math.max(lt, ds), jr))), mt = Math.floor($e(Math.min(Math.max(mt, ps), hs)));
            var Ll = -lt / 2,
              Ve = -mt / 2,
              Ae = lt,
              fc = mt,
            ...
            if (cs) {
              ...
              an = ti.width, We = ti.height, Nl = (Y - an) / 2, Ci = (Q - We) / 2, qi.push(Nl, Ci, an, We);
            }
            if (qi.push(Ll, Ve, Ae, fc), rr) {
              var or = [mt, lt];
              lt = or[0], mt = or[1];
            }
            kt.width = lt, kt.height = mt, $(oe.mimeType) || (oe.mimeType = Rt.type);
            var Ml = "transparent";
            Rt.size > oe.convertSize && oe.convertTypes.indexOf(oe.mimeType) >= 0 && (oe.mimeType = "image/jpeg");
            var Fo = oe.mimeType === "image/jpeg";
            if (Fo && (Ml = "#fff"), rt.fillStyle = Ml, rt.fillRect(0, 0, lt, mt), oe.beforeDraw && oe.beforeDraw.call(this, rt, kt), !this.aborted && (rt.save(), rt.translate(lt / 2, mt / 2), rt.rotate(ge * Math.PI / 180), rt.scale(ce, Ne), rt.drawImage.apply(rt, [qe].concat(qi)), rt.restore(), oe.drew && oe.drew.call(this, rt, kt), !this.aborted)) {
              var Eo = o(function (fs) {
                if (!N.aborted) {
                  var ln = o(function (wi) {
                    return N.done({
                      naturalWidth: Y,
                      naturalHeight: Q,
                      result: wi
                  ...
                  if (fs && Fo && oe.retainExif && N.exif && N.exif.length > 0) {
                    var un = o(function (wi) {
                      return ln(d(te(Le(wi, N.exif), oe.mimeType)));
                    }, "next");
                    if (fs.arrayBuffer) fs.arrayBuffer().then(un).catch(function () {
                      N.fail(new Error("Failed to read the compressed image with Blob.arrayBuffer()."));
                    });else {
                      var gt = new P();
                      N.reader = gt, gt.onload = function (Ut) {
                        var wi = Ut.target;
                        un(wi.result);
                      }, gt.onabort = function () {
                        ...
                        N.reader = null;
                      }, gt.readAsArrayBuffer(fs);
                    }
                  } else ln(fs);
                }
              }, "callback");
              kt.toBlob ? kt.toBlob(Eo, oe.mimeType, oe.quality) : Eo(d(kt.toDataURL(oe.mimeType, oe.quality)));
            }
          }, "draw")
        }, {
          key: "done",
          value: o(function (k) {
            var N = k.naturalWidth,
              ...
              ge = this.image,
              ue = this.options;
            if (E && ge.src.indexOf("blob:") === 0 && E.revokeObjectURL(ge.src), Q) {
              if (ue.strict && !ue.retainExif && Q.size > Ce.size && ue.mimeType === Ce.type && !(ue.width > N || ue.height > Y || ue.minWidth > N || ue.minHeight > Y || ue.maxWidth < N || ue.maxHeight < Y)) Q = Ce;else {
                var ce = new Date();
                Q.lastModified = ce.getTime(), Q.lastModifiedDate = ce, Q.name = Ce.name, Q.name && Q.type !== Ce.type && (Q.name = Q.name.replace(L, W(Q.type)));
              }
            } else Q = Ce;
          ...
          value: o(function (k) {
            var N = this.options;
            if (N.error) N.error.call(this, k);else throw k;
          }, "fail")
        }, {
          key: "abort",
          value: o(function () {
...
o(Hl, "_classPrivateFieldLooseBase");
var F1 = 0;
function zf(i) {
...
function E1(i, e, t) {
  let r = [];
  return i.forEach(s => typeof s != "string" ? r.push(s) : e[Symbol.split](s).forEach((n, a, u) => {
...
function jf(i, e) {
  let t = /\$/g,
    ...
    s = [i];
  if (e == null) return s;
  for (let n of Object.keys(e)) if (n !== "_") {
    let a = e[n];
    typeof a == "string" && (a = t[Symbol.replace](a, r)), s = E1(s, new RegExp(`%\\{${n}\\}`, "g"), a);
  }
  return s;
}
o(jf, "interpolate");
var O1 = o(i => {
  ...
  vs = class {
    ...
    constructor(e, t) {
      ...
      }, Array.isArray(e) ? e.forEach(Hl(this, dn)[dn], this) : Hl(this, dn)[dn](e), Hl(this, hn)[hn] = r;
    }
    translate(e, t) {
    ...
    translateArray(e, t) {
      ...
      if (r == null && (Hl(this, hn)[hn](e), r = e), typeof r == "object") {
...
var Pw = 0;
function Sm(i) {
  return "__private_" + Pw++ + "_" + i;
}
o(Sm, "_classPrivateFieldLooseKey");
var _w = {
    version: "3.2.2"
  },
  bs = Sm("callbacks"),
  ...
  Wl = class {
    ...
    constructor() {
      Object.defineProperty(this, xc, {
        value: xw
      }), this.state = {}, Object.defineProperty(this, bs, {
        writable: !0,
        value: new Set()
      });
    }
    ...
    setState(e) {
      ...
      this.state = r, Vl(this, xc)[xc](t, r, e);
    }
    subscribe(e) {
      return Vl(this, bs)[bs].add(e), () => {
        Vl(this, bs)[bs].delete(e);
      };
    }
  };
function xw() {
  for (var i = arguments.length, e = new Array(i), t = 0; t < i; t++) e[t] = arguments[t];
  Vl(this, bs)[bs].forEach(r => {
    r(...e);
  });
}
o(xw, "_publish2");
Wl.VERSION = _w.version;
var Fc = Wl;
exports.DefaultStore = Fc;
function Wi(i) {
  let e = i.lastIndexOf(".");
...
function mn(i) {
  ...
  let t = i.name ? (e = Wi(i.name).extension) == null ? void 0 : e.toLowerCase() : null;
  return t && t in fn ? fn[t] : "application/octet-stream";
}
o(mn, "getFileType");
function Fw(i) {
...
function _m(i, e) {
  let t = e || "uppy";
  return typeof i.name == "string" && (t += `-${Pm(i.name.toLowerCase())}`), i.type !== void 0 && (t += `-${i.type}`), i.meta && typeof i.meta.relativePath == "string" && (t += `-${Pm(i.meta.relativePath.toLowerCase())}`), i.data.size !== void 0 && (t += `-${i.data.size}`), i.data.lastModified !== void 0 && (t += `-${i.data.lastModified}`), t;
}
o(_m, "generateFileID");
function Ew(i) {
...
var xm = {
    ...
    error: function () {
      for (var i = arguments.length, e = new Array(i), t = 0; t < i; t++) e[t] = arguments[t];
      return console.error(`[Uppy] [${Co()}]`, ...e);
    }
  },
  Kl = {
    debug: function () {
      for (var i = arguments.length, e = new Array(i), t = 0; t < i; t++) e[t] = arguments[t];
      return console.debug(`[Uppy] [${Co()}]`, ...e);
    },
    warn: function () {
      for (var i = arguments.length, e = new Array(i), t = 0; t < i; t++) e[t] = arguments[t];
      return console.warn(`[Uppy] [${Co()}]`, ...e);
    },
    error: function () {
      for (var i = arguments.length, e = new Array(i), t = 0; t < i; t++) e[t] = arguments[t];
      return console.error(`[Uppy] [${Co()}]`, ...e);
...
var km = {
  ...
  Xl = class {
    ...
    validateAggregateRestrictions(e, t) {
      ...
      if (s && e.filter(a => !a.isGhost).length + t.length > s) throw new Yt(`${this.getI18n()("youCanOnlyUploadX", {
        smart_count: s
      })}`);
      if (r) {
        ...
        if (n > r) throw new Yt(this.getI18n()("aggregateExceedsSize", {
          sizeAllowed: (0, yn.default)(r),
          size: (0, yn.default)(n)
        }));
      }
    }
    validateSingleFile(e) {
      ...
      if (s && !s.some(a => a.includes("/") ? e.type ? (0, Rm.default)(e.type.replace(/;.*?$/, ""), a) : !1 : a[0] === "." && e.extension ? e.extension.toLowerCase() === a.slice(1).toLowerCase() : !1)) {
        let a = s.join(", ");
        throw new Yt(this.getI18n()("youCanOnlyUploadFileTypes", {
          types: a
        }), {
          file: e
        });
      }
      if (t && e.size != null && e.size > t) throw new Yt(this.getI18n()("exceedsSize", {
        size: (0, yn.default)(t),
        file: e.name
      }), {
        file: e
      });
      if (r && e.size != null && e.size < r) throw new Yt(this.getI18n()("inferiorSize", {
        size: (0, yn.default)(r)
      }), {
        file: e
      });
    ...
    getMissingRequiredMetaFields(e) {
      let t = new Yt(this.getI18n()("missingRequiredMetaFieldOnFile", {
          fileName: e.name
        })),
        {
        ...
        s = [];
      for (let n of r) (!Object.hasOwn(e.meta, n) || e.meta[n] === "") && s.push(n);
      return {
        missingFields: s,
        error: t
      };
...
o(Xe, "_classPrivateFieldLooseKey");
var Tw = {
    version: "3.13.0"
  },
  Yl = {
  ...
  Pt = Xe("plugins"),
  ri = Xe("restricter"),
  vn = Xe("storeUnsubscribe"),
  lr = Xe("emitter"),
  ws = Xe("preProcessors"),
  Ss = Xe("uploaders"),
  hr = Xe("postProcessors"),
  si = Xe("informAndEmit"),
  _n = Xe("checkRequiredMetaFieldsOnFile"),
  Ac = Xe("checkRequiredMetaFields"),
  bn = Xe("assertNewUploadAllowed"),
  kc = Xe("transformFile"),
  wn = Xe("startIfAutoProceed"),
  Sn = Xe("checkAndUpdateFileState"),
  Tc = Xe("addListeners"),
  Ai = Xe("updateOnlineStatus"),
  Pn = Xe("requestClientById"),
  ur = Xe("createUpload"),
  Rc = Xe("getUpload"),
  Ps = Xe("removeUpload"),
  cr = Xe("runUpload");
Dm = Symbol.for("uppy test: getPlugins");
Im = Symbol.for("uppy test: createUpload");
var Ql = class i {
  static {
    o(this, "Uppy");
  }
  constructor(e) {
    Object.defineProperty(this, cr, {
      ...
      writable: !0,
      value: new Set()
    }), this.scheduledAutoProceed = null, this.wasOffline = !1, this.calculateProgress = (0, Nm.default)((s, n) => {
      ...
      this.setFileState(s.id, {
        progress: {
          ...
          percentage: u ? Math.round(n.bytesUploaded / n.bytesTotal * 100) : 0
        }
    ...
    this.opts = {
    ...
    }, e && e.logger && e.debug ? this.log("You are using a custom `logger`, but also set `debug: true`, which uses built-in logger to output logs to console. Ignoring `debug: true` and using your custom `logger`.", "warning") : e && e.debug && (this.opts.logger = Kl), this.log(`Using Core v${i.VERSION}`), this.i18nInit(), this.store = this.opts.store, this.setState({
      ...Yl,
      plugins: {},
      files: {},
      currentUploads: {},
      ...
      info: []
    }), J(this, ri)[ri] = new Xl(() => this.opts, () => this.i18n), J(this, vn)[vn] = this.store.subscribe((s, n, a) => {
      this.emit("state-update", s, n, a), this.updateAll(n);
    }), this.opts.debug && typeof window < "u" && (window[this.opts.id] = this), J(this, Tc)[Tc]();
  }
  emit(e) {
  ...
  i18nInit() {
    let e = o(r => this.log(`Missing i18n string: ${r}`, "error"), "onMissingKey"),
      t = new vs([this.defaultLocale, this.opts.locale], {
        onMissingKey: e
      });
  ...
  getObjectOfFilesPerState() {
    ...
    for (let S of s) {
      ...
      !T.uploadComplete && T.uploadStarted && (n.push(S), S.isPaused || y.push(S)), T.uploadStarted || a.push(S), (T.uploadStarted || T.preprocess || T.postprocess) && u.push(S), T.uploadStarted && l.push(S), S.isPaused && h.push(S), T.uploadComplete && d.push(S), S.error && p.push(S), (T.preprocess || T.postprocess) && b.push(S);
    }
    return {
      newFiles: a,
      startedFiles: u,
  ...
  addFile(e) {
    ...
    let [a] = r;
    return this.emit("file-added", a), this.emit("files-added", r), this.log(`Added file: ${a.name}, ${a.id}, mime type: ${a.type}`), J(this, wn)[wn](), a.id;
  }
  addFiles(e) {
    J(this, bn)[bn]();
    let {
 ...
 * ${l.message}`;
        ...
        details: u
      }, "error", this.opts.infoTimeout), typeof AggregateError == "function") throw new AggregateError(a, u);
      {
        let l = new Error(u);
        throw l.errors = a, l;
      }
    ...
    }), this.emit("files-added", r), r.length > 5 ? this.log(`Added batch of ${r.length} files`) : Object.values(r).forEach(u => {
 ...
 type: ${u.type}`);
  ...
  removeFiles(e, t) {
    ...
    e.forEach(p => {
      r[p] && (u[p] = r[p], delete n[p]);
    });
    function l(p) {
      return u[p] === void 0;
    }
    o(l, "fileIsNotRemoved"), Object.keys(a).forEach(p => {
      let y = s[p].fileIDs.filter(l);
      if (y.length === 0) {
        delete a[p];
        return;
      }
      ...
      if (y.length !== s[p].fileIDs.length && !b.individualCancellation) throw new Error("The installed uploader plugin does not allow removing files during an upload.");
      a[p] = {
        ...s[p],
        fileIDs: y
      };
    ...
    Object.keys(n).length === 0 && (h.allowNewUpload = !0, h.error = null, h.recoveredState = null), this.setState(h), this.calculateTotalProgress();
    let d = Object.keys(u);
    d.forEach(p => {
      this.emit("file-removed", u[p], t);
  ...
  cancelAll(e) {
    ...
    if (this.emit("cancel-all", {
      ...
      let {
        ...
        s = Object.keys(r);
      s.length && this.removeFiles(s, "cancel-all"), this.setState(Yl);
    }
  }
  retryUpload(e) {
    this.setFileState(e, {
  ...
  calculateTotalProgress() {
    let t = this.getFiles().filter(h => h.progress.uploadStarted || h.progress.preprocess || h.progress.postprocess);
    if (t.length === 0) {
    ...
    let n = r.reduce((h, d) => {
        var p;
        return h + ((p = d.progress.bytesTotal) != null ? p : 0);
      }, 0),
      a = n / r.length;
    n += a * s.length;
    let u = 0;
...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
  ...
  getPlugin(e) {
    for (let t of Object.values(J(this, Pt)[Pt])) {
      let r = t.find(s => s.id === e);
      if (r != null) return r;
    }
  }
  [Dm](e) {
    return J(this, Pt)[Pt][e];
  }
  iteratePlugins(e) {
    Object.values(J(this, Pt)[Pt]).flat(1).forEach(e);
  }
  removePlugin(e) {
    this.log(`Removing plugin ${e.id}`), this.emit("plugin-remove", e), e.uninstall && e.uninstall();
    let t = J(this, Pt)[Pt][e.type],
  ...
  close(e) {
    ...
    this.log(`Closing Uppy instance ${this.opts.id}: removing all files and uninstalling plugins`), this.cancelAll({
      reason: t
    }), J(this, vn)[vn](), this.iteratePlugins(r => {
      this.removePlugin(r);
    }), typeof window < "u" && window.removeEventListener && (window.removeEventListener("online", J(this, Ai)[Ai]), window.removeEventListener("offline", J(this, Ai)[Ai]));
  }
  hideInfo() {
    let {
      info: e
  ...
  registerRequestClient(e, t) {
    J(this, Pn)[Pn].set(e, t);
  }
  getRequestClientForFile(e) {
    if (!e.remote) throw new Error(`Tried to get RequestClient for a non-remote file ${e.id}`);
    let t = J(this, Pn)[Pn].get(e.remote.requestClientId);
    if (t == null) throw new Error(`requestClientId "${e.remote.requestClientId}" not registered for file "${e.id}"`);
    return t;
  }
  restore(e) {
    return this.log(`Core: attempting to restore upload "${e}"`), this.getState().currentUploads[e] ? J(this, cr)[cr](e) : (J(this, Ps)[Ps](e), Promise.reject(new Error("Nonexistent upload")));
  }
  [Im]() {
  ...
  upload() {
    var e;
    (e = J(this, Pt)[Pt].uploader) != null && e.length || this.log("No uploader type plugins are used", "warning");
    let {
        files: t
      } = this.getState(),
    ...
    return r === !1 ? Promise.reject(new Error("Not starting the upload because onBeforeUpload returned false")) : (r && typeof r == "object" && (t = r, this.setState({
      files: t
    })), Promise.resolve().then(() => J(this, ri)[ri].validateMinNumberOfFiles(t)).catch(s => {
      throw J(this, si)[si]([s]), s;
    }).then(() => {
      if (!J(this, Ac)[Ac](t)) throw new Yt(this.i18n("missingRequiredMetaField"));
    }).catch(s => {
      throw s;
    }).then(() => {
      let {
      ...
      Object.keys(t).forEach(l => {
        ...
        !h.progress.uploadStarted && n.indexOf(l) === -1 && a.push(h.id);
      });
...
function kw(i) {
  let {
    missingFields: e,
    error: t
  } = J(this, ri)[ri].getMissingRequiredMetaFields(i);
...
function Uw(i) {
  let e = !0;
  for (let t of Object.values(i)) J(this, _n)[_n](t) || (e = !1);
  return e;
}
...
function Dw(i) {
  ...
  if (e === !1) {
    let t = new Yt(this.i18n("noMoreFilesAllowed"), {
      file: i
    });
...
function Nw(i) {
  ...
  for (let a of i) try {
    ...
    if (!h && this.checkIfFileAlreadyExists(u.id)) throw new Yt(this.i18n("noDuplicates", {
      fileName: u.name
    }), {
      file: a
    });
    if (h === !1 && !l) throw new Yt("Cannot add the file because onBeforeFileAdded returned false.", {
      isUserFacing: !1,
      file: a
    });
    typeof h == "object" && h !== null && (u = h), J(this, ri)[ri].validateSingleFile(u), t[u.id] = u, r.push(u);
  } catch (u) {
    s.push(u);
  }
  try {
...
function Mw() {
  ...
  this.on("error", i), this.on("upload-error", (r, s, n) => {
    if (i(s, r, n), typeof s == "object" && s.message) {
      ...
      let u = new Error(this.i18n("failedToUpload", {
        file: (a = r?.name) != null ? a : ""
      }));
      u.isUserFacing = !0, u.details = s.message, s.details && (u.details += ` ${s.details}`), J(this, si)[si]([u]);
    } else J(this, si)[si]([s]);
  });
  let e = null;
  ...
  let t = o(r => {
    let s = r.filter(a => {
        ...
        return u || this.log(`Not setting progress for a file that has been removed: ${a?.id}`), u;
      }),
  ...
  this.on("upload-start", r => {
  ...
  }), this.on("upload-progress", this.calculateProgress), this.on("upload-success", (r, s) => {
    ...
    this.setFileState(r.id, {
      progress: {
        ...n,
        postprocess: J(this, hr)[hr].size > 0 ? {
          mode: "indeterminate"
        } : void 0,
        uploadComplete: !0,
        percentage: 100,
    ...
    r && J(this, _n)[_n](r);
  }), typeof window < "u" && window.addEventListener && (window.addEventListener("online", J(this, Ai)[Ai]), window.addEventListener("offline", J(this, Ai)[Ai]), setTimeout(J(this, Ai)[Ai], 3e3));
}
o(Mw, "_addListeners2");
function Bw(i, e) {
  e === void 0 && (e = {});
...
async function Hw(i) {
  let e = o(() => {
    ...
    t = e(),
    r = [...J(this, ws)[ws], ...J(this, Ss)[Ss], ...J(this, hr)[hr]];
  try {
  ...
  let s;
  return t && (s = t.result, this.emit("complete", s), J(this, Ps)[Ps](i)), s == null && this.log(`Not setting result for an upload that has been removed: ${i}`), s;
}
o(Hw, "_runUpload2");
Ql.VERSION = Tw.version;
var Mm = Ql;
exports.Uppy = Mm;
var En,
  le,
...
function c(i, e, t) {
  ...
  if (arguments.length > 2 && (a.children = arguments.length > 3 ? En.call(arguments, 2) : t), typeof i == "function" && i.defaultProps != null) for (n in i.defaultProps) a[n] === void 0 && (a[n] = i.defaultProps[n]);
...
o(Te, "d");
function Ao(i, e) {
  if (e == null) return i.__ ? Ao(i.__, i.__.__k.indexOf(i) + 1) : null;
  for (var t; e < i.__k.length; e++) if ((t = i.__k[e]) != null && t.__e != null) return t.__e;
  return typeof i.type == "function" ? Ao(i) : null;
}
o(Ao, "_");
function Km(i) {
  var e, t;
...
o(Km, "k");
function jm(i) {
  (!i.__d && (i.__d = !0) && xn.push(i) && !Zl.__r++ || Bm !== le.debounceRendering) && ((Bm = le.debounceRendering) || setTimeout)(Zl);
}
o(jm, "b");
function Zl() {
  for (var i; Zl.__r = xn.length;) i = xn.sort(function (e, t) {
    return e.__v.__b - t.__v.__b;
  }), xn = [], i.some(function (e) {
    var t, r, s, n, a, u;
    e.__d && (a = (n = (t = e).__v).__e, (u = t.__P) && (r = [], (s = dr({}, n)).__v = n.__v + 1, Uc(u, n, s, t.__n, u.ownerSVGElement !== void 0, n.__h != null ? [a] : null, r, a ?? Ao(n), n.__h), Jm(r, n), n.__e != a && Km(n)));
  });
}
o(Zl, "g");
function Xm(i, e, t, r, s, n, a, u, l, h) {
  var d,
    p,
    y,
    b,
    ...
    _ = r && r.__k || Vm,
    R = _.length;
  for (t.__k = [], d = 0; d < e.length; d++) if ((b = t.__k[d] = (b = e[d]) == null || typeof b == "boolean" ? null : typeof b == "string" || typeof b == "number" || typeof b == "bigint" ? Fn(null, b, null, null, b) : Array.isArray(b) ? Fn(vt, {
    children: b
  }, null, null, null) : b.__b > 0 ? Fn(b.type, b.props, b.key, null, b.__v) : b) != null) {
    if (b.__ = t, b.__b = t.__b + 1, (y = _[d]) === null || y && b.key == y.key && b.type === y.type) _[d] = void 0;else for (p = 0; p < R; p++) {
      if ((y = _[p]) && b.key == y.key && b.type === y.type) {
        _[p] = void 0;
        break;
      }
      y = null;
    }
    Uc(i, b, y = y || Jl, s, n, a, u, l, h), S = b.__e, (p = b.ref) && y.ref != p && (O || (O = []), y.ref && O.push(y.ref, null, b), O.push(p, b.__c || S, b)), S != null ? (T == null && (T = S), typeof b.type == "function" && b.__k === y.__k ? b.__d = l = Ym(b, l, i) : l = Qm(i, b, y, _, S, l), typeof t.type == "function" && (t.__d = l)) : l && y.__e == l && l.parentNode != i && (l = Ao(y));
  }
  for (t.__e = T, d = R; d--;) _[d] != null && (typeof t.type == "function" && _[d].__e != null && _[d].__e == t.__d && (t.__d = Ao(r, d + 1)), eg(_[d], _[d]));
  if (O) for (d = 0; d < O.length; d++) Zm(O[d], O[++d], O[++d]);
}
o(Xm, "w");
function Ym(i, e, t) {
  for (var r, s = i.__k, n = 0; s && n < s.length; n++) (r = s[n]) && (r.__ = i, e = typeof r.type == "function" ? Ym(r, e, t) : Qm(t, r, r, s, r.__e, e));
  return e;
}
o(Ym, "m");
function Pi(i, e) {
...
o(Pi, "x");
function Qm(i, e, t, r, s, n) {
  var a, u, l;
  if (e.__d !== void 0) a = e.__d, e.__d = void 0;else if (t == null || s != n || s.parentNode == null) e: if (n == null || n.parentNode !== i) i.appendChild(s), a = null;else {
    for (u = n, l = 0; (u = u.nextSibling) && l < r.length; l += 2) if (u == s) break e;
...
function Ww(i, e, t, r, s) {
  var n;
  for (n in t) n === "children" || n === "key" || n in e || eu(i, n, null, t[n], r);
  for (n in e) s && typeof e[n] != "function" || n === "children" || n === "key" || n === "value" || n === "checked" || t[n] === e[n] || eu(i, n, e[n], t[n], r);
}
o(Ww, "C");
function zm(i, e, t) {
  e[0] === "-" ? i.setProperty(e, t) : i[e] = t == null ? "" : typeof t != "number" || Vw.test(e) ? t : t + "px";
}
o(zm, "$");
function eu(i, e, t, r, s) {
  var n;
  e: if (e === "style") {
    if (typeof t == "string") i.style.cssText = t;else {
      if (typeof r == "string" && (i.style.cssText = r = ""), r) for (e in r) t && e in t || zm(i.style, e, "");
      if (t) for (e in t) r && t[e] === r[e] || zm(i.style, e, t[e]);
    }
  } else if (e[0] === "o" && e[1] === "n") n = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in i ? e.toLowerCase().slice(2) : e.slice(2), i.l || (i.l = {}), i.l[e + n] = t, t ? r || i.addEventListener(e, n ? $m : Hm, n) : i.removeEventListener(e, n ? $m : Hm, n);else if (e !== "dangerouslySetInnerHTML") {
    if (s) e = e.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");else if (e !== "href" && e !== "list" && e !== "form" && e !== "tabIndex" && e !== "download" && e in i) try {
      i[e] = t ?? "";
      break e;
    } catch {}
...
function Uc(i, e, t, r, s, n, a, u, l) {
  ...
  t.__h != null && (l = t.__h, u = e.__e = t.__e, e.__h = null, n = [u]), (h = le.__b) && h(e);
  try {
    e: if (typeof q == "function") {
      if (O = e.props, _ = (h = q.contextType) && r[h.__c], R = h ? _ ? _.props.value : h.__ : r, t.__c ? T = (d = e.__c = t.__c).__ = d.__E : ("prototype" in q && q.prototype.render ? e.__c = d = new q(O, R) : (e.__c = d = new Te(O, R), d.constructor = q, d.render = Kw), _ && _.sub(d), d.props = O, d.state || (d.state = {}), d.context = R, d.__n = r, p = d.__d = !0, d.__h = []), d.__s == null && (d.__s = d.state), q.getDerivedStateFromProps != null && (d.__s == d.state && (d.__s = dr({}, d.__s)), dr(d.__s, q.getDerivedStateFromProps(O, d.__s))), y = d.props, b = d.state, p) q.getDerivedStateFromProps == null && d.componentWillMount != null && d.componentWillMount(), d.componentDidMount != null && d.__h.push(d.componentDidMount);else {
        if (q.getDerivedStateFromProps == null && O !== y && d.componentWillReceiveProps != null && d.componentWillReceiveProps(O, R), !d.__e && d.shouldComponentUpdate != null && d.shouldComponentUpdate(O, d.__s, R) === !1 || e.__v === t.__v) {
          d.props = O, d.state = d.__s, e.__v !== t.__v && (d.__d = !1), d.__v = e, e.__e = t.__e, e.__k = t.__k, e.__k.forEach(function (G) {
            G && (G.__ = e);
          }), d.__h.length && a.push(d);
          break e;
        }
        d.componentWillUpdate != null && d.componentWillUpdate(O, d.__s, R), d.componentDidUpdate != null && d.__h.push(function () {
          d.componentDidUpdate(y, b, S);
        });
      }
      if (d.context = R, d.props = O, d.__v = e, d.__P = i, $ = le.__r, W = 0, "prototype" in q && q.prototype.render) d.state = d.__s, d.__d = !1, $ && $(e), h = d.render(d.props, d.state, d.context);else do d.__d = !1, $ && $(e), h = d.render(d.props, d.state, d.context), d.state = d.__s; while (d.__d && ++W < 25);
      d.state = d.__s, d.getChildContext != null && (r = dr(dr({}, r), d.getChildContext())), p || d.getSnapshotBeforeUpdate == null || (S = d.getSnapshotBeforeUpdate(y, b)), K = h != null && h.type === vt && h.key == null ? h.props.children : h, Xm(i, Array.isArray(K) ? K : [K], e, t, r, s, n, a, u, l), d.base = e.__e, e.__h = null, d.__h.length && a.push(d), T && (d.__E = d.__ = null), d.__e = !1;
    } else n == null && e.__v === t.__v ? (e.__k = t.__k, e.__e = t.__e) : e.__e = Gw(t.__e, e, t, r, s, n, a, l);
    (h = le.diffed) && h(e);
  } catch (G) {
    e.__v = null, (l || n != null) && (e.__e = u, e.__h = !!l, n[n.indexOf(u)] = null), le.__e(G, e, t);
  }
}
o(Uc, "j");
function Jm(i, e) {
  le.__c && le.__c(e, i), i.some(function (t) {
    try {
...
function Gw(i, e, t, r, s, n, a, u) {
  var l,
    ...
    S = 0;
  if (b === "svg" && (s = !0), n != null) {
    for (; S < n.length; S++) if ((l = n[S]) && "setAttribute" in l == !!b && (b ? l.localName === b : l.nodeType === 3)) {
      i = l, n[S] = null;
      break;
    }
  }
  if (i == null) {
    ...
    i = s ? document.createElementNS("http://www.w3.org/2000/svg", b) : document.createElement(b, y.is && y), n = null, u = !1;
  }
  if (b === null) p === y || u && i.data === y || (i.data = y);else {
    if (n = n && En.call(i.childNodes), h = (p = t.props || Jl).dangerouslySetInnerHTML, d = y.dangerouslySetInnerHTML, !u) {
      if (n != null) for (p = {}, S = 0; S < i.attributes.length; S++) p[i.attributes[S].name] = i.attributes[S].value;
      (d || h) && (d && (h && d.__html == h.__html || d.__html === i.innerHTML) || (i.innerHTML = d && d.__html || ""));
    }
    if (Ww(i, y, p, s, u), d) e.__k = [];else if (S = e.props.children, Xm(i, Array.isArray(S) ? S : [S], e, t, r, s && b !== "foreignObject", n, a, n ? n[0] : t.__k && Ao(t, 0), u), n != null) for (S = n.length; S--;) n[S] != null && Wm(n[S]);
    u || ("value" in y && (S = y.value) !== void 0 && (S !== i.value || b === "progress" && !S || b === "option" && S !== p.value) && eu(i, "value", S, p.value, !1), "checked" in y && (S = y.checked) !== void 0 && S !== i.checked && eu(i, "checked", S, p.checked, !1));
  }
  return i;
}
o(Gw, "L");
...
function eg(i, e, t) {
  var r, s;
  if (le.unmount && le.unmount(i), (r = i.ref) && (r.current && r.current !== i.__e || Zm(r, null, e)), (r = i.__c) != null) {
  ...
  if (r = i.__k) for (s = 0; s < r.length; s++) r[s] && eg(r[s], e, typeof i.type != "function");
  t || i.__e == null || Wm(i.__e), i.__e = i.__d = void 0;
}
o(eg, "N");
function Kw(i, e, t) {
...
function Dc(i, e, t) {
  var r, s, n;
  le.__ && le.__(i, e), s = (r = typeof t == "function") ? null : t && t.__k || e.__k, n = [], Uc(e, i = (!r && t || e).__k = c(vt, null, [i]), s || Jl, Jl, e.ownerSVGElement !== void 0, !r && t ? [t] : s ? null : e.firstChild ? En.call(e.childNodes) : null, n, !r && t ? t : s ? s.__e : e.firstChild, r), Jm(n, i);
}
o(Dc, "P");
function tu(i, e, t) {
  var r,
...
}, "i"), Te.prototype.setState = function (i, e) {
  var t;
  t = this.__s != null && this.__s !== this.state ? this.__s : this.__s = dr({}, this.state), typeof i == "function" && (i = i(dr({}, t), this.props)), i && dr(t, i), i != null && this.__v && (e && this.__h.push(e), jm(this));
}, Te.prototype.forceUpdate = function (i) {
  this.__v && (this.__e = !0, i && this.__h.push(i), jm(this));
}, Te.prototype.render = vt, xn = [], Zl.__r = 0, qw = 0;
function On(i) {
  return typeof i != "object" || i === null || !("nodeType" in i) ? !1 : i.nodeType === Node.ELEMENT_NODE;
}
o(On, "isDOMElement");
function Xw(i, e) {
  return e === void 0 && (e = document), typeof i == "string" ? e.querySelector(i) : On(i) ? i : null;
}
o(Xw, "findDOMElement");
var iu = Xw;
function Yw(i) {
...
var Oe = class {
  ...
  i18nInit() {
    let e = new vs([this.defaultLocale, this.uppy.locale, this.opts.locale]);
...
exports.BasePlugin = Oe;
function tg(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
}
o(tg, "_classPrivateFieldLooseBase");
var Qw = 0;
function Jw(i) {
...
o(Zw, "debounce");
var Cn = Jw("updateUI"),
  Ic = class i extends Oe {
    static {
      o(this, "UIPlugin");
    }
    constructor() {
      super(...arguments), Object.defineProperty(this, Cn, {
        writable: !0,
        value: void 0
      });
    }
    ...
    mount(e, t) {
      ...
      if (s) {
        ...
        return u.classList.add("uppy-Root"), tg(this, Cn)[Cn] = Zw(l => {
          this.uppy.getPlugin(this.id) && (Dc(this.render(l), u), this.afterUpdate());
        }), this.uppy.log(`Installing ${r} to a DOM element '${e}'`), this.opts.replaceTargetContent && (s.innerHTML = ""), Dc(this.render(this.uppy.getState()), u), this.el = u, s.appendChild(u), u.dir = this.opts.direction || ru(u) || "ltr", this.onMount(), this.el;
      }
    ...
    update(e) {
      if (this.el != null) {
        var t, r;
        (t = (r = tg(this, Cn))[Cn]) == null || t.call(r, e);
      }
    }
    unmount() {
...
var tS = Object.prototype.toString,
  ...
  rS = new Set(["Failed to fetch", "NetworkError when attempting to fetch resource.", "The Internet connection appears to be offline.", "Load failed", "Network request failed", "fetch failed"]);
function Nc(i) {
  return i && iS(i) && i.name === "TypeError" && typeof i.message == "string" ? i.message === "Load failed" ? i.stack === void 0 : rS.has(i.message) : !1;
}
o(Nc, "isNetworkError");
  ...
  return new Promise((t, r) => {
    ...
    s.attempt(async u => {
      try {
        ...
        try {
          if (!(l instanceof Error)) throw new TypeError(`Non-error was thrown: "${l}". You should only throw errors.`);
          if (l instanceof To) throw l.originalError;
          if (l instanceof TypeError && !Nc(l)) throw l;
          if (await e.onFailedAttempt(lg(l, u, e)), !s.retry(l)) throw s.mainError();
        } catch (h) {
          lg(h, u, e), a(), r(h);
        }
      }
...
var Bc = class extends Error {
    ...
    constructor(e, t) {
      super(e), this.cause = t?.cause, this.cause && oi(this.cause, "isNetworkError") ? this.isNetworkError = this.cause.isNetworkError : this.isNetworkError = !1;
    }
  },
  pr = Bc;
var cg = be(ql(), 1);
...
o(ou, "_classPrivateFieldLooseKey");
var nS = {
  version: "3.8.1"
};
function aS(i) {
...
async function uS(i) {
  ...
  throw i.status >= 400 && i.status <= 499 && t.message ? new ig(t.message) : new $c({
    statusCode: i.status,
    message: e
  });
}
o(uS, "handleJSONResponse");
var mr = ou("companionHeaders"),
  An = ou("getUrl"),
  Hc = ou("requestSocketToken"),
  Tn = ou("awaitRemoteFileUpload");
...
var It = class {
  ...
  constructor(e, t) {
    ...
    }), this.uppy = e, this.opts = t, this.onReceiveResponse = this.onReceiveResponse.bind(this), fr(this, mr)[mr] = t?.companionHeaders;
  }
  ...
  async request(e) {
    ...
    try {
      ...
      throw u.isAuthError || u.name === "UserFacingApiError" || u.name === "AbortError" ? u : new pr(`Could not ${r} ${fr(this, An)[An](t)}`, {
        cause: u
      });
    }
  }
  ...
  async uploadRemoteFile(e, t, r) {
    ...
    try {
      ...
      return await su(async () => {
        var u;
        let l = (u = this.uppy.getFile(e.id)) == null ? void 0 : u.serverToken;
        if (l != null) return this.uppy.log(`Connecting to exiting websocket ${l}`), fr(this, Tn)[Tn]({
          file: e,
          queue: a(),
          signal: n
        });
        let d = await a().wrapPromiseFunction(async function () {
          try {
            return await fr(s, Hc)[Hc](...arguments);
          } catch (p) {
            if (p.isAuthError) throw new To(p);
            if (p.cause == null) throw p;
            let y = p.cause,
              b = o(() => [408, 409, 429, 418, 423].includes(y.statusCode) || y.statusCode >= 500 && y.statusCode <= 599 && ![501, 505].includes(y.statusCode), "isRetryableHttpError");
            throw y.name === "HttpError" && !b() ? new To(y) : y;
          }
        }, {
          priority: -1
        })({
        ...
        retries: fg,
        signal: n,
        onFailedAttempt: u => this.uppy.log(`Retrying upload due to: ${u.message}`, "warning")
      });
    } catch (n) {
      ...
      let l = e.serverToken,
        ...
        S = o((G, te) => {
          if (d == null || d.readyState !== d.OPEN) {
            var re;
            this.uppy.log(`Cannot send "${G}" to socket ${e.id} because the socket state was ${String((re = d) == null ? void 0 : re.readyState)}`, "warning");
            return;
          }
      ...
      let O = o(async () => {
          ...
          let G = o(re => {
            ...
            this.uppy.setFileState(e.id, {
              serverToken: null
            }), (Ee = p) == null || Ee.abort == null || Ee.abort(), u(re);
          }, "onFatalError");
          function te() {
            clearTimeout(y), !b && (y = setTimeout(() => G(new Error("Timeout waiting for message from Companion socket")), lS));
          }
          o(te, "resetActivityTimeout");
          try {
            await t.wrapPromiseFunction(async () => {
              await su(o(async () => new Promise((Ee, Re) => {
                d = new WebSocket(`${h}/api/${l}`), te(), d.addEventListener("close", () => {
                  d = void 0, Re(new Error("Socket closed unexpectedly"));
                }), d.addEventListener("error", we => {
                  var Pe;
                  this.uppy.log(`Companion socket error ${JSON.stringify(we)}, closing socket`, "warning"), (Pe = d) == null || Pe.close();
                  ...
                  try {
                    ...
                    switch (E) {
                      case "progress":
                        {
                          hg(this, L, this.uppy.getFile(e.id));
                          break;
                        }
                      case "success":
                        {
                          var Pe, Le, C, P;
                          let z = (Pe = L.response) == null ? void 0 : Pe.responseText;
                          this.uppy.emit("upload-success", this.uppy.getFile(e.id), {
                            uploadURL: L.url,
                            status: (Le = (C = L.response) == null ? void 0 : C.status) != null ? Le : 200,
                            body: z ? JSON.parse(z) : void 0
                          }), (P = p) == null || P.abort == null || P.abort(), a();
                          break;
                        }
                      case "error":
                        {
                      ...
                      default:
                        this.uppy.log(`Companion socket unknown action ${E}`, "warning");
                    }
                  } catch (E) {
                    G(E);
                  }
                ...
                let $e = o(() => {
                  this.uppy.log(`Closing socket ${e.id}`, "info"), clearTimeout(y), d && d.close(), d = void 0;
                }, "closeSocket");
                ...
                signal: p.signal,
                onFailedAttempt: () => {
                  p.signal.aborted || this.uppy.log(`Retrying websocket ${e.id}`, "info");
                }
              });
            })().abortOn(p.signal);
          } catch (re) {
        ...
        _ = o(G => {
          if (n.resumableUploads) if (b = G, d && T(), G) {
            var te;
            (te = p) == null || te.abort == null || te.abort();
          } else O();
        }, "pause"),
        R = o(G => {
          var te;
          n.individualCancellation && G.id === e.id && (S("cancel"), (te = p) == null || te.abort == null || te.abort(), this.uppy.log(`upload ${e.id} was removed`, "info"), a());
        }, "onFileRemove"),
        $ = o(G => {
          var te;
          let {
          ...
          re === "user" && S("cancel"), (te = p) == null || te.abort == null || te.abort(), this.uppy.log(`upload ${e.id} was canceled`, "info"), a();
        }, "onCancelAll"),
        W = o((G, te) => {
          G === e.id && _(te);
        }, "onFilePausedChange"),
        K = o(() => _(!0), "onPauseAll"),
        q = o(() => _(!1), "onResumeAll");
      this.uppy.on("file-removed", R), this.uppy.on("cancel-all", $), this.uppy.on("upload-pause", W), this.uppy.on("pause-all", K), this.uppy.on("resume-all", q), s = o(() => {
        this.uppy.off("file-removed", R), this.uppy.off("cancel-all", $), this.uppy.off("upload-pause", W), this.uppy.off("pause-all", K), this.uppy.off("resume-all", q);
...
var pS = o(i => i.split("-").map(e => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), "getName");
function fS() {
...
o(mg, "getRegex");
function mS(i, e) {
  return (Array.isArray(e) ? e.map(mg) : [mg(e)]).some(r => r?.test(i) || r?.test(`${i}/`));
}
o(mS, "isOriginAllowed");
var Ti = Vc("refreshingTokenPromise"),
  Rn = Vc("getAuthToken"),
  Ri = Vc("getPlugin"),
  Ye = class extends It {
    static {
    ...
    constructor(e, t) {
      var r;
      super(e, t), Object.defineProperty(this, Ri, {
        value: yS
        ...
        writable: !0,
        value: void 0
      }), this.provider = t.provider, this.id = this.provider, this.name = this.opts.name || pS(this.id), this.pluginId = this.opts.pluginId, this.tokenKey = `companion-${this.pluginId}-auth-token`, this.companionKeysParams = this.opts.companionKeysParams, this.preAuthToken = null, this.supportsRefreshToken = (r = t.supportsRefreshToken) != null ? r : !0;
    }
    async headers() {
      let [e, t] = await Promise.all([super.headers(), xi(this, Rn)[Rn]()]),
        r = {};
    ...
    onReceiveResponse(e) {
      ...
      let t = xi(this, Ri)[Ri](),
        s = t.getPluginState().authenticated ? e.status !== qc : e.status < 400;
      return t.setPluginState({
        authenticated: s
      }), e;
    }
    async setAuthToken(e) {
      return xi(this, Ri)[Ri]().storage.setItem(this.tokenKey, e);
    }
    async removeAuthToken() {
      return xi(this, Ri)[Ri]().storage.removeItem(this.tokenKey);
    }
    async ensurePreAuth() {
    ...
    async loginSimpleAuth(e) {
      let {
        ...
        n = await this.post(`${this.id}/simple-auth`, {
          form: r
        }, {
          qs: {
            uppyVersions: t
    ...
    async loginOAuth(e) {
      ...
      return await this.ensurePreAuth(), s.throwIfAborted(), new Promise((n, a) => {
        let u = this.authUrl({
          ...
          d = o(p => {
            if (p.source !== l) {
              let S = "";
              try {
                S = JSON.stringify(p.data);
              } catch {}
              this.uppy.log(`ignoring event from unknown source ${S}`, "warning");
              return;
            }
            let {
              companionAllowedHosts: y
            } = xi(this, Ri)[Ri]().opts;
            if (!mS(p.origin, y)) {
              a(new Error(`rejecting event from ${p.origin} vs allowed pattern ${y}`));
              return;
            }
            let b = typeof p.data == "string" ? JSON.parse(p.data) : p.data;
            if (b.error) {
              let {
                  uppy: S
                } = this,
        ...
        h = o(() => {
          l?.close(), window.removeEventListener("message", d), s.removeEventListener("abort", h);
        }, "cleanup"), s.addEventListener("abort", h), window.addEventListener("message", d);
      });
    }
    async login(e) {
      let {
    ...
    async request() {
      ...
      try {
        ...
        let t = await xi(this, Rn)[Rn]();
        if (!e.isAuthError || !t) throw e;
        return xi(this, Ti)[Ti] == null && (xi(this, Ti)[Ti] = (async () => {
          try {
            ...
            xi(this, Ti)[Ti] = void 0;
          }
        })()), await xi(this, Ti)[Ti], super.request(...arguments);
      }
    }
...
async function gS() {
  return xi(this, Ri)[Ri]().storage.getItem(this.tokenKey);
}
o(gS, "_getAuthToken2");
function yS() {
...
o(yS, "_getPlugin2");
var vS = o(i => i.split("-").map(e => e.charAt(0).toUpperCase() + e.slice(1)).join(" "), "getName"),
  Fs = class extends It {
    static {
      o(this, "SearchProvider");
    }
    constructor(e, t) {
      super(e, t), this.provider = t.provider, this.id = this.provider, this.name = this.opts.name || vS(this.id), this.pluginId = this.opts.pluginId;
    }
    fileUrl(e) {
...
function Qe(i, e) {
  if (i) {
    if (typeof i != "string" && !Array.isArray(i) && !(i instanceof RegExp)) throw new TypeError('The option "companionAllowedHosts" must be one of string, Array, RegExp');
    return i;
  }
  return /^(?!https?:\/\/).*$/i.test(e) ? `https://${e.replace(/^\/\//, "")}` : new URL(e).origin;
}
o(Qe, "getAllowedHosts");
var Je = {};
vc(Je, {
  getItem: () => wS,
  removeItem: () => SS,
...
o(Ge, "_classPrivateFieldLooseBase");
var PS = 0;
function Un(i) {
  return "__private_" + PS++ + "_" + i;
}
o(Un, "_classPrivateFieldLooseKey");
var gr = Un("queued"),
  Es = Un("emitter"),
  ki = Un("isOpen"),
  ht = Un("socket"),
  Wc = Un("handleMessage");
gg = Symbol.for("uppy test: getSocket");
yg = Symbol.for("uppy test: getQueued");
var kn = class {
  static {
    o(this, "UppySocket");
  }
  ...
  get isOpen() {
    return Ge(this, ki)[ki];
  }
  [gg]() {
    return Ge(this, ht)[ht];
  }
  [yg]() {
    return Ge(this, gr)[gr];
  }
  open() {
    Ge(this, ht)[ht] == null && (Ge(this, ht)[ht] = new WebSocket(this.opts.target), Ge(this, ht)[ht].onopen = () => {
      for (Ge(this, ki)[ki] = !0; Ge(this, gr)[gr].length > 0 && Ge(this, ki)[ki];) {
        let e = Ge(this, gr)[gr].shift();
        this.send(e.action, e.payload);
      }
    }, Ge(this, ht)[ht].onclose = () => {
      Ge(this, ki)[ki] = !1, Ge(this, ht)[ht] = null;
    }, Ge(this, ht)[ht].onmessage = Ge(this, Wc)[Wc]);
  }
  close() {
    var e;
    (e = Ge(this, ht)[ht]) == null || e.close();
  }
  send(e, t) {
    if (!Ge(this, ki)[ki]) {
      Ge(this, gr)[gr].push({
    ...
    Ge(this, ht)[ht].send(JSON.stringify({
      action: e,
      payload: t
    }));
  }
  on(e, t) {
    Ge(this, Es)[Es].on(e, t);
  }
  emit(e, t) {
    Ge(this, Es)[Es].emit(e, t);
  }
  once(e, t) {
    Ge(this, Es)[Es].once(e, t);
  }
};
var yh = {};
vc(yh, {
...
var In = class extends Error {
  ...
  Pg = o(i => globalThis.DOMException === void 0 ? new Xc(i) : new DOMException(i), "getDOMException"),
  _g = o(i => {
    let e = i.reason === void 0 ? Pg("This operation was aborted.") : i.reason;
    return e instanceof Error ? e : Pg(e);
  }, "getAbortedReason");
function Yc(i, e, t, r) {
  let s,
    n = new Promise((a, u) => {
      ...
      if (r = {
        ...
        l.aborted && u(_g(l)), l.addEventListener("abort", () => {
          u(_g(l));
        });
      }
      s = r.customTimers.setTimeout.call(void 0, () => {
        ...
        let l = typeof t == "string" ? t : `Promise timed out after ${e} milliseconds`,
          h = t instanceof Error ? t : new In(l);
...
var Os = function (i, e, t, r) {
  ...
  Jc = class {
    ...
    enqueue(e, t) {
      ...
      if (this.size && Os(this, yr, "f")[this.size - 1].priority >= t.priority) {
        Os(this, yr, "f").push(r);
        return;
      }
      let s = Qc(Os(this, yr, "f"), r, (n, a) => a.priority - n.priority);
      Os(this, yr, "f").splice(s, 0, r);
    }
    dequeue() {
      let e = Os(this, yr, "f").shift();
      return e?.run;
    }
    filter(e) {
      return Os(this, yr, "f").filter(t => t.priority === e.priority).map(t => t.run);
    }
    get size() {
      return Os(this, yr, "f").length;
    }
  };
yr = new WeakMap();
var xg = Jc;
var Me = function (i, e, t, r, s) {
  ...
  th = class extends Kc.default {
    static {
      o(this, "PQueue");
    }
    constructor(e) {
      var t, r, s, n;
      if (super(), Ze.add(this), Nn.set(this, void 0), Mn.set(this, void 0), Vr.set(this, 0), du.set(this, void 0), Bn.set(this, void 0), au.set(this, 0), Ui.set(this, void 0), Ln.set(this, void 0), ni.set(this, void 0), lu.set(this, void 0), ai.set(this, 0), jn.set(this, void 0), qr.set(this, void 0), uu.set(this, void 0), Object.defineProperty(this, "timeout", {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: void 0
        ...
        queueClass: xg,
        ...e
      }, !(typeof e.intervalCap == "number" && e.intervalCap >= 1)) throw new TypeError(`Expected \`intervalCap\` to be a number from 1 and up, got \`${(r = (t = e.intervalCap) === null || t === void 0 ? void 0 : t.toString()) !== null && r !== void 0 ? r : ""}\` (${typeof e.intervalCap})`);
      if (e.interval === void 0 || !(Number.isFinite(e.interval) && e.interval >= 0)) throw new TypeError(`Expected \`interval\` to be a finite number >= 0, got \`${(n = (s = e.interval) === null || s === void 0 ? void 0 : s.toString()) !== null && n !== void 0 ? n : ""}\` (${typeof e.interval})`);
      Me(this, Nn, e.carryoverConcurrencyCount, "f"), Me(this, Mn, e.intervalCap === Number.POSITIVE_INFINITY || e.interval === 0, "f"), Me(this, du, e.intervalCap, "f"), Me(this, Bn, e.interval, "f"), Me(this, ni, new e.queueClass(), "f"), Me(this, lu, e.queueClass, "f"), this.concurrency = e.concurrency, this.timeout = e.timeout, Me(this, uu, e.throwOnTimeout === !0, "f"), Me(this, qr, e.autoStart === !1, "f");
    }
    get concurrency() {
      return ie(this, jn, "f");
    }
    set concurrency(e) {
      ...
      Me(this, jn, e, "f"), ie(this, Ze, "m", pu).call(this);
    }
    async add(e, t = {}) {
      return t = {
        timeout: this.timeout,
        throwOnTimeout: ie(this, uu, "f"),
        ...t
      }, new Promise((r, s) => {
        ie(this, ni, "f").enqueue(async () => {
          var n, a, u;
          Me(this, ai, (a = ie(this, ai, "f"), a++, a), "f"), Me(this, Vr, (u = ie(this, Vr, "f"), u++, u), "f");
          try {
            if (!((n = t.signal) === null || n === void 0) && n.aborted) throw new fu("The task was aborted.");
            let l = e({
              signal: t.signal
            });
            t.timeout && (l = Yc(Promise.resolve(l), t.timeout)), t.signal && (l = Promise.race([l, ie(this, Ze, "m", Tg).call(this, t.signal)]));
            let h = await l;
            r(h), this.emit("completed", h);
          } catch (l) {
            if (l instanceof In && !t.throwOnTimeout) {
              r();
              return;
            }
            s(l), this.emit("error", l);
          } finally {
            ie(this, Ze, "m", Ag).call(this);
          }
        }, t), this.emit("add"), ie(this, Ze, "m", cu).call(this);
      });
    }
    async addAll(e, t) {
    ...
    start() {
      return ie(this, qr, "f") ? (Me(this, qr, !1, "f"), ie(this, Ze, "m", pu).call(this), this) : this;
    }
    pause() {
      Me(this, qr, !0, "f");
    }
    clear() {
      Me(this, ni, new (ie(this, lu, "f"))(), "f");
    }
    async onEmpty() {
      ie(this, ni, "f").size !== 0 && (await ie(this, Ze, "m", hu).call(this, "empty"));
    }
    async onSizeLessThan(e) {
      ie(this, ni, "f").size < e || (await ie(this, Ze, "m", hu).call(this, "next", () => ie(this, ni, "f").size < e));
    }
    async onIdle() {
      ie(this, ai, "f") === 0 && ie(this, ni, "f").size === 0 || (await ie(this, Ze, "m", hu).call(this, "idle"));
    }
    get size() {
...
Nn = new WeakMap(), Mn = new WeakMap(), Vr = new WeakMap(), du = new WeakMap(), Bn = new WeakMap(), au = new WeakMap(), Ui = new WeakMap(), Ln = new WeakMap(), ni = new WeakMap(), lu = new WeakMap(), ai = new WeakMap(), jn = new WeakMap(), qr = new WeakMap(), uu = new WeakMap(), Ze = new WeakSet(), Fg = o(function () {
  return ie(this, Mn, "f") || ie(this, Vr, "f") < ie(this, du, "f");
}, "_PQueue_doesIntervalAllowAnother_get"), Eg = o(function () {
  return ie(this, ai, "f") < ie(this, jn, "f");
}, "_PQueue_doesConcurrentAllowAnother_get"), Ag = o(function () {
  var e;
  Me(this, ai, (e = ie(this, ai, "f"), e--, e), "f"), ie(this, Ze, "m", cu).call(this), this.emit("next");
}, "_PQueue_next"), Og = o(function () {
  ie(this, Ze, "m", eh).call(this), ie(this, Ze, "m", Zc).call(this), Me(this, Ln, void 0, "f");
}, "_PQueue_onResumeInterval"), Cg = o(function () {
  let e = Date.now();
  if (ie(this, Ui, "f") === void 0) {
    let t = ie(this, au, "f") - e;
    if (t < 0) Me(this, Vr, ie(this, Nn, "f") ? ie(this, ai, "f") : 0, "f");else return ie(this, Ln, "f") === void 0 && Me(this, Ln, setTimeout(() => {
      ie(this, Ze, "m", Og).call(this);
    }, t), "f"), !0;
  }
  return !1;
}, "_PQueue_isIntervalPaused_get"), cu = o(function () {
  if (ie(this, ni, "f").size === 0) return ie(this, Ui, "f") && clearInterval(ie(this, Ui, "f")), Me(this, Ui, void 0, "f"), this.emit("empty"), ie(this, ai, "f") === 0 && this.emit("idle"), !1;
  if (!ie(this, qr, "f")) {
    let e = !ie(this, Ze, "a", Cg);
    if (ie(this, Ze, "a", Fg) && ie(this, Ze, "a", Eg)) {
      let t = ie(this, ni, "f").dequeue();
      return t ? (this.emit("active"), t(), e && ie(this, Ze, "m", Zc).call(this), !0) : !1;
    }
  }
  return !1;
}, "_PQueue_tryToStartAnother"), Zc = o(function () {
  ie(this, Mn, "f") || ie(this, Ui, "f") !== void 0 || (Me(this, Ui, setInterval(() => {
    ie(this, Ze, "m", eh).call(this);
  }, ie(this, Bn, "f")), "f"), Me(this, au, Date.now() + ie(this, Bn, "f"), "f"));
}, "_PQueue_initializeIntervalIfNeeded"), eh = o(function () {
  ie(this, Vr, "f") === 0 && ie(this, ai, "f") === 0 && ie(this, Ui, "f") && (clearInterval(ie(this, Ui, "f")), Me(this, Ui, void 0, "f")), Me(this, Vr, ie(this, Nn, "f") ? ie(this, ai, "f") : 0, "f"), ie(this, Ze, "m", pu).call(this);
}, "_PQueue_onInterval"), pu = o(function () {
  for (; ie(this, Ze, "m", cu).call(this););
}, "_PQueue_processQueue"), Tg = o(async function (e) {
  return new Promise((t, r) => {
    e.addEventListener("abort", () => {
      r(new fu("The task was aborted."));
    }, {
      once: !0
    });
  });
}, "_PQueue_throwOnAbort"), hu = o(async function (e, t) {
...
function FS(i, e, t) {
  var r = sh(yu++, 2);
  return r.t = i, r.__c || (r.__ = [t ? t(e) : zg(void 0, e), function (s) {
    var n = r.t(r.__[0], s);
...
o(Ro, "F");
function As(i, e) {
  return zn = 8, Ro(function () {
    return i;
  }, e);
}
o(As, "T");
function ES() {
  for (var i; i = Bg.shift();) if (i.__P) try {
    i.__H.__h.forEach(gu), i.__H.__h.forEach(rh), i.__H.__h = [];
  } catch (e) {
...
le.__b = function (i) {
  ...
  Dg && Dg(i), yu = 0;
  var e = (Mt = i.__c).__H;
  e && (ih === Mt ? (e.__h = [], Mt.__h = [], e.__.forEach(function (t) {
    t.__V = mu, t.u = void 0;
  })) : (e.__h.forEach(gu), e.__h.forEach(rh), e.__h = [])), ih = Mt;
}, le.diffed = function (i) {
  Ig && Ig(i);
  var e = i.__c;
  e && e.__H && (e.__H.__h.length && (Bg.push(e) !== 1 && kg === le.requestAnimationFrame || ((kg = le.requestAnimationFrame) || function (t) {
    var r,
      s = o(function () {
        clearTimeout(n), Mg && cancelAnimationFrame(r), setTimeout(t);
      }, "u"),
      n = setTimeout(s, 100);
    Mg && (r = requestAnimationFrame(s));
  })(ES)), e.__H.__.forEach(function (t) {
    t.u && (t.__H = t.u), t.__V !== mu && (t.__ = t.__V), t.u = void 0, t.__V = mu;
  })), ih = Mt = null;
}, le.__c = function (i, e) {
  e.some(function (t) {
    try {
      t.__h.forEach(gu), t.__h = t.__h.filter(function (r) {
        return !r.__ || rh(r);
      });
    } catch (r) {
      e.some(function (s) {
...
function CS(i) {
  ...
  }, c(OS, null), t("signInWithGoogle")) : c("button", {
    type: "submit",
...
o(ah, "Breadcrumbs");
function lh(i) {
  return c(vt, null, i.showBreadcrumbs && c(ah, {
...
function Hn(i) {
  return {
    ...i,
    type: i.mimeType,
    extension: i.name ? Wi(i.name).extension : null
  };
}
o(Hn, "remoteFileObjToLocal");
function uh() {
  return uh = Object.assign ? Object.assign.bind() : function (i) {
...
function $n(i) {
  let {
    ...
    [O] = vr(() => {
      ...
      return _.setAttribute("tabindex", "-1"), _.id = Xt(), _;
    });
  return Gi(() => (document.body.appendChild(O), O.addEventListener("submit", b), () => {
    O.removeEventListener("submit", b), document.body.removeChild(O);
  }), [O, b]), c(vt, null, c("input", {
...
function LS(i) {
  let {
    ...
    y = (0, Hg.default)("uppy-u-reset", "uppy-ProviderBrowserItem-checkbox", "uppy-ProviderBrowserItem-checkbox--grid", {
      "uppy-ProviderBrowserItem-checkbox--is-checked": s
    });
  return c("li", {
    className: e,
    title: t ? r?.message : void 0
  }, c("input", {
    type: "checkbox",
    className: y,
    onChange: l,
...
function fh(i) {
  ...
  return c("li", {
    ...
    type: "checkbox",
    className: `uppy-u-reset uppy-ProviderBrowserItem-checkbox ${n ? "uppy-ProviderBrowserItem-checkbox--is-checked" : ""}`,
    onChange: a,
    onKeyDown: u,
    onMouseDown: u,
    name: "listitem",
    id: h,
    checked: n,
    "aria-label": l === "file" ? null : S("allFilesFromFolderNamed", {
      name: p
    }),
    disabled: t,
    "data-uppy-super-focusable": !0
...
function wu(i) {
  let {
    ...
    a = t(),
    u = (0, $g.default)("uppy-ProviderBrowserItem", {
...
function qg(i) {
  ...
  if (p.isFolder) return wu({
    ...
    getItemIcon: () => p.icon,
    isChecked: s(p),
    toggleCheckbox: b => n(b, p),
    recordShiftKeyPress: a,
    type: "folder",
    isDisabled: !1,
    isCheckboxDisabled: p.id === NS,
    handleFolderClick: () => d(p)
  });
  let y = h(Hn(p), [...t, ...e]);
  return wu({
    id: p.id,
    title: p.name,
    author: p.author,
    getItemIcon: () => r === "grid" && p.thumbnail ? p.thumbnail : p.icon,
    isChecked: s(p),
    toggleCheckbox: b => n(b, p),
...
function MS(i) {
  let {
    ...
    we = Ro(() => [...t, ...r], [t, r]);
  return c("div", {
    className: (0, mh.default)("uppy-ProviderBrowser", `uppy-ProviderBrowser-viewType--${n}`)
  }, a && c("div", {
    className: "uppy-ProviderBrowser-header"
  }, c("div", {
    className: (0, mh.default)("uppy-ProviderBrowser-headerBar", !u && "uppy-ProviderBrowser-headerBar--simple")
  }, a)), O && c("div", {
  ...
  }, c("span", null, typeof T == "string" ? T : b("loading"))) : !t.length && !r.length ? c("div", {
...
var Ts = class {
  ...
  constructor(e, t) {
    this.filterItems = r => {
      ...
      return !s.filterInput || s.filterInput === "" ? r : r.filter(n => n.name.toLowerCase().indexOf(s.filterInput.toLowerCase()) !== -1);
    ...
    }, this.plugin = e, this.provider = t.provider, this.opts = t, this.isHandlingScroll = !1, this.preFirstRender = this.preFirstRender.bind(this), this.handleError = this.handleError.bind(this), this.clearSelection = this.clearSelection.bind(this), this.cancelPicking = this.cancelPicking.bind(this);
  }
  preFirstRender() {
  ...
  handleError(e) {
    ...
    r.log(e.toString()), !(e.isAuthError || ((t = e.cause) == null ? void 0 : t.name) === "AbortError") && r.info({
      message: s,
      details: e.toString()
    }, "error", 5e3);
  }
  registerRequestClient() {
    this.requestClientId = this.provider.provider, this.plugin.uppy.registerRequestClient(this.requestClientId, this.provider);
  }
  getTagFile(e) {
    let t = {
      id: e.id,
    ...
    return e.thumbnail && (t.preview = e.thumbnail), e.author && (e.author.name != null && (t.meta.authorName = String(e.author.name)), e.author.url && (t.meta.authorUrl = e.author.url)), e.relDirPath != null && (t.meta.relativePath = e.relDirPath ? `${e.relDirPath}/${t.name}` : null), e.absDirPath != null && (t.meta.absolutePath = e.absDirPath ? `/${e.absDirPath}/${t.name}` : `/${t.name}`), t;
  }
  toggleCheckbox(e, t) {
    ...
    if (this.lastCheckbox && this.isShiftKeyPressed) {
      ...
      for (let y of d) {
        let {
          ...
          S = b.validateRestrictions(Hn(y), [...b.getFiles(), ...p]);
        S ? b.info({
          message: S.message
        }, "error", b.opts.infoTimeout) : p.push(y);
      }
      this.plugin.setPluginState({
        currentSelection: [...new Set([...u, ...p])]
      });
      return;
    }
    this.lastCheckbox = t;
...
function zS(i) {
  return i.slice(1).map(e => e.name).join("/");
}
...
var HS = {
  ...
  Rs = Kn("abortController"),
  Di = Kn("withAbort"),
  Gn = Kn("list"),
  Vn = Kn("listFilesAndFolders"),
  Wn = Kn("recursivelyListAllFiles"),
  Be = class extends Ts {
    static {
      o(this, "ProviderView");
    }
    constructor(e, t) {
      super(e, {
        ...
        writable: !0,
        value: void 0
      }), this.filterQuery = this.filterQuery.bind(this), this.clearFilter = this.clearFilter.bind(this), this.getFolder = this.getFolder.bind(this), this.getNextFolder = this.getNextFolder.bind(this), this.logout = this.logout.bind(this), this.handleAuth = this.handleAuth.bind(this), this.handleScroll = this.handleScroll.bind(this), this.donePicking = this.donePicking.bind(this), this.render = this.render.bind(this), this.plugin.setPluginState({
      ...
      try {
        await Qt(this, Di)[Di](async r => {
          ...
          do {
            ...
            a = a.concat(l), u = u.concat(h), this.setLoading(this.plugin.uppy.i18n("loadedXFiles", {
        ...
        await Qt(this, Di)[Di](async e => {
          ...
          for (let n of t) {
            let {
              ...
              u = o(l => ({
                ...l,
                relDirPath: l.absDirPath.replace(n.absDirPath, "").replace(/^\//, "")
              }), "withRelDirPath");
            if (n.isFolder) {
              let l = !0,
                h = 0,
                ...
                p = o(b => {
                  for (let S of b) {
                    let T = this.getTagFile(S),
                      O = Gl(T, this.plugin.uppy.getID());
                    this.plugin.uppy.checkIfFileAlreadyExists(O) || (s.push(u(S)), h++, this.setLoading(this.plugin.uppy.i18n("addedNumFiles", {
                      numFiles: h
                    }))), l = !1;
                  }
                }, "onFiles");
              await Qt(this, Wn)[Wn]({
                requestPath: a,
                absDirPath: gh(n.absDirPath, n.name),
                relDirPath: n.name,
                queue: d,
                onFiles: p,
                signal: e
              ...
              let y;
              l ? y = this.plugin.uppy.i18n("emptyFolderAdded") : h === 0 ? y = this.plugin.uppy.i18n("folderAlreadyAdded", {
                folder: n.name
          ...
          this.plugin.uppy.log("Adding files from a remote provider"), this.plugin.uppy.addFiles(s.map(n => this.getTagFile(n, this.requestClientId))), this.plugin.setPluginState({
            filterInput: ""
          }), r.forEach(n => this.plugin.uppy.info(n)), this.clearSelection();
        });
      } catch (e) {
        this.handleError(e);
      } finally {
...
async function $S(i) {
  ...
  try {
    ...
    this.plugin.uppy.off("dashboard:close-panel", r), this.plugin.uppy.off("cancel-all", r), Qt(this, Rs)[Rs] = void 0;
  }
}
o($S, "_withAbort2");
async function qS(i) {
...
async function WS(i) {
  ...
  for (; u;) {
    ...
    n(h);
    let p = d.map(async y => s.add(async () => Qt(this, Wn)[Wn]({
      requestPath: y.requestPath,
      absDirPath: gh(t, y.name),
      relDirPath: gh(r, y.name),
      queue: s,
      onFiles: n,
      signal: a
    })));
  ...
  wr = class extends Ts {
    ...
    constructor(e, t) {
      super(e, {
        ...
        value: QS
      }), this.nextPageQuery = null, this.search = this.search.bind(this), this.clearSearch = this.clearSearch.bind(this), this.resetPluginState = this.resetPluginState.bind(this), this.handleScroll = this.handleScroll.bind(this), this.donePicking = this.donePicking.bind(this), this.render = this.render.bind(this), this.plugin.setPluginState(Wg), this.registerRequestClient();
    }
    tearDown() {}
    resetPluginState() {
    ...
    donePicking() {
      ...
      this.plugin.uppy.log("Adding remote search provider files"), this.plugin.uppy.addFiles(e.map(t => this.getTagFile(t))), this.resetPluginState();
    }
    render(e, t) {
      var r = this;
      t === void 0 && (t = {});
...
o(Ki, "_classPrivateFieldLooseBase");
var JS = 0;
function vh(i) {
  return "__private_" + JS++ + "_" + i;
}
o(vh, "_classPrivateFieldLooseKey");
var ZS = {
    version: "3.0.7"
  },
...
var Pu = class {
  ...
  constructor(e) {
    Object.defineProperty(this, Sr, {
      ...
      writable: !0,
      value: void 0
    }), Ki(this, Pr)[Pr] = e.store, Ki(this, Sr)[Sr] = e.id || Xt(), Ki(this, Yn)[Yn] = e.selector || t2(Ki(this, Sr)[Sr]), this.setState({});
  }
  setState(e) {
    Ki(this, Pr)[Pr].dispatch({
      type: e2,
      id: Ki(this, Sr)[Sr],
      payload: e
    });
  ...
  getState() {
    return Ki(this, Yn)[Yn](Ki(this, Pr)[Pr].getState());
  }
  subscribe(e) {
    let t = this.getState();
    return Ki(this, Pr)[Pr].subscribe(() => {
      let r = this.getState();
      if (t !== r) {
        let s = i2(t, r);
        e(t, r, s), t = r;
  ...
  [Gg]() {
    return Ki(this, Sr)[Sr];
  }
};
Pu.VERSION = ZS.version;
var r2 = Pu;
exports.ReduxStore = r2;
function _u(i, e, t, r) {
...
function Qn(i) {
  ...
  for (let {
    ...
    r == null && (a || u) && ({
      mode: t,
      message: r
    } = a || u), a?.mode === "determinate" && e.push(a.value), u?.mode === "determinate" && e.push(u.value);
  }
...
o(Qn, "calculateProcessingProgress");
var Ph = be(li(), 1),
  Sh = be(gn(), 1);
function bh(i) {
...
function Xg(i) {
  let {
    ...
    l = (0, Ph.default)("uppy-u-reset", "uppy-c-btn", "uppy-StatusBar-actionBtn", "uppy-StatusBar-actionBtn--upload", {
      "uppy-c-btn-primary": n === ui.STATE_WAITING
    }, {
      "uppy-StatusBar-actionBtn--disabled": a
    }),
    h = e && t && !r ? s("uploadXNewFiles", {
      smart_count: e
    }) : s("uploadXFiles", {
      smart_count: e
    });
...
function Jg(i) {
  ...
  return o(u, "togglePauseResume"), c("button", {
    title: a,
    "aria-label": a,
    className: "uppy-u-reset uppy-StatusBar-actionCircleBtn",
    type: "button",
...
function ty(i) {
  ...
  }, c(ey, null), r === "determinate" ? `${Math.round(t * 100)}% \xB7 ` : "", s);
}
o(ty, "ProgressBarProcessing");
function o2(i) {
  let {
      numUploads: e,
      complete: t,
  ...
  }, u && a("filesUploadedOfTotal", {
    complete: t,
    smart_count: e
  }), c("span", {
    className: "uppy-StatusBar-additionalInfo"
  }, u && Kg(), a("dataUploadedOfTotal", {
    complete: (0, Sh.default)(r),
    total: (0, Sh.default)(s)
  }), Kg(), a("xTimeLeft", {
    time: wh(n)
  })));
}
o(o2, "ProgressDetails");
function iy(i) {
  let {
    i18n: e,
    complete: t,
...
function n2(i) {
  let {
    ...
    s = (0, Ph.default)("uppy-u-reset", "uppy-c-btn", "uppy-StatusBar-actionBtn", "uppy-StatusBar-actionBtn--uploadNewlyAdded");
  return c("div", {
    className: "uppy-StatusBar-statusSecondary"
  }, c("div", {
...
function ry(i) {
  ...
  return o(_, "renderProgressDetails"), c("div", {
    className: "uppy-StatusBar-content",
    "aria-label": O,
    title: O
  }, u ? null : c(ey, null), c("div", {
...
o(oy, "ProgressBarError");
var {
  STATE_ERROR: ny,
  STATE_WAITING: ay,
  STATE_PREPROCESSING: _h,
  STATE_UPLOADING: xu,
  STATE_POSTPROCESSING: xh,
  STATE_COMPLETE: Fu
} = ui;
function Eu(i) {
  let {
  ...
  let P = Pe(),
    ...
    A = a && !G && !d,
    k = R && y === Fu,
    N = (0, Fh.default)("uppy-StatusBar-progress", {
      "is-indeterminate": Le()
    }),
    Y = (0, Fh.default)("uppy-StatusBar", `is-${y}`, {
      "has-ghosts": _
    });
  return c("div", {
    className: Y,
...
var a2 = 0;
function Uo(i) {
  return "__private_" + a2++ + "_" + i;
}
o(Uo, "_classPrivateFieldLooseKey");
var l2 = {
    version: "3.3.3"
  },
  u2 = 2e3,
...
function h2(i, e, t, r) {
  ...
  for (let a = 0; a < n.length; a++) {
    ...
    u.preprocess && (s = ui.STATE_PREPROCESSING), u.postprocess && s !== ui.STATE_PREPROCESSING && (s = ui.STATE_POSTPROCESSING);
  }
  return s;
}
o(h2, "getUploadingState");
var d2 = {
    target: "body",
    hideUploadButton: !1,
    hideRetryButton: !1,
  ...
  Fi = Uo("lastUpdateTime"),
  Ii = Uo("previousUploadedBytes"),
  _r = Uo("previousSpeed"),
  ci = Uo("previousETA"),
  Eh = Uo("computeSmoothETA"),
  Jn = Uo("onUploadStart"),
  Wr = class extends ae {
    static {
      o(this, "StatusBar");
    ...
    constructor(e, t) {
      super(e, {
        ...
        writable: !0,
        value: void 0
      }), this.startUpload = () => this.uppy.upload().catch(() => {}), Object.defineProperty(this, Jn, {
        writable: !0,
        value: () => {
          let {
            recoveredState: r
          } = this.uppy.getState();
          if (je(this, _r)[_r] = null, je(this, ci)[ci] = null, r) {
            je(this, Ii)[Ii] = Object.values(r.files).reduce((s, n) => {
              let {
                progress: a
              } = n;
          ...
          je(this, Fi)[Fi] = performance.now(), je(this, Ii)[Ii] = 0;
        }
      }), this.id = this.opts.id || "StatusBar", this.title = "StatusBar", this.type = "progressindicator", this.defaultLocale = ly, this.i18nInit(), this.render = this.render.bind(this), this.install = this.install.bind(this);
    }
    render(e) {
      let {
          capabilities: t,
        ...
        _ = u ? Object.values(r) : l,
        R = !!t.resumableUploads,
        $ = t.uploadProgress !== !1,
        W = 0,
        K = 0;
      h.forEach(G => {
        W += G.progress.bytesTotal || 0, K += G.progress.bytesUploaded || 0;
      });
      let q = je(this, Eh)[Eh]({
        uploaded: K,
        total: W,
    ...
    install() {
      ...
      e && this.mount(e, this), this.uppy.on("upload", je(this, Jn)[Jn]), je(this, Fi)[Fi] = performance.now(), je(this, Ii)[Ii] = this.uppy.getFiles().reduce((t, r) => t + r.progress.bytesUploaded, 0);
    }
    uninstall() {
      this.unmount(), this.uppy.off("upload", je(this, Jn)[Jn]);
    }
  };
exports.StatusBar = Wr;
function p2(i) {
  var e, t;
  if (i.total === 0 || i.remaining === 0) return 0;
  (t = (e = je(this, Fi))[Fi]) != null || (e[Fi] = performance.now());
  let r = performance.now() - je(this, Fi)[Fi];
  if (r === 0) {
    var s;
    return Math.round(((s = je(this, ci)[ci]) != null ? s : 0) / 100) / 10;
  }
  let n = i.uploaded - je(this, Ii)[Ii];
  if (je(this, Ii)[Ii] = i.uploaded, n <= 0) {
    var a;
    return Math.round(((a = je(this, ci)[ci]) != null ? a : 0) / 100) / 10;
  }
  let u = n / r,
    l = je(this, _r)[_r] == null ? u : _u(u, je(this, _r)[_r], u2, r);
  je(this, _r)[_r] = l;
  let h = i.remaining / l,
    d = Math.max(je(this, ci)[ci] - r, 0),
    p = je(this, ci)[ci] == null ? h : _u(h, d, c2, r);
  return je(this, ci)[ci] = p, je(this, Fi)[Fi] = performance.now(), Math.round(p / 100) / 10;
}
o(p2, "_computeSmoothETA2");
Wr.VERSION = l2.version;
var uy = 300,
  Zn = class extends Te {
    static {
      o(this, "FadeIn");
    ...
    constructor() {
      super(...arguments), this.ref = Gm();
    }
    componentWillEnter(e) {
      this.ref.current.style.opacity = "1", this.ref.current.style.transform = "none", setTimeout(e, uy);
    }
    componentWillLeave(e) {
      this.ref.current.style.opacity = "0", this.ref.current.style.transform = "translateY(350%)", setTimeout(e, uy);
    }
    render() {
      let {
        children: e
...
function ea(i) {
  let e = {};
  for (let t = 0; t < i.length; t++) if (i[t] != null) {
    let r = m2(i[t], t.toString(36));
    e[r] = i[t];
  }
  return e;
}
o(ea, "getChildMapping");
function y2(i, e) {
  i = i || {}, e = e || {};
  ...
  let n = {};
  for (let a in e) {
    if (r.hasOwnProperty(a)) for (let u = 0; u < r[a].length; u++) {
      let l = r[a][u];
      n[r[a][u]] = t(l);
    }
    n[a] = t(a);
  ...
  Ou = class extends Te {
    ...
    constructor(e, t) {
      super(e, t), this.refs = {}, this.state = {
        children: ea(Pi(Pi(this.props.children)) || [])
    ...
    _handleDoneAppearing(e) {
      ...
      let r = ea(Pi(this.props.children) || []);
    ...
    _handleDoneLeaving(e) {
      ...
      let s = ea(Pi(this.props.children) || []);
      if (s && s.hasOwnProperty(e)) this.performEnter(e);else {
        let n = f2({}, this.state.children);
...
exports.Informer = Gr;
Gr.VERSION = b2.version;
var w2 = /^data:([^/]+\/[^,;]+(?:[^,]*?))(;base64)?,([\s\S]*)$/;
function S2(i, e, t) {
  var r, s;
  let n = w2.exec(i),
...
o(Fe, "e");
var wy = typeof self < "u" ? self : global,
  sa = typeof navigator < "u",
  P2 = sa && typeof HTMLImageElement > "u",
  dy = !(typeof global > "u" || typeof process > "u" || !process.versions || !process.versions.node),
  Sy = wy.Buffer,
  Py = !!Sy,
  _2 = o(i => i !== void 0, "h");
function _y(i) {
  return i === void 0 || (i instanceof Map ? i.size === 0 : Object.values(i).filter(_2).length === 0);
}
o(_y, "f");
function bt(i) {
  let e = new Error(i);
...
o(py, "o");
var Oh = o(i => String.fromCharCode.apply(null, i), "u"),
  fy = typeof TextDecoder < "u" ? new TextDecoder("utf-8") : void 0,
  Us = class i {
    static {
      o(this, "c");
    }
    ...
    constructor(e, t = 0, r, s) {
      if (typeof s == "boolean" && (this.le = s), Array.isArray(e) && (e = new Uint8Array(e)), e === 0) this.byteOffset = 0, this.byteLength = 0;else if (e instanceof ArrayBuffer) {
        ...
        r === void 0 && (r = e.byteLength - t), (t += e.byteOffset) + r > e.byteOffset + e.byteLength && bt("Creating view outside of available memory in ArrayBuffer");
    ...
    set(e, t, r = i) {
      return e instanceof DataView || e instanceof i ? e = new Uint8Array(e.buffer, e.byteOffset, e.byteLength) : e instanceof ArrayBuffer && (e = new Uint8Array(e)), e instanceof Uint8Array || bt("BufferView.set(): Invalid data argument."), this.toUint8().set(e, t), new r(this, t, e.byteLength);
    }
    subarray(e, t) {
    ...
    getString(e = 0, t = this.byteLength) {
      return s = this.getUint8Array(e, t), fy ? fy.decode(s) : Py ? Buffer.from(s).toString("utf8") : decodeURIComponent(escape(Oh(s)));
      var s;
    }
...
var oa = class extends Map {
    ...
    get(e, t) {
      return this.has(e) || Ah(this.kind, e), t && (e in t || function (r, s) {
        bt(`Unknown ${r} '${s}'.`);
      }(this.kind, e), t[e].enabled || Ah(this.kind, e)), super.get(e);
    }
    keyList() {
      return Array.from(this.keys());
    }
  },
  Du = new oa("file parser"),
  hi = new oa("segment parser"),
  la = new oa("file reader"),
  x2 = wy.fetch;
function my(i, e) {
  return (t = i).startsWith("data:") || t.length > 1e4 ? Rh(i, e, "base64") : dy && i.includes("://") ? Th(i, e, "url", Tu) : dy ? Rh(i, e, "fs") : sa ? Th(i, e, "url", Tu) : void bt("Invalid input argument");
  var t;
}
o(my, "k");
async function Th(i, e, t, r) {
  return la.has(t) ? Rh(i, e, t) : r ? async function (s, n) {
    let a = await n(s);
    return new Us(a);
  }(i, r) : void bt(`Parser ${t} is not loaded`);
}
o(Th, "O");
async function Rh(i, e, t) {
  let r = new (la.get(t))(i, e);
  return await r.read(), r;
}
o(Rh, "v");
var Tu = o(i => x2(i).then(e => e.arrayBuffer()), "S"),
  na = o(i => new Promise((e, t) => {
    let r = new FileReader();
    r.onloadend = () => e(r.result || new ArrayBuffer()), r.onerror = t, r.readAsArrayBuffer(i);
  }), "A"),
  kh = class extends Map {
    static {
      o(this, "U");
    }
    get tagKeys() {
...
function xy(i, e, t) {
  ...
  if (Array.isArray(e)) for (let s of e) i.set(s, r);else i.set(e, r);
  return r;
}
o(xy, "x");
function Fy(i, e, t) {
...
var ua = new Map(),
  Nh = new Map(),
  Mh = new Map(),
  Do = ["chunked", "firstChunkSize", "firstChunkSizeNode", "firstChunkSizeBrowser", "chunkSize", "chunkLimit"],
  Iu = ["jfif", "xmp", "icc", "iptc", "ihdr"],
  aa = ["tiff", ...Iu],
  ot = ["ifd0", "ifd1", "exif", "gps", "interop"],
  Io = [...aa, ...ot],
  Lo = ["makerNote", "userComment"],
  Lu = ["translateKeys", "translateValues", "reviveValues", "multiSegment"],
  No = [...Lu, "sanitize", "mergeOutput", "silentErrors"],
  Ru = class {
    static {
      o(this, "_");
    }
  ...
  ks = class extends Ru {
    ...
    constructor(e, t, r, s) {
      ...
      } else r === !0 || r === !1 ? this.parse = this.enabled = r : bt(`Invalid options argument: ${r}`);
    }
    applyInheritables(e) {
      let t, r;
      for (t of Lu) r = e[t], r !== void 0 && (this[t] = r);
    }
    translateTagSet(e, t) {
      if (this.dict) {
        let r,
    ...
    finalizeFilters() {
      !this.enabled && this.deps.size > 0 ? (this.enabled = !0, ku(this.pick, this.deps)) : this.enabled && this.pick.size > 0 && ku(this.pick, this.deps);
    }
  },
  Bt = {
    jfif: !1,
  ...
  Ds = class extends Ru {
    ...
    static useCached(e) {
      let t = gy.get(e);
      return t !== void 0 || (t = new this(e), gy.set(e, t)), t;
    }
    constructor(e) {
    ...
    setupFromUndefined() {
      let e;
      for (e of Do) this[e] = Bt[e];
      for (e of No) this[e] = Bt[e];
      for (e of Lo) this[e] = Bt[e];
      for (e of Io) this[e] = new ks(e, Bt[e], void 0, this);
    }
    setupFromTrue() {
      let e;
      for (e of Do) this[e] = Bt[e];
      for (e of No) this[e] = Bt[e];
      for (e of Lo) this[e] = !0;
      for (e of Io) this[e] = new ks(e, !0, void 0, this);
    }
    setupFromArray(e) {
      let t;
      for (t of Do) this[t] = Bt[t];
      for (t of No) this[t] = Bt[t];
      for (t of Lo) this[t] = Bt[t];
      for (t of Io) this[t] = new ks(t, !1, void 0, this);
      this.setupGlobalFilters(e, void 0, ot);
    }
    setupFromObject(e) {
      let t;
      for (t of (ot.ifd0 = ot.ifd0 || ot.image, ot.ifd1 = ot.ifd1 || ot.thumbnail, Object.assign(this, e), Do)) this[t] = Ch(e[t], Bt[t]);
      for (t of No) this[t] = Ch(e[t], Bt[t]);
      for (t of Lo) this[t] = Ch(e[t], Bt[t]);
      for (t of aa) this[t] = new ks(t, Bt[t], e[t], this);
      for (t of ot) this[t] = new ks(t, Bt[t], e[t], this.tiff);
      this.setupGlobalFilters(e.pick, e.skip, ot, Io), e.tiff === !0 ? this.batchEnableWithBool(ot, !0) : e.tiff === !1 ? this.batchEnableWithUserValue(ot, e) : Array.isArray(e.tiff) ? this.setupGlobalFilters(e.tiff, void 0, ot) : typeof e.tiff == "object" && this.setupGlobalFilters(e.tiff.pick, e.tiff.skip, ot);
    }
    ...
    setupGlobalFilters(e, t, r, s = r) {
      if (e && e.length) {
        ...
        let n = yy(e, r);
        for (let [a, u] of n) ku(this[a].pick, u), this[a].enabled = !0;
      } else if (t && t.length) {
        let n = yy(t, r);
        for (let [a, u] of n) ku(this[a].skip, u);
      }
    }
    ...
    traverseTiffDependencyTree() {
      ...
      s.needed && (t.deps.add(40965), e.deps.add(40965)), t.needed && e.deps.add(34665), r.needed && e.deps.add(34853), this.tiff.enabled = ot.some(n => this[n].enabled === !0) || this.makerNote || this.userComment;
      for (let n of ot) this[n].finalizeFilters();
    }
    get onlyTiff() {
      return !Iu.map(e => this[e].enabled).some(e => e === !0) && this.tiff.enabled;
    }
    checkLoadedPlugins() {
      for (let e of aa) this[e].enabled && !hi.has(e) && Ah("segment parser", e);
    }
  };
function yy(i, e) {
  let t,
    ...
    a = [];
  for (s of e) {
    for (n of (t = ua.get(s), r = [], t)) (i.includes(n[0]) || i.includes(n[1])) && r.push(n[0]);
    r.length && a.push([s, r]);
  }
  return a;
}
...
var Mo = class {
  ...
  constructor(e) {
    Fe(this, "parsers", {}), Fe(this, "output", {}), Fe(this, "errors", []), Fe(this, "pushToErrors", t => this.errors.push(t)), this.options = Ds.useCached(e);
  }
  async read(e) {
    this.file = await function (t, r) {
      return typeof t == "string" ? my(t, r) : sa && !P2 && t instanceof HTMLImageElement ? my(t.src, r) : t instanceof Uint8Array || t instanceof ArrayBuffer || t instanceof DataView ? new Us(t) : sa && t instanceof Blob ? Th(t, r, "blob", na) : void bt("Invalid input argument");
    }(e, this.options);
  }
  setup() {
    ...
    let {
      ...
      t = e.getUint16(0);
    for (let [r, s] of Du) if (s.canHandle(e, t)) return this.fileParser = new s(this.options, this.file, this.parsers), e[r] = !0;
  ...
  async parse() {
    ...
    return this.setup(), this.options.silentErrors ? (await this.executeParsers().catch(this.pushToErrors), t.push(...this.fileParser.errors)) : await this.executeParsers(), this.file.close && this.file.close(), this.options.silentErrors && t.length > 0 && (e.errors = t), _y(r = e) ? void 0 : r;
    var r;
  }
...
var F2 = Object.freeze({
    ...
    createDictionary: xy,
    extendDictionary: Fy,
    fetchUrlAsArrayBuffer: Tu,
    readBlobAsArrayBuffer: na,
    chunkedProps: Do,
    otherSegments: Iu,
    segments: aa,
    tiffBlocks: ot,
    segmentsAndBlocks: Io,
    tiffExtractables: Lo,
    inheritables: Lu,
    allFormatters: No,
    Options: Ds
  ...
  Kr = class {
    ...
    static parse(e, t = {}) {
      return new this(e, new Ds({
        [this.type]: t
      }), e).parse();
    }
    normalizeInput(e) {
      return e instanceof Us ? e : new Us(e);
    }
    constructor(e, t = {}, r) {
      Fe(this, "errors", []), Fe(this, "raw", new Map()), Fe(this, "handleError", s => {
    ...
    translateBlock(e, t) {
      let r = Mh.get(t),
        ...
        h = a.translateKeys && !!n,
        d = {};
      for (let [p, y] of e) u && r.has(p) ? y = r.get(p)(y) : l && s.has(p) && (y = this.translateValue(y, s.get(p))), h && n.has(p) && (p = n.get(p) || p), d[p] = y;
      return d;
    }
    translateValue(e, t) {
...
Fe(Kr, "headerLength", 4), Fe(Kr, "type", void 0), Fe(Kr, "multiSegment", !1), Fe(Kr, "canHandle", () => !1);
function E2(i) {
...
var Uu = class extends class {
  constructor(e, t, r) {
    Fe(this, "errors", []), Fe(this, "ensureSegmentChunk", async s => {
      let n = s.start,
        a = s.size || 65536;
      if (this.file.chunked) {
        if (this.file.available(n, a)) s.chunk = this.file.subarray(n, a);else try {
          s.chunk = await this.file.readChunk(n, a);
        } catch (u) {
          bt(`Couldn't read segment: ${JSON.stringify(s)}. ${u.message}`);
        }
      } else this.file.byteLength > n + a ? s.chunk = this.file.subarray(n, a) : s.size === void 0 ? s.chunk = this.file.subarray(n) : bt("Segment unreachable: " + JSON.stringify(s));
      return s.chunk;
  ...
  constructor(...e) {
    super(...e), Fe(this, "appSegments", []), Fe(this, "jpegSegments", []), Fe(this, "unknownSegments", []);
  }
  ...
  setupSegmentFinderArgs(e) {
    e === !0 ? (this.findAll = !0, this.wanted = new Set(hi.keyList())) : (e = e === void 0 ? hi.keyList().filter(t => this.options[t].enabled) : e.filter(t => this.options[t].enabled && hi.has(t)), this.findAll = !1, this.remaining = new Set(e), this.wanted = new Set(e)), this.unfinishedMultiSegment = !1;
  }
  async findAppSegments(e = 0, t) {
    ...
    if (!s && this.file.chunked && (s = Array.from(n).some(u => {
      let l = hi.get(u),
        h = this.options[u];
      ...
      let u = !1;
      for (; a.size > 0 && !u && (r.canReadNextChunk || this.unfinishedMultiSegment);) {
        let {
            nextChunkOffset: l
          } = r,
          h = this.appSegments.some(d => !this.file.available(d.offset || d.start, d.length || d.size));
        if (u = e > l && !h ? !(await r.readNextChunk(e)) : !(await r.readNextChunk(l)), (e = this.findAppSegmentsInRange(e, r.byteLength)) === void 0) return;
      }
    }
  }
  findAppSegmentsInRange(e, t) {
    ...
    for (; e < t; e++) if (h.getUint8(e) === 255) {
      if (r = h.getUint8(e + 1), O2(r)) {
        if (s = h.getUint16(e + 2), n = C2(h, e, s), n && p.has(n) && (a = hi.get(n), u = a.findPosition(h, e), l = b[n], u.type = n, this.appSegments.push(u), !d && (a.multiSegment && l.multiSegment ? (this.unfinishedMultiSegment = u.chunkNumber < u.chunkCount, this.unfinishedMultiSegment || y.delete(n)) : y.delete(n), y.size === 0))) break;
        b.recordUnknownSegments && (u = Kr.findPosition(h, e), u.marker = r, this.unknownSegments.push(u)), e += s + 1;
      } else if (E2(r)) {
        if (s = h.getUint16(e + 2), r === 218 && b.stopAfterSos !== !1) return;
        b.recordJpegSegments && this.jpegSegments.push({
          offset: e,
          length: s,
          marker: r
        }), e += s + 1;
  ...
  mergeMultiSegments() {
    ...
    let e = function (t, r) {
      let s,
        ...
        a,
        u = new Map();
      for (let l = 0; l < t.length; l++) s = t[l], n = s[r], u.has(n) ? a = u.get(n) : u.set(n, a = []), a.push(s);
      return Array.from(u);
...
Fe(Uu, "type", "jpeg"), Du.set("jpeg", Uu);
var A2 = [void 0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8, 4],
  Uh = class extends Kr {
    static {
      o(this, "se");
    }
    ...
    parseTag(e, t, r) {
      let {
        ...
        a = s.getUint32(e + 4),
        u = A2[n];
      if (u * a <= 4 ? e += 8 : e = s.getUint32(e + 8), (n < 1 || n > 13) && bt(`Invalid TIFF value type. block: ${r.toUpperCase()}, tag: ${t.toString(16)}, type: ${n}, offset ${e}`), e > s.byteLength && bt(`Invalid TIFF value offset. block: ${r.toUpperCase()}, tag: ${t.toString(16)}, type: ${n}, offset ${e} is outside of chunk size ${s.byteLength}`), n === 1) return s.getUint8Array(e, a);
      if (n === 2) return (l = function (h) {
        for (; h.endsWith("\0");) h = h.slice(0, -1);
        return h;
      }(l = s.getString(e, a)).trim()) === "" ? void 0 : l;
      var l;
      if (n === 7) return s.getUint8Array(e, a);
      if (a === 1) return this.parseTagValue(n, e);
      {
        let h = new (function (p) {
            switch (p) {
              case 1:
                return Uint8Array;
              case 3:
          ...
          d = u;
        for (let p = 0; p < a; p++) h[p] = this.parseTagValue(n, e), e += d;
        return h;
      }
    }
    parseTagValue(e, t) {
  ...
  ra = class extends Uh {
    ...
    async parseIfd0Block() {
      ...
      this.findIfd0Offset(), this.ifd0Offset < 8 && bt("Malformed EXIF data"), !e.chunked && this.ifd0Offset > e.byteLength && bt(`IFD0 offset points to outside of file.
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e.byteLength}`), e.tiff && (await e.ensureChunk(this.ifd0Offset, py(this.options)));
    ...
    async parseExifBlock() {
      ...
      this.file.tiff && (await this.file.ensureChunk(this.exifOffset, py(this.options)));
    ...
    async parseGpsBlock() {
      ...
      return e && e.has(2) && e.has(4) && (e.set("latitude", vy(...e.get(2), e.get(1))), e.set("longitude", vy(...e.get(4), e.get(3)))), e;
    }
    ...
    createOutput() {
      let e,
        ...
        r,
        s = {};
      for (t of ot) if (e = this[t], !_y(e)) if (r = this.canTranslate ? this.translateBlock(e, t) : Object.fromEntries(e), this.options.mergeOutput) {
        if (t === "ifd1") continue;
        Object.assign(s, r);
      } else s[t] = r;
    ...
    assignToOutput(e, t) {
      if (this.globalOptions.mergeOutput) Object.assign(e, t);else for (let [r, s] of Object.entries(t)) this.assignObjectToOutput(e, r, s);
    }
  };
function vy(i, e, t, r) {
  var s = i + e / 60 + t / 3600;
...
o(vy, "ne");
Fe(ra, "type", "tiff"), Fe(ra, "headerLength", 10), hi.set("tiff", ra);
...
var n4 = Object.assign({}, Bh, {
  tiff: !1,
  ifd1: !0,
  mergeOutput: !1
});
var T2 = Object.assign({}, Bh, {
  firstChunkSize: 4e4,
  ifd0: [274]
});
async function R2(i) {
...
if (typeof navigator == "object") {
  ...
  if (i.includes("iPad") || i.includes("iPhone")) {
    ...
    if (e) {
      let [, t, r] = e;
      ta = Number(t) + .1 * Number(r) < 13.4, ia = !1;
    }
...
o(Oy, "ye");
var Dh = class extends Us {
    static {
      o(this, "be");
    }
    constructor(...e) {
      super(...e), Fe(this, "ranges", new Ih()), this.byteLength !== 0 && this.ranges.add(0, this.byteLength);
    }
    _tryExtend(e, t, r) {
    ...
    _extend(e) {
      let t;
      t = Py ? Sy.allocUnsafe(e) : new Uint8Array(e);
  ...
  Ih = class {
    ...
    add(e, t, r = 0) {
      let s = e + t,
        n = this.list.filter(a => by(e, a.offset, s) || by(e, a.end, s));
      if (n.length > 0) {
        e = Math.min(e, ...n.map(u => u.offset)), s = Math.max(s, ...n.map(u => u.end)), t = s - e;
        let a = n.shift();
        a.offset = e, a.length = t, a.end = s, this.list = this.list.filter(u => !n.includes(u));
      } else this.list.push({
        offset: e,
        length: t,
        end: s
...
la.set("blob", class extends Lh {
  async readWhole() {
    this.chunked = !1;
    let i = await na(this.input);
...
function D2(i, e, t) {
  ...
  return i.toBlob ? new Promise(r => {
    ...
    return r;
  }) : Promise.resolve().then(() => hy(i.toDataURL(e, t), {})).then(r => {
  ...
  Is = class extends ae {
    ...
    constructor(e, t) {
      if (super(e, {
        ...
        !r.preview && r.data && Au(r.type) && !r.isRemote && this.addToQueue(r.id);
      }, this.onCancelRequest = r => {
        let s = this.queue.indexOf(r.id);
        s !== -1 && this.queue.splice(s, 1);
      }, this.onFileRemoved = r => {
        let s = this.queue.indexOf(r.id);
        s !== -1 && this.queue.splice(s, 1), r.preview && Cu(r.preview) && URL.revokeObjectURL(r.preview);
      }, this.onRestored = () => {
        this.uppy.getFiles().filter(s => s.isRestored).forEach(s => {
          (!s.preview || Cu(s.preview)) && this.addToQueue(s.id);
        });
      ...
      }, this.type = "modifier", this.id = this.opts.id || "ThumbnailGenerator", this.title = "Thumbnail Generator", this.queue = [], this.queueProcessing = !1, this.defaultThumbnailDimension = 200, this.thumbnailType = this.opts.thumbnailType, this.defaultLocale = Cy, this.i18nInit(), this.opts.lazy && this.opts.waitForThumbnailsBeforeUpload) throw new Error("ThumbnailGenerator: The `lazy` and `waitForThumbnailsBeforeUpload` options are mutually exclusive. Please ensure at most one of them is set to `true`.");
    }
    createThumbnail(e, t, r) {
      let s = URL.createObjectURL(e.data),
        n = new Promise((u, l) => {
          let h = new Image();
          h.src = s, h.addEventListener("load", () => {
            URL.revokeObjectURL(s), u(h);
          }), h.addEventListener("error", d => {
            URL.revokeObjectURL(s), l(d.error || new Error("Could not create thumbnail"));
          });
        }),
        a = Oy(e.data).catch(() => 1);
      return Promise.all([n, a]).then(u => {
        let [l, h] = u,
          d = this.getProportionalDimensions(l, t, r, h.deg),
          p = I2(l, h),
          y = this.resizeImage(p, d.width, d.height);
        return D2(y, this.thumbnailType, 80);
    ...
    resizeImage(e, t, r) {
      ...
      for (; n--;) {
        ...
        h.width = a, h.height = u, h.getContext("2d").drawImage(s, 0, 0, a, u), s = h, a = Math.round(a / l), u = Math.round(u / l);
      }
      return s;
    }
    setPreviewURL(e, t) {
    ...
    requestThumbnail(e) {
      return Au(e.type) && !e.isRemote ? this.createThumbnail(e, this.opts.thumbnailWidth, this.opts.thumbnailHeight).then(t => {
...
exports.ThumbnailGenerator = Is;
Is.VERSION = U2.version;
function M2(i) {
  if (typeof i == "string") {
    let e = document.querySelectorAll(i);
    return e.length === 0 ? null : Array.from(e);
  }
  return typeof i == "object" && On(i) ? [i] : null;
}
o(M2, "findAllDOMElements");
var jh = M2;
var nt = Array.from;
function Nu(i, e, t, r) {
  let {
...
o(Nu, "getFilesAndDirectoriesFromDirectory");
function Ay(i, e) {
  return i == null ? i : {
...
function Ty(i, e, t) {
  try {
    return t === void 0 && (t = void 0), async function* () {
      ...
      } else if (i.kind === "directory") for await (let s of i.values()) yield* Ty(s, e ? r() : i.name);else t != null && (yield t);
    }();
  } catch (r) {
    return Promise.reject(r);
  }
}
o(Ty, "createPromiseToAddFileOrParseDirectory");
async function* zh(i, e) {
  let t = await Promise.all(Array.from(i.items, async r => {
    var s;
    let n,
      a = o(() => typeof r.getAsEntry == "function" ? r.getAsEntry() : r.webkitGetAsEntry(), "getAsEntry");
...
o(zh, "getFilesFromDataTransfer");
function Hh(i) {
  let e = nt(i.files);
  return Promise.resolve(e);
}
o(Hh, "fallbackApi");
async function Ls(i, e) {
  var t;
  let r = (t = e?.logDropError) != null ? t : Function.prototype;
  try {
    let s = [];
    for await (let n of zh(i, r)) s.push(n);
    return s;
  } catch {
    return Hh(i);
  }
}
o(Ls, "getDroppedFiles");
var Ry = Number.isNaN || o(function (e) {
  return typeof e == "number" && e !== e;
}, "ponyfill");
function B2(i, e) {
  return !!(i === e || Ry(i) && Ry(e));
}
o(B2, "isEqual");
function j2(i, e) {
  if (i.length !== e.length) return !1;
  for (var t = 0; t < i.length; t++) if (!B2(i[t], e[t])) return !1;
  return !0;
}
o(j2, "areInputsEqual");
function $h(i, e) {
...
o($h, "memoizeOne");
var Mu = ['a[href]:not([tabindex^="-"]):not([inert]):not([aria-hidden])', 'area[href]:not([tabindex^="-"]):not([inert]):not([aria-hidden])', "input:not([disabled]):not([inert]):not([aria-hidden])", "select:not([disabled]):not([inert]):not([aria-hidden])", "textarea:not([disabled]):not([inert]):not([aria-hidden])", "button:not([disabled]):not([inert]):not([aria-hidden])", 'iframe:not([tabindex^="-"]):not([inert]):not([aria-hidden])', 'object:not([tabindex^="-"]):not([inert]):not([aria-hidden])', 'embed:not([tabindex^="-"]):not([inert]):not([aria-hidden])', '[contenteditable]:not([tabindex^="-"]):not([inert]):not([aria-hidden])', '[tabindex]:not([tabindex^="-"]):not([inert]):not([aria-hidden])'];
function ca(i, e) {
  if (e) {
...
o(ca, "getActiveOverlayEl");
function ky(i, e) {
  let t = e[0];
  t && (t.focus(), i.preventDefault());
}
o(ky, "focusOnFirstNode");
function z2(i, e) {
  let t = e[e.length - 1];
  t && (t.focus(), i.preventDefault());
}
o(z2, "focusOnLastNode");
function H2(i) {
  return i.contains(document.activeElement);
}
o(H2, "isFocusInOverlay");
function qh(i, e, t) {
  let r = ca(t, e),
    s = nt(r.querySelectorAll(Mu)),
    n = s.indexOf(document.activeElement);
  H2(r) ? i.shiftKey && n === 0 ? z2(i, s) : !i.shiftKey && n === s.length - 1 && ky(i, s) : ky(i, s);
}
o(qh, "trapFocus");
function Uy(i, e, t) {
  e === null || qh(i, e, t);
...
o(da, "FilePreview");
var Q2 = o((i, e) => (typeof e == "function" ? e() : e).filter(s => s.id === i)[0].name, "metaFieldIdToName");
function pa(i) {
  let {
      file: e,
      toggleFileCard: t,
...
function Wh(i) {
  let {
    ...
    u = e.preview ? "rgba(255, 255, 255, 0.5)" : Ns(e.type).color;
  return c("div", {
...
function Xh(i) {
  ...
  if (!i.recoveredState) return i.error && !i.hideRetryButton ? c(Gh, i, c("svg", {
    "aria-hidden": "true",
    focusable: "false",
  ...
  }))) : i.resumableUploads && !i.hidePauseResumeButton ? c(Gh, i, c(Bu, null, c(Kh, {
    ...
    height: "10",
    rx: "0"
  })))) : !i.resumableUploads && i.individualCancellation && !i.hideCancelButton ? c(Gh, i, c(Bu, null, c(Kh, {
    progress: i.file.progress.percentage
  }), c("polygon", {
    className: "cancel",
...
function ju(i, e) {
  ...
  if (e <= Yh.length + 1) return `${i.slice(0, e - 1)}\u2026`;
  let t = e - Yh.length,
    r = Math.ceil(t / 2),
    s = Math.floor(t / 2);
  return i.slice(0, r) + Yh + i.slice(-s);
}
o(ju, "truncateString");
var Z2 = o(i => {
    let {
  ...
  eP = o(i => {
    ...
    return t ? c("div", {
      ...
      target: "_blank",
      rel: "noopener noreferrer"
    }, ju(t.name, 13)), r ? c(vt, null, ` ${s} `, r, ` ${s} `) : null) : null;
  }, "renderAuthor"),
  tP = o(i => i.file.size && c("div", {
    className: "uppy-Dashboard-Item-statusSize"
  }, (0, My.default)(i.file.size)), "renderFileSize"),
  iP = o(i => i.file.isGhost && c("span", null, " \u2022 ", c("button", {
...
o(oP, "RemoveButton");
var nP = o((i, e) => {
  Jh(e.file.uploadURL, e.i18n("copyLinkToClipboardFallback")).then(() => {
...
var fa = class extends Te {
  ...
  shouldComponentUpdate(e) {
    return !(0, jy.default)(this.props, e);
  }
  componentDidUpdate() {
    let {
      file: e
...
function ed(i) {
  let {
    ...
    Re = K === 1 ? 71 : 200,
    $e = Ro(() => {
      let Pe = o((C, P) => n[P].isGhost - n[C].isGhost, "sortByGhostComesFirst"),
        Le = Object.keys(n);
      return $ && Le.sort(Pe), lP(Le, K);
    }, [n, K, $]),
    we = o(Pe => c("div", {
...
o(ed, "FileList");
var zy;
zy = Symbol.for("uppy test: disable unused locale key warning");
var td = class extends Te {
    ...
    constructor() {
      super(...arguments), this.triggerFileInputClick = () => {
      ...
      }, this.renderHiddenInput = (e, t) => c("input", {
        ...
        return c(vt, null, t.map(s => this.renderAcquirer(s)), c("span", {
          role: "presentation",
          style: {
            "white-space": "nowrap"
          }
        ...
        return c(vt, null, this.renderDropPasteBrowseTagline(n.length), c("div", {
...
var Hy = be(li(), 1);
var uP = o(i => c("div", {
    className: (0, Hy.default)("uppy-Dashboard-AddFilesPanel", i.className),
  ...
  }, i.i18n("back"))), c(zu, i)), "AddFilesPanel"),
  $y = uP;
var qy = be(li(), 1);
function cP(i) {
  let {
...
function hP(i) {
  ...
  return c("div", {
    className: (0, qy.default)("uppy-DashboardContent-panel", t),
    role: "tabpanel",
...
function dP(i) {
  ...
  return c("div", {
    className: (0, Wy.default)("uppy-DashboardContent-panel", i.className),
    role: "tabpanel",
...
function pP(i, e, t, r) {
  ...
  for (let a = 0; a < n.length; a++) {
    ...
    if (u.uploadStarted && !u.uploadComplete) return Yi.STATE_UPLOADING;
    u.preprocess && s !== Yi.STATE_UPLOADING && (s = Yi.STATE_PREPROCESSING), u.postprocess && s !== Yi.STATE_UPLOADING && s !== Yi.STATE_PREPROCESSING && (s = Yi.STATE_POSTPROCESSING);
  }
  return s;
}
o(pP, "getUploadingState");
function fP(i) {
  let {
    files: e,
    i18n: t,
...
function mP(i) {
  ...
  return u && s && (u = i.totalFileCount < i.maxNumberOfFiles), c("div", {
    className: "uppy-DashboardContent-bar"
  }, !t && !r ? c("button", {
    className: "uppy-DashboardContent-back",
    type: "button",
...
function id(i) {
  ...
  return e.map(u => {
    ...
    return c("fieldset", {
      ...
      htmlFor: l
    }, u.name), u.render !== void 0 ? u.render({
      value: n[u.id],
      onChange: d => r(d, u.id),
      fieldCSSClasses: a,
      required: h,
...
function rd(i) {
  ...
  T.forEach(te => {
    var re;
    _[te.id] = (re = S.meta[te.id]) != null ? re : "";
  });
  let [R, $] = vr(_),
    W = As(te => {
  ...
  return Gi(() => (document.body.appendChild(G), G.addEventListener("submit", W), () => {
    G.removeEventListener("submit", W), document.body.removeChild(G);
  }), [G, W]), c("div", {
    className: (0, Xy.default)("uppy-Dashboard-FileCard", p),
    ...
    style: {
      backgroundColor: Ns(S.type).color
    }
  }, c(da, {
    file: S
  }), O && c("button", {
...
o(rd, "FileCard");
var Qy = be(li(), 1);
var Bo = "uppy-transition-slideDownUp",
  Yy = 250;
function gP(i) {
  let {
      children: e
    ...
    l = Cs(),
    h = o(() => {
      n(`${Bo}-enter`), cancelAnimationFrame(l.current), clearTimeout(u.current), u.current = void 0, l.current = requestAnimationFrame(() => {
        n(`${Bo}-enter ${Bo}-enter-active`), a.current = setTimeout(() => {
          n("");
        }, Yy);
      });
    }, "handleEnterTransition"),
    d = o(() => {
      n(`${Bo}-leave`), cancelAnimationFrame(l.current), clearTimeout(a.current), a.current = void 0, l.current = requestAnimationFrame(() => {
        n(`${Bo}-leave ${Bo}-leave-active`), u.current = setTimeout(() => {
          r(null), n("");
        }, Yy);
      });
  ...
  return Gi(() => {
    let p = Pi(e)[0];
    t !== p && (p && !t ? h() : t && !p && !u.current && d(), r(p));
  }, [e, t]), Gi(() => () => {
    clearTimeout(a.current), clearTimeout(u.current), cancelAnimationFrame(l.current);
  }, []), t ? tu(t, {
    className: (0, Qy.default)(s, t.props.className)
  }) : null;
}
o(gP, "Slide");
var ma = gP;
function Ms() {
  return Ms = Object.assign ? Object.assign.bind() : function (i) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (i[r] = t[r]);
    }
...
function od(i) {
  let e = i.totalFileCount === 0,
    ...
    r = i.containerWidth > sd,
    s = i.containerHeight > ev,
    n = (0, tv.default)({
      "uppy-Dashboard": !0,
      ...
      "uppy-size--md": i.containerWidth > sd,
      "uppy-size--lg": i.containerWidth > Zy,
      "uppy-size--xl": i.containerWidth > Jy,
      "uppy-size--height-md": i.containerHeight > ev,
    ...
    a = 1;
  i.containerWidth > Jy ? a = 5 : i.containerWidth > Zy ? a = 4 : i.containerWidth > sd && (a = 3);
  let u = i.showSelectedFiles && !e,
    l = i.recoveredState ? Object.keys(i.recoveredState.files).length : null,
    h = i.files ? Object.keys(i.files).filter(y => i.files[y].isGhost).length : null,
    d = o(() => h > 0 ? i.i18n("recoveredXFiles", {
      smart_count: h
  ...
  return c("div", {
    ...
    "data-uppy-drag-drop-supported": !i.disableLocalFiles && ha(),
  ...
  }, i.i18n("dropHint")), u && c(Ky, i), l && c("div", {
    ...
    isSizeMD: r
  })), c(ma, null, i.showAddFilesPanel ? c($y, Ms({
    key: "AddFiles"
  }, i, {
    isSizeMD: r
  })) : null), c(ma, null, i.fileCardFor ? c(rd, Ms({
    key: "FileCard"
  }, i)) : null), c(ma, null, i.activePickerPanel ? c(Vy, Ms({
    key: "Picker"
  }, i)) : null), c(ma, null, i.showFileEditor ? c(Gy, Ms({
    key: "Editor"
  }, i)) : null), c("div", {
    className: "uppy-Dashboard-progressindicators"
  }, i.progressindicators.map(y => i.uppy.getPlugin(y.id).render(i.state))))));
}
o(od, "Dashboard");
var iv = {
  strings: {
...
o(Li, "_classPrivateFieldLooseKey");
var vP = {
    version: "3.9.0"
  },
  nd = $h.default || $h,
...
var wP = {
  ...
  Bs = Li("disabledNodes"),
  xr = Li("generateLargeThumbnailIfSingleFile"),
  ga = Li("openFileEditorWhenFilesAdded"),
  js = Li("attachRenderFunctionToTarget"),
  ad = Li("isTargetSupported"),
  ld = Li("getAcquirers"),
  ud = Li("getProgressIndicators"),
  Fr = Li("getEditors"),
  cd = Li("addSpecifiedPluginsFromOptions"),
  hd = Li("autoDiscoverPlugins"),
  zs = Li("addSupportedPluginIfNoTarget"),
  jo = class extends ae {
    static {
      o(this, "Dashboard");
    }
    constructor(e, t) {
      var r, s, n, a;
      let u;
      t ? t.autoOpen === void 0 ? u = t.autoOpenFileEditor ? "imageEditor" : null : u = t.autoOpen : u = null, super(e, {
        ...wP,
        ...t,
        autoOpen: u
        ...
        writable: !0,
        value: void 0
      }), this.modalName = `uppy-Dashboard-${Xt()}`, this.superFocus = Vh(), this.ifFocusedOnUppyRecently = !1, this.removeTarget = l => {
        let d = this.getPluginState().targets.filter(p => p.id !== l.id);
        this.setPluginState({
          targets: d
        });
      }, this.addTarget = l => {
        let h = l.id || l.constructor.name,
          d = l.title || h,
          p = l.type;
        if (p !== "acquirer" && p !== "progressindicator" && p !== "editor") return this.uppy.log("Dashboard: can only be targeted by plugins of types: acquirer, progressindicator, editor", "error"), null;
        let y = {
            id: h,
            name: d,
            type: p
        ...
        return S.push(y), this.setPluginState({
          targets: S
        }), this.el;
      }, this.hideAllPanels = () => {
        var l;
        ...
        h.activePickerPanel === d.activePickerPanel && h.showAddFilesPanel === d.showAddFilesPanel && h.showFileEditor === d.showFileEditor && h.activeOverlayType === d.activeOverlayType || (this.setPluginState(d), this.uppy.emit("dashboard:close-panel", (l = h.activePickerPanel) == null ? void 0 : l.id));
      }, this.showPanel = l => {
        let {
            targets: h
          } = this.getPluginState(),
          d = h.find(p => p.type === "acquirer" && p.id === l);
        this.setPluginState({
          activePickerPanel: d,
        ...
        return Ie(this, Fr)[Fr](h).some(p => this.uppy.getPlugin(p.id).canEditFile(l));
        ...
        this.setPluginState({
          ...
          this.uppy.getPlugin(p.id).selectFile(l);
        });
        ...
        if (this.savedScrollPosition = window.pageYOffset, this.savedActiveElement = document.activeElement, this.opts.disablePageScrollWhenModalOpen && document.body.classList.add("uppy-Dashboard-isFixed"), this.opts.animateOpenClose && this.getPluginState().isClosing) {
          let d = o(() => {
            this.setPluginState({
              isHidden: !1
            }), this.el.removeEventListener("animationend", d, !1), h();
          }, "handler");
        ...
        if (this.opts.disablePageScrollWhenModalOpen && document.body.classList.remove("uppy-Dashboard-isFixed"), this.opts.animateOpenClose) {
          ...
          let O = o(() => {
            this.setPluginState({
              isHidden: !0,
              isClosing: !1
            }), this.superFocus.cancel(), this.savedActiveElement.focus(), this.el.removeEventListener("animationend", O, !1), S();
          }, "handler");
        ...
        let h = l.matches;
        this.uppy.log(`[Dashboard] Dark mode is ${h ? "on" : "off"}`), this.setDarkModeCapability(h);
        ...
        this.resizeObserver = new ResizeObserver(l => {
          ...
          !l.areInsidesReadyToBeVisible && !h && (this.uppy.log("[Dashboard] resize event didn\u2019t fire on time: defaulted to mobile layout", "warning"), this.setPluginState({
            areInsidesReadyToBeVisible: !0
          }));
        }, 1e3);
        ...
        let d = ["a[href]", "input:not([disabled])", "select:not([disabled])", "textarea:not([disabled])", "button:not([disabled])", '[role="button"]:not([disabled])'],
          p = (h = Ie(this, Bs)[Bs]) != null ? h : nt(this.el.querySelectorAll(d)).filter(y => !y.classList.contains("uppy-Dashboard-close"));
        for (let y of p) y.tagName === "A" ? y.setAttribute("aria-disabled", l) : y.disabled = l;
        l ? Ie(this, Bs)[Bs] = p : Ie(this, Bs)[Bs] = null, this.dashboardIsDisabled = l;
        ...
        this.isModalOpen() && (!l.state || !l.state[this.modalName]) && this.closeModal({
          manualClose: !1
        }), !this.isModalOpen() && (h = l.state) != null && h[this.modalName] && history.back();
      }, this.handleKeyDownInModal = l => {
        l.keyCode === bP && this.requestCloseModal(), l.keyCode === rv && qh(l, this.getPluginState().activeOverlayType, this.el);
        ...
        let h = nt(l.clipboardData.files);
        h.length > 0 && (this.uppy.log("[Dashboard] Files pasted"), this.addFiles(h));
      }, this.handleInputChange = l => {
        l.preventDefault();
        let h = nt(l.target.files);
        h.length > 0 && (this.uppy.log("[Dashboard] Files selected through input"), this.addFiles(h));
      }, this.handleDragOver = l => {
        var h, d;
        l.preventDefault(), l.stopPropagation();
        let p = o(() => {
            let T = !0;
            return this.uppy.iteratePlugins(O => {
              O.canHandleRootDrop != null && O.canHandleRootDrop(l) && (T = !0);
            }), T;
          ...
          b = p(),
          S = y();
        if (!b && !S || this.opts.disabled || this.opts.disableLocalFiles && (S || !b) || !this.uppy.getState().allowNewUpload) {
          l.dataTransfer.dropEffect = "none", clearTimeout(this.removeDragOverClassTimeout);
          return;
        }
        l.dataTransfer.dropEffect = "copy", clearTimeout(this.removeDragOverClassTimeout), this.setPluginState({
          isDraggingOver: !0
        }), (h = (d = this.opts).onDragOver) == null || h.call(d, l);
      }, this.handleDragLeave = l => {
        var h, d;
        l.preventDefault(), l.stopPropagation(), clearTimeout(this.removeDragOverClassTimeout), this.removeDragOverClassTimeout = setTimeout(() => {
          this.setPluginState({
            isDraggingOver: !1
          });
        }, 50), (h = (d = this.opts).onDragLeave) == null || h.call(d, l);
      }, this.handleDrop = async l => {
        var h, d;
        l.preventDefault(), l.stopPropagation(), clearTimeout(this.removeDragOverClassTimeout), this.setPluginState({
          isDraggingOver: !1
        }), this.uppy.iteratePlugins(S => {
          S.type === "acquirer" && (S.handleRootDrop == null || S.handleRootDrop(l));
        });
        let p = !1,
          y = o(S => {
            this.uppy.log(S, "error"), p || (this.uppy.info(S.message, "error"), p = !0);
          }, "logDropError");
        this.uppy.log("[Dashboard] Processing dropped files");
        let b = await Ls(l.dataTransfer, {
          logDropError: y
        });
        b.length > 0 && (this.uppy.log("[Dashboard] Files dropped"), this.addFiles(b)), (h = (d = this.opts).onDrop) == null || h.call(d, l);
        ...
        l.keyCode === rv && Uy(l, this.getPluginState().activeOverlayType, this.el);
        ...
        this.opts.closeAfterFinish && !(h != null && h.length) && this.requestCloseModal();
        ...
        writable: !0,
        value: nd(l => l.filter(h => h.type === "acquirer" && Ie(this, ad)[ad](h)).map(Ie(this, js)[js]))
      }), Object.defineProperty(this, ud, {
        writable: !0,
        value: nd(l => l.filter(h => h.type === "progressindicator").map(Ie(this, js)[js]))
      }), Object.defineProperty(this, Fr, {
        writable: !0,
        value: nd(l => l.filter(h => h.type === "editor").map(Ie(this, js)[js]))
      }), this.render = l => {
        let h = this.getPluginState(),
          {
            files: d,
          ...
          te = Ie(this, ld)[ld](h.targets),
          re = Ie(this, ud)[ud](h.targets),
          Ee = Ie(this, Fr)[Fr](h.targets),
          Re;
        return this.opts.theme === "auto" ? Re = p.darkMode ? "dark" : "light" : Re = this.opts.theme, ["files", "folders", "both"].indexOf(this.opts.fileManagerSelectionType) < 0 && (this.opts.fileManagerSelectionType = "files", console.warn(`Unsupported option for "fileManagerSelectionType". Using default of "${this.opts.fileManagerSelectionType}".`)), od({
          state: l,
          isHidden: h.isHidden,
          files: d,
          newFiles: b,
        ...
        value: () => {
          (this.opts.plugins || []).forEach(h => {
            ...
            d ? d.mount(this, d) : this.uppy.log(`[Uppy] Dashboard could not find plugin '${h}', make sure to uppy.use() the plugins you are specifying`, "warning");
          });
        }
      }), Object.defineProperty(this, hd, {
        writable: !0,
        value: () => {
          this.uppy.iteratePlugins(Ie(this, zs)[zs]);
        }
        ...
        value: l => {
          ...
          l && !((h = l.opts) != null && h.target) && d.includes(l.type) && (this.getPluginState().targets.some(y => l.id === y.id) || l.mount(this, l));
        }
      }), this.install = () => {
        this.setPluginState({
          isHidden: !0,
        ...
        if (l && h) throw new Error("[Dashboard] `closeAfterFinish: true` cannot be used on an inline Dashboard, because an inline Dashboard cannot be closed at all. Either set `inline: false`, or disable the `closeAfterFinish` option.");
        let {
          allowMultipleUploads: d,
          allowMultipleUploadBatches: p
        } = this.uppy.opts;
        (d || p) && h && this.uppy.log("[Dashboard] When using `closeAfterFinish`, we recommended setting the `allowMultipleUploadBatches` option to `false` in the Uppy constructor. See https://uppy.io/docs/uppy/#allowMultipleUploads-true", "warning");
        let {
          target: y
        } = this.opts;
        y && this.mount(y, this), this.opts.disableStatusBar || this.uppy.use(Wr, {
          ...
          doneButtonHandler: this.opts.doneButtonHandler
        }), this.opts.disableInformer || this.uppy.use(Gr, {
          id: `${this.id}:Informer`,
          target: this
        }), this.opts.disableThumbnailGenerator || this.uppy.use(Is, {
        ...
        if (this.uppy.log(`[Dashboard] Dark mode is ${b ? "on" : "off"}`), this.setDarkModeCapability(b), this.opts.theme === "auto") {
          var S;
          (S = this.darkModeMediaQuery) == null || S.addListener(this.handleSystemDarkModeChange);
        }
        Ie(this, cd)[cd](), Ie(this, hd)[hd](), this.initEvents();
      }, this.uninstall = () => {
        ...
        if ((this.opts.plugins || []).forEach(d => {
          let p = this.uppy.getPlugin(d);
          p && p.unmount();
        }), this.opts.theme === "auto") {
          var h;
          (h = this.darkModeMediaQuery) == null || h.removeListener(this.handleSystemDarkModeChange);
        }
      ...
      }, this.id = this.opts.id || "Dashboard", this.title = "Dashboard", this.type = "orchestrator", this.defaultLocale = iv, (s = (r = this.opts).doneButtonHandler) != null || (r.doneButtonHandler = () => {
        this.uppy.clearUploadedFiles(), this.requestCloseModal();
      }), (a = (n = this.opts).onRequestCloseModal) != null || (n.onRequestCloseModal = () => this.closeModal()), this.i18nInit();
    }
  };
exports.Dashboard = jo;
jo.VERSION = vP.version;
var ov = {
  strings: {
  ...
  zo = class i extends ae {
    ...
    constructor(e, t) {
      super(e, {
        ...PP,
        ...t
      }), this.isDragDropSupported = ha(), this.addFiles = r => {
        let s = r.map(n => ({
          source: this.id,
          name: n.name,
          type: n.type,
        ...
        let s = nt(r.target.files);
        s.length > 0 && (this.uppy.log("[DragDrop] Files selected through input"), this.addFiles(s)), r.target.value = null;
        ...
        if (!u || !l) {
          r.dataTransfer.dropEffect = "none", clearTimeout(this.removeDragOverClassTimeout);
          return;
        }
        r.dataTransfer.dropEffect = "copy", clearTimeout(this.removeDragOverClassTimeout), this.setPluginState({
          isDraggingOver: !0
        }), (s = (n = this.opts).onDragOver) == null || s.call(n, r);
      }, this.handleDragLeave = r => {
        var s, n;
        r.preventDefault(), r.stopPropagation(), clearTimeout(this.removeDragOverClassTimeout), this.removeDragOverClassTimeout = setTimeout(() => {
          this.setPluginState({
            isDraggingOver: !1
          });
        }, 50), (s = (n = this.opts).onDragLeave) == null || s.call(n, r);
      }, this.handleDrop = async r => {
        var s, n;
        r.preventDefault(), r.stopPropagation(), clearTimeout(this.removeDragOverClassTimeout), this.setPluginState({
          isDraggingOver: !1
        });
        let a = o(l => {
            this.uppy.log(l, "error");
          }, "logDropError"),
          u = await Ls(r.dataTransfer, {
            logDropError: a
          });
        u.length > 0 && (this.uppy.log("[DragDrop] Files dropped"), this.addFiles(u)), (s = (n = this.opts).onDrop) == null || s.call(n, r);
      }, this.type = "acquirer", this.id = this.opts.id || "DragDrop", this.title = "Drag & Drop", this.defaultLocale = ov, this.i18nInit();
    }
...
var ya = class extends Oe {
  ...
  constructor(e, t) {
    super(e, {
      ...
      var s, n, a;
      if (!dd(r)) return;
      r.preventDefault(), r.stopPropagation(), clearTimeout(this.removeDragOverClassTimeout), (s = r.currentTarget) == null || s.classList.remove("uppy-is-drag-over"), this.setPluginState({
        isDraggingOver: !1
      }), this.uppy.iteratePlugins(d => {
        d.type === "acquirer" && (d.handleRootDrop == null || d.handleRootDrop(r));
      });
      let u = !1,
        l = o(d => {
          this.uppy.log(d, "error"), u || (this.uppy.info(d.message, "error"), u = !0);
        }, "logDropError"),
        h = await Ls(r.dataTransfer, {
          logDropError: l
        });
      h.length > 0 && (this.uppy.log("[DropTarget] Files were dropped"), this.addFiles(h)), (n = (a = this.opts).onDrop) == null || n.call(a, r);
    }, this.handleDragOver = r => {
      var s, n;
      dd(r) && (r.preventDefault(), r.stopPropagation(), r.dataTransfer.dropEffect = "copy", clearTimeout(this.removeDragOverClassTimeout), r.currentTarget.classList.add("uppy-is-drag-over"), this.setPluginState({
        isDraggingOver: !0
      }), (s = (n = this.opts).onDragOver) == null || s.call(n, r));
    }, this.handleDragLeave = r => {
      var s, n;
      ...
      clearTimeout(this.removeDragOverClassTimeout), this.removeDragOverClassTimeout = setTimeout(() => {
        a.classList.remove("uppy-is-drag-over"), this.setPluginState({
          isDraggingOver: !1
        });
      }, 50), (s = (n = this.opts).onDragLeave) == null || s.call(n, r);
    }, this.addListeners = () => {
      ...
      if (r instanceof Element ? this.nodes = [r] : typeof r == "string" && (this.nodes = nt(document.querySelectorAll(r))), !this.nodes || this.nodes.length === 0) throw new Error(`"${r}" does not match any HTML elements`);
...
exports.DropTarget = ya;
ya.VERSION = _P.version;
var nv = {
  strings: {
  ...
  Ho = class extends ae {
    ...
    constructor(e, t) {
      super(e, {
        ...EP,
        ...t
      }), this.id = this.opts.id || "FileInput", this.title = "File Input", this.type = "acquirer", this.defaultLocale = nv, this.i18nInit(), this.render = this.render.bind(this), this.handleInputChange = this.handleInputChange.bind(this), this.handleClick = this.handleClick.bind(this);
    }
    addFiles(e) {
      let t = e.map(r => ({
        source: this.id,
...
exports.FileInput = Ho;
Ho.VERSION = FP.version;
var dv = be(av(), 1);
function OP(i, e) {
...
o(OP, "getCanvasDataThatFitsPerfectlyIntoContainer");
var lv = OP;
function CP(i) {
...
o(AP, "getScaleFactorThatRemovesDarkCorners");
var uv = AP;
function TP(i, e, t) {
...
o(TP, "limitCropboxMovementOnMove");
var cv = TP;
function RP(i, e, t) {
  return e.left < i.left ? {
    left: i.left,
...
o(RP, "limitCropboxMovementOnResize");
var hv = RP;
var va = class extends Te {
  ...
  constructor(e) {
    super(e), this.onRotate90Deg = () => {
      ...
      let a = this.cropper.getImageData(),
        u = uv(a.naturalWidth, a.naturalHeight, r),
  ...
  componentDidMount() {
    ...
    this.cropper = new dv.default(this.imgElement, e.cropperOptions), this.imgElement.addEventListener("cropstart", this.storePrevCropboxData), this.imgElement.addEventListener("cropend", this.limitCropboxMovement), t(this.cropper);
  }
  componentWillUnmount() {
...
var kP = {
  ...
  $o = class extends ae {
    ...
    constructor(e, t) {
      super(e, {
        ...
        let r = o(a => {
            ...
            this.uppy.emit("thumbnail:request", l), this.setPluginState({
              currentImage: l
      ...
      }, this.id = this.opts.id || "ImageEditor", this.title = "Image Editor", this.type = "editor", this.defaultLocale = pv, this.i18nInit();
    }
    canEditFile(e) {
    ...
    render() {
      ...
      return e === null || e.isRemote ? null : c(va, {
        currentImage: e,
...
exports.ImageEditor = $o;
$o.VERSION = kP.version;
var DP = {
    version: "3.1.1"
  },
  IP = {
...
exports.ProgressBar = qo;
qo.VERSION = DP.version;
var LP = {
  __proto__: null,
  "audio/mp3": "mp3",
  "audio/mp4": "mp4",
...
o(NP, "_classPrivateFieldLooseBase");
var MP = 0;
function BP(i) {
  return "__private_" + MP++ + "_" + i;
}
o(BP, "_classPrivateFieldLooseKey");
function yv(i) {
...
var bd = BP("draw"),
  wa = class {
    ...
    draw() {
      ...
      for (let h = 0; h < r; h++) {
        let p = t[h] / 128 * (a / 2);
        h === 0 ? s.moveTo(l, p) : s.lineTo(l, p), l += u;
      }
      s.lineTo(n, a / 2), s.stroke(), this.onDrawFrame(this), requestAnimationFrame(NP(this, bd)[bd]);
    }
  };
function jP(i) {
  let {
...
function wd(i) {
  ...
  Gi(() => () => {
    ...
    if (!t && (T.current = new wa(S.current, {
      canvas: {
        width: 600,
        height: 600
      },
...
var $P = {
  ...
  _t = Ft("stream"),
  Er = Ft("audioActive"),
  He = Ft("recordingChunks"),
  ze = Ft("recorder"),
  Or = Ft("capturedMediaFile"),
  xt = Ft("mediaDevices"),
  Sa = Ft("supportsUserMedia"),
  Sd = Ft("hasAudioCheck"),
  Hs = Ft("start"),
  Pd = Ft("startRecording"),
  Pa = Ft("stopRecording"),
  _d = Ft("discardRecordedAudio"),
  xd = Ft("submit"),
  Cr = Ft("stop"),
  Fd = Ft("getAudio"),
  Ed = Ft("changeSource"),
  ...
  Vo = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), Object.defineProperty(this, Fd, {
        value: VP
        ...
        writable: !0,
        value: r => {
          if (!Z(this, Sa)[Sa]) return Promise.reject(new Error("Microphone access not supported"));
          Z(this, Er)[Er] = !0, Z(this, Sd)[Sd]().then(s => (this.setPluginState({
            hasAudio: s
          }), Z(this, xt)[xt].getUserMedia({
            audio: !0
          }).then(n => {
            Z(this, _t)[_t] = n;
            let a = null,
              u = n.getAudioTracks();
            r != null && r.deviceId ? a = u.findLast(l => l.getSettings().deviceId === r.deviceId) : a = u[0].getSettings().deviceId, Z(this, $s)[$s](), this.setPluginState({
              currentDeviceId: a,
              audioReady: !0
            });
          }).catch(n => {
        ...
        writable: !0,
        value: () => {
          Z(this, ze)[ze] = new MediaRecorder(Z(this, _t)[_t]), Z(this, He)[He] = [];
          let r = !1;
          Z(this, ze)[ze].addEventListener("dataavailable", s => {
            Z(this, He)[He].push(s.data);
            let {
              restrictions: n
            } = this.uppy.opts;
            if (Z(this, He)[He].length > 1 && n.maxFileSize != null && !r) {
              let a = Z(this, He)[He].reduce((d, p) => d + p.size, 0),
                l = (a - Z(this, He)[He][0].size) / (Z(this, He)[He].length - 1) * 3,
                h = Math.max(0, n.maxFileSize - l);
              a > h && (r = !0, this.uppy.info(this.i18n("recordingStoppedMaxSize"), "warning", 4e3), Z(this, Pa)[Pa]());
            }
          }), Z(this, ze)[ze].start(500), this.recordingLengthTimer = setInterval(() => {
        ...
        writable: !0,
        value: () => new Promise(s => {
          Z(this, ze)[ze].addEventListener("stop", () => {
            s();
          }), Z(this, ze)[ze].stop(), clearInterval(this.recordingLengthTimer), this.setPluginState({
          ...
          try {
            Z(this, Or)[Or] = s, this.setPluginState({
          ...
          Z(this, He)[He] = null, Z(this, ze)[ze] = null;
        }, s => {
          throw Z(this, He)[He] = null, Z(this, ze)[ze] = null, s;
        })
        ...
        value: () => {
          try {
            Z(this, Or)[Or] && this.uppy.addFile(Z(this, Or)[Or]);
          } catch (r) {
        ...
        writable: !0,
        value: async () => {
          Z(this, _t)[_t] && Z(this, _t)[_t].getAudioTracks().forEach(s => s.stop()), Z(this, ze)[ze] && (await new Promise(r => {
            Z(this, ze)[ze].addEventListener("stop", r, {
              once: !0
            }), Z(this, ze)[ze].stop(), clearInterval(this.recordingLengthTimer);
          })), Z(this, He)[He] = null, Z(this, ze)[ze] = null, Z(this, Er)[Er] = !1, Z(this, _t)[_t] = null, this.setPluginState({
            recordedAudio: null,
            isRecording: !1,
            recordingLengthSeconds: 0
          });
        ...
        writable: !0,
        value: () => {
          Z(this, xt)[xt].enumerateDevices().then(r => {
            this.setPluginState({
              audioSources: r.filter(s => s.kind === "audioinput")
            });
          });
        }
      }), Z(this, xt)[xt] = navigator.mediaDevices, Z(this, Sa)[Sa] = Z(this, xt)[xt] != null, this.id = this.opts.id || "Audio", this.type = "acquirer", this.icon = () => c("svg", {
        ...
        fill: "currentcolor",
        "fill-rule": "nonzero"
      })), this.defaultLocale = Sv, this.opts = {
        ...t
    ...
    render() {
      Z(this, Er)[Er] || Z(this, Hs)[Hs]();
      let e = this.getPluginState();
      return !e.audioReady || !e.hasAudio ? c(wv, {
        icon: this.icon,
        i18n: this.i18n,
        hasAudio: e.hasAudio
      }) : c(wd, Od({}, e, {
        audioActive: Z(this, Er)[Er],
        onChangeSource: Z(this, Ed)[Ed],
        onStartRecording: Z(this, Pd)[Pd],
        onStopRecording: Z(this, Pa)[Pa],
        onDiscardRecordedAudio: Z(this, _d)[_d],
        onSubmit: Z(this, xd)[xd],
        onStop: Z(this, Cr)[Cr],
        i18n: this.i18n,
        showAudioSourceDropdown: this.opts.showAudioSourceDropdown,
        supportsRecording: md(),
    ...
    install() {
      ...
      e && this.mount(e, this), Z(this, xt)[xt] && (Z(this, $s)[$s](), Z(this, xt)[xt].ondevicechange = () => {
        if (Z(this, $s)[$s](), Z(this, _t)[_t]) {
          let t = !0,
            {
              audioSources: r,
              currentDeviceId: s
          ...
          r.forEach(n => {
            s === n.deviceId && (t = !1);
          }), t && (Z(this, Cr)[Cr](), Z(this, Hs)[Hs]());
        }
      });
    }
    uninstall() {
      Z(this, _t)[_t] && Z(this, Cr)[Cr](), this.unmount();
    }
  };
exports.Audio = Vo;
function qP() {
  return Z(this, xt)[xt] ? Z(this, xt)[xt].enumerateDevices().then(i => i.some(e => e.kind === "audioinput")) : Promise.resolve(!1);
}
o(qP, "_hasAudioCheck2");
function VP() {
  let i = Z(this, He)[He].find(n => {
      var a;
...
var WP = {
  ...
  Xr = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.id = this.opts.id || "Box", this.type = "acquirer", this.storage = this.opts.storage || Je, this.files = [], this.icon = () => c("svg", {
      ...
      }))), this.opts.companionAllowedHosts = Qe(this.opts.companionAllowedHosts, this.opts.companionUrl), this.provider = new Ye(e, {
      ...
      }), this.defaultLocale = Pv, this.i18nInit(), this.title = this.i18n("pluginNameBox"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new Be(this, {
...
var GP = {
  ...
  Yr = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.id = this.opts.id || "Dropbox", this.type = "acquirer", this.storage = this.opts.storage || Je, this.files = [], this.icon = () => c("svg", {
      ...
      }), this.defaultLocale = _v, this.i18nInit(), this.title = this.opts.title || this.i18n("pluginNameDropbox"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new Be(this, {
        provider: this.provider,
...
var KP = {
  ...
  Qr = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.id = this.opts.id || "Facebook", this.type = "acquirer", this.storage = this.opts.storage || Je, this.files = [], this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
        ...
        pluginId: this.id,
        supportsRefreshToken: !1
      }), this.defaultLocale = xv, this.i18nInit(), this.title = this.i18n("pluginNameFacebook"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new Be(this, {
        provider: this.provider
...
exports.Facebook = Qr;
Qr.VERSION = KP.version;
var _a = class extends Be {
  static {
...
var XP = {
  ...
  Jr = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.type = "acquirer", this.storage = this.opts.storage || Je, this.files = [], this.id = this.opts.id || "GoogleDrive", this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
        ...
        pluginId: this.id,
        supportsRefreshToken: !0
      }), this.defaultLocale = Fv, this.i18nInit(), this.title = this.i18n("pluginNameGoogleDrive"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new _a(this, {
        provider: this.provider,
        loadAllFiles: !0,
        virtualList: !0
      });
...
exports.GoogleDrive = Jr;
Jr.VERSION = XP.version;
var Ev = {
  strings: {
...
var YP = {
  ...
  Zr = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.type = "acquirer", this.storage = this.opts.storage || Je, this.files = [], this.id = this.opts.id || "GooglePhotos", this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
        ...
        pluginId: this.id,
        supportsRefreshToken: !0
      }), this.defaultLocale = Ev, this.i18nInit(), this.title = this.i18n("pluginNameGooglePhotos"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new Be(this, {
        provider: this.provider,
    ...
    render(e) {
      return this.getPluginState().files.length && !this.getPluginState().folders.length ? this.view.render(e, {
        viewType: "grid",
        showFilter: !1,
        showTitles: !1
      }) : this.view.render(e);
...
exports.GooglePhotos = Zr;
Zr.VERSION = YP.version;
var Ov = {
  strings: {
...
var QP = {
  ...
  es = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.type = "acquirer", this.files = [], this.storage = this.opts.storage || Je, this.id = this.opts.id || "Instagram", this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
      ...
      }))), this.defaultLocale = Ov, this.i18nInit(), this.title = this.i18n("pluginNameInstagram"), this.opts.companionAllowedHosts = Qe(this.opts.companionAllowedHosts, this.opts.companionUrl), this.provider = new Ye(e, {
        companionUrl: this.opts.companionUrl,
        companionHeaders: this.opts.companionHeaders,
        companionKeysParams: this.opts.companionKeysParams,
        companionCookiesRule: this.opts.companionCookiesRule,
...
exports.Instagram = es;
es.VERSION = QP.version;
var Cv = {
  strings: {
...
var JP = {
  ...
  ts = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.type = "acquirer", this.files = [], this.storage = this.opts.storage || Je, this.id = this.opts.id || "OneDrive", this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
        ...
        pluginId: this.id,
        supportsRefreshToken: !1
      }), this.defaultLocale = Cv, this.i18nInit(), this.title = this.i18n("pluginNameOneDrive"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new Be(this, {
        provider: this.provider,
...
var ZP = {
  ...
  is = class extends ae {
    ...
    constructor(e, t) {
      if (super(e, t), this.type = "acquirer", this.files = [], this.storage = this.opts.storage || Je, this.id = this.opts.id || "Unsplash", this.title = this.opts.title || "Unsplash", this.icon = () => c("svg", {
      ...
      this.hostname = this.opts.companionUrl, this.opts.companionAllowedHosts = Qe(this.opts.companionAllowedHosts, this.opts.companionUrl), this.provider = new Fs(e, {
        companionUrl: this.opts.companionUrl,
        companionHeaders: this.opts.companionHeaders,
        companionCookiesRule: this.opts.companionCookiesRule,
        provider: "unsplash",
...
var e_ = 0;
function t_(i) {
  return "__private_" + e_++ + "_" + i;
}
o(t_, "_classPrivateFieldLooseKey");
var xa = t_("handleSubmit"),
  Cd = class extends Te {
    static {
      o(this, "UrlUI");
    }
    constructor(e) {
      super(e), this.form = document.createElement("form"), Object.defineProperty(this, xa, {
        writable: !0,
        value: t => {
          t.preventDefault();
          let {
    ...
    componentDidMount() {
      this.input.value = "", this.form.addEventListener("submit", Av(this, xa)[xa]), document.body.appendChild(this.form);
    }
    componentWillUnmount() {
      this.form.removeEventListener("submit", Av(this, xa)[xa]), document.body.removeChild(this.form);
    }
    render() {
      let {
        i18n: e
...
o(Hu, "forEachDroppedOrPastedUrl");
var Rv = {
  strings: {
    import: "Import",
...
o(s_, "addProtocolToURL");
function o_(i) {
  return nt(i.dataTransfer.items).filter(r => r.kind === "string" && r.type === "text/uri-list").length > 0;
}
o(o_, "canHandleRootDrop");
function n_(i) {
  return i?.startsWith("http://") || i?.startsWith("https://");
}
o(n_, "checkIfCorrectURL");
function a_(i) {
  let {
    pathname: e
  } = new URL(i);
...
o(a_, "getFileNameFromUrl");
var Ni = class i extends ae {
  static {
    o(this, "Url");
  }
  constructor(e, t) {
    if (super(e, t), this.getMeta = r => this.client.post("url/meta", {
      ...
      if (s.error) throw this.uppy.log("[URL] Error:"), this.uppy.log(s.error), new Error("Failed to fetch the file");
      return s;
      ...
      Hu(r.dataTransfer, "drop", s => {
        this.uppy.log(`[URL] Adding file from dropped url: ${s}`), this.addFile(s);
      });
    }, this.handleRootPaste = r => {
      Hu(r.clipboardData, "paste", s => {
        this.uppy.log(`[URL] Adding file from pasted url: ${s}`), this.addFile(s);
      });
    }, this.id = this.opts.id || "Url", this.title = this.opts.title || "Link", this.type = "acquirer", this.icon = () => c(r_, null), this.defaultLocale = Rv, this.i18nInit(), this.hostname = this.opts.companionUrl, !this.hostname) throw new Error("Companion hostname is required, please consult https://uppy.io/docs/companion");
...
exports.Url = Ni;
kv = Ni;
Ni.VERSION = i_.version;
Ni.requestClientId = kv.name;
Ni.prototype.canHandleRootDrop = o_;
var Uv = {
  strings: {
    pluginNameZoom: "Zoom"
  }
...
var l_ = {
  ...
  rs = class extends ae {
    ...
    constructor(e, t) {
      super(e, t), this.type = "acquirer", this.files = [], this.storage = this.opts.storage || Je, this.id = this.opts.id || "Zoom", this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
        ...
        pluginId: this.id,
        supportsRefreshToken: !1
      }), this.defaultLocale = Uv, this.i18nInit(), this.title = this.i18n("pluginNameZoom"), this.onFirstRender = this.onFirstRender.bind(this), this.render = this.render.bind(this);
    }
    install() {
      this.view = new Be(this, {
        provider: this.provider
...
exports.Zoom = rs;
rs.VERSION = l_.version;
function Ad(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
}
o(Ad, "_classPrivateFieldLooseBase");
var u_ = 0;
function c_(i) {
...
var h_ = {
  ...
  d_ = {
    sources: Object.keys(Td)
  },
  qs = c_("installedPlugins"),
  Fa = class extends Oe {
    static {
    ...
    install() {
      this.opts.sources.forEach(e => {
        let t = {
          ...
          r = Td[e];
        if (r == null) {
          let s = Object.keys(Td),
            n = new Intl.ListFormat("en", {
              style: "long",
              type: "disjunction"
            });
          throw new Error(`Invalid plugin: "${e}" is not one of: ${n.format(s)}.`);
        }
        this.uppy.use(r, t), Ad(this, qs)[qs].add(this.uppy.getPlugin(e));
      });
    }
    uninstall() {
      for (let e of Ad(this, qs)[qs]) this.uppy.removePlugin(e);
      Ad(this, qs)[qs].clear();
    }
  };
exports.RemoteSources = Fa;
Fa.VERSION = h_.version;
function Rd() {
  return c("svg", {
...
o(Id, "StreamStatus");
function Ld() {
  return Ld = Object.assign ? Object.assign.bind() : function (i) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (i[r] = t[r]);
    }
...
var Nd = class extends Te {
    ...
    render() {
      ...
      }, c(Id, this.props), c("video", Ld({
        ref: n => {
          this.videoElement = n;
        },
        className: "uppy-ScreenCapture-video"
      }, s)), c(Dv, this.props)), c("div", {
        className: "uppy-ScreenCapture-buttonContainer"
      }, c(kd, this.props), c(Ud, this.props)));
    }
  },
  Iv = Nd;
var Lv = {
...
function Md() {
  return Md = Object.assign ? Object.assign.bind() : function (i) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (i[r] = t[r]);
    }
...
o(m_, "isScreenRecordingSupported");
function g_() {
  return window.MediaRecorder && navigator.mediaDevices;
}
o(g_, "getMediaDevices");
var y_ = {
  ...
  Wo = class extends ae {
    ...
    startRecording() {
      ...
      this.selectVideoStreamSource().then(r => {
        ...
        t && MediaRecorder.isTypeSupported(t) && Qi(t) && (e.mimeType = t);
    ...
    render() {
      let e = this.getPluginState();
      return !e.streamActive && !this.captureActive && !this.userDenied && this.start(), c(Iv, Md({}, e, {
...
exports.ScreenCapture = Wo;
Wo.VERSION = f_.version;
var $v = be(Nv(), 1);
function jd(i, e, t) {
  return new Promise(r => {
    i.toBlob(r, e, t);
...
var Bv = P_;
function Gd() {
  return Gd = Object.assign ? Object.assign.bind() : function (i) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (i[r] = t[r]);
    }
...
o(qu, "isModeAvailable");
var Kd = class extends Te {
    static {
      o(this, "CameraScreen");
    }
    componentDidMount() {
    ...
    render() {
      let {
        ...
        _ = !!t,
        R = !_ && n && (qu(s, "video-only") || qu(s, "audio-only") || qu(s, "video-audio")),
        $ = !_ && qu(s, "picture"),
        W = n && l && !_,
        K = u && a && a.length > 1,
        q = {
      ...
      return t ? (q.muted = !1, q.controls = !0, q.src = t, this.videoElement && (this.videoElement.srcObject = null)) : (q.muted = !0, q.autoPlay = !0, q.srcObject = e), c("div", {
        ...
        className: `uppy-Webcam-video  ${p ? "uppy-Webcam-video--mirrored" : ""}`
      }, q))), c("div", {
        className: "uppy-Webcam-footer"
      }, c("div", {
        className: "uppy-Webcam-videoSourceContainer"
      }, K ? Wd(this.props) : null), c("div", {
...
function Qd() {
  return Qd = Object.assign ? Object.assign.bind() : function (i) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (i[r] = t[r]);
    }
...
o(Oa, "_classPrivateFieldLooseBase");
var __ = 0;
function x_(i) {
  return "__private_" + __++ + "_" + i;
}
o(x_, "_classPrivateFieldLooseKey");
var F_ = {
  version: "3.4.2"
};
function Hv(i) {
  return i[0] === "." ? fn[i.slice(1)] : i;
}
o(Hv, "toMimeType");
function E_(i) {
  return /^video\/[^*]+$/.test(i);
}
o(E_, "isVideoMimeType");
function O_(i) {
  return /^image\/[^*]+$/.test(i);
}
o(O_, "isImageMimeType");
function C_() {
  return navigator.mediaDevices;
}
o(C_, "getMediaDevices");
function Yd(i, e) {
  return i.includes(e);
}
o(Yd, "isModeAvailable");
var A_ = {
    ...
    mobileNativeCamera: (0, $v.default)({
      tablet: !0
    })
  },
  Mi = x_("enableMirror"),
  Go = class extends ae {
    ...
    constructor(e, t) {
      super(e, {
        ...
        writable: !0,
        value: void 0
      }), this.mediaDevices = C_(), this.supportsUserMedia = !!this.mediaDevices, this.protocol = location.protocol.match(/https/i) ? "https" : "http", this.id = this.opts.id || "Webcam", this.type = "acquirer", this.capturedMediaFile = null, this.icon = () => c("svg", {
        "aria-hidden": "true",
        focusable: "false",
        width: "32",
        height: "32",
    ...
    start(e) {
      ...
      this.webcamActive = !0, this.opts.mirror && (Oa(this, Mi)[Mi] = !0);
      ...
      this.hasCameraCheck().then(s => (this.setPluginState({
        ...
        this.stream = n;
        let a = null,
          u = this.isAudioOnly() ? n.getAudioTracks() : n.getVideoTracks();
        !e || !e.deviceId ? a = u[0].getSettings().deviceId : u.forEach(l => {
          l.getSettings().deviceId === e.deviceId && (a = l.getSettings().deviceId);
    ...
    getMediaRecorderOptions() {
      ...
      if (MediaRecorder.isTypeSupported) {
        let {
          ...
          r = [];
        this.opts.preferredVideoMimeType ? r = [this.opts.preferredVideoMimeType] : t.allowedFileTypes && (r = t.allowedFileTypes.map(Hv).filter(E_));
        let s = o(a => MediaRecorder.isTypeSupported(a) && Qi(a), "filterSupportedTypes"),
          n = r.filter(s);
    ...
    startRecording() {
      ...
      this.recorder.addEventListener("dataavailable", t => {
        ...
        if (this.recordingChunks.length > 1 && r.maxFileSize != null && !e) {
          ...
          s > u && (e = !0, this.uppy.info(this.i18n("recordingStoppedMaxSize"), "warning", 4e3), this.stopRecording());
        }
    ...
    discardRecordedVideo() {
      this.setPluginState({
        recordedVideo: null
      }), this.opts.mirror && (Oa(this, Mi)[Mi] = !0), this.capturedMediaFile = null;
    }
    submit() {
      try {
        this.capturedMediaFile && this.uppy.addFile(this.capturedMediaFile);
    ...
    getImage() {
      ...
      let {
        ...
        u = [];
      this.opts.preferredImageMimeType ? u = [this.opts.preferredImageMimeType] : a.allowedFileTypes && (u = a.allowedFileTypes.map(Hv).filter(O_));
      let l = u[0] || "image/jpeg",
        h = Qi(l) || "jpg",
        d = `cam-${Date.now()}.${h}`;
      return jd(s, l).then(p => ({
        source: this.id,
        name: d,
        data: new Blob([p], {
          type: l
    ...
    render() {
      ...
      let e = this.getPluginState();
      return !e.cameraReady || !e.hasCamera ? c(Xd, {
        icon: Ea,
        i18n: this.i18n,
        ...
        supportsRecording: zd(),
        recording: e.isRecording,
        mirror: Oa(this, Mi)[Mi],
        src: this.stream
      }));
    }
    install() {
      ...
      if (e && n) {
        var a;
        (a = this.getTargetPlugin(n)) == null || a.setOptions({
          showNativeVideoCameraButton: Yd(t, "video-only") || Yd(t, "video-audio"),
          showNativePhotoCameraButton: Yd(t, "picture"),
      ...
      this.setPluginState({
        cameraReady: !1,
        recordingLengthSeconds: 0
      }), n && this.mount(n, this), this.mediaDevices && (this.updateVideoSources(), this.mediaDevices.ondevicechange = () => {
...
exports.Webcam = Go;
Go.VERSION = F_.version;
function Ar(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
}
o(Ar, "_classPrivateFieldLooseBase");
var T_ = 0;
function qv(i) {
  return "__private_" + T_++ + "_" + i;
}
...
var jt = qv("uppy"),
  ...
  Tr = class {
    ...
    on(e, t) {
      return Ar(this, Ca)[Ca].push([e, t]), Ar(this, jt)[jt].on(e, t);
    }
    remove() {
      for (let [e, t] of Ar(this, Ca)[Ca].splice(0)) Ar(this, jt)[jt].off(e, t);
    }
    onFilePause(e, t) {
    ...
    onCancelAll(e, t) {
      ...
      this.on("cancel-all", function () {
        Ar(r, jt)[jt].getFile(e) && t(...arguments);
      });
    }
    onResumeAll(e, t) {
      this.on("resume-all", () => {
  ...
  Jt = class {
    ...
    constructor(e) {
      Object.defineProperty(this, tp, {
        ...
        value: () => {
          if (se(this, di)[di]) {
            se(this, Rr)[Rr] = setTimeout(se(this, Gs)[Gs], 0);
            return;
          }
          se(this, zt)[zt] = this.limit, this.limit = Math.ceil((se(this, Ws)[Ws] + se(this, zt)[zt]) / 2);
          for (let t = se(this, zt)[zt]; t <= this.limit; t++) se(this, kr)[kr]();
          se(this, Ws)[Ws] - se(this, zt)[zt] > 3 ? se(this, Rr)[Rr] = setTimeout(se(this, Gs)[Gs], 2e3) : se(this, zt)[zt] = Math.floor(se(this, zt)[zt] / 2);
        }
      }), typeof e != "number" || e === 0 ? this.limit = 1 / 0 : this.limit = e;
    }
    run(e, t) {
      return !se(this, di)[di] && se(this, pi)[pi] < this.limit ? se(this, Aa)[Aa](e) : se(this, Jd)[Jd](e, t);
    }
    wrapSyncFunction(e, t) {
      var r = this;
      return function () {
        for (var s = arguments.length, n = new Array(s), a = 0; a < s; a++) n[a] = arguments[a];
        let u = r.run(() => (e(...n), queueMicrotask(() => u.done()), () => {}), t);
        return {
          abortOn: Vv,
          abort() {
            u.abort();
    ...
    resume() {
      se(this, di)[di] = !1, clearTimeout(se(this, Vs)[Vs]);
      for (let e = 0; e < this.limit; e++) se(this, kr)[kr]();
    }
    pause(e) {
      e === void 0 && (e = null), se(this, di)[di] = !0, clearTimeout(se(this, Vs)[Vs]), e != null && (se(this, Vs)[Vs] = setTimeout(se(this, Zd)[Zd], e));
    }
    rateLimit(e) {
      clearTimeout(se(this, Rr)[Rr]), this.pause(e), this.limit > 1 && Number.isFinite(this.limit) && (se(this, Ws)[Ws] = this.limit - 1, this.limit = se(this, zt)[zt], se(this, Rr)[Rr] = setTimeout(se(this, Gs)[Gs], e));
    }
    get isPaused() {
...
function U_(i) {
  ...
  return {
    abort: r => {
      e || (e = !0, se(this, pi)[pi] -= 1, t?.(r), se(this, kr)[kr]());
    },
    done: () => {
      e || (e = !0, se(this, pi)[pi] -= 1, se(this, kr)[kr]());
    }
  };
}
o(U_, "_call2");
function D_() {
  queueMicrotask(() => se(this, ep)[ep]());
}
o(D_, "_queueNext2");
function I_() {
  if (se(this, di)[di] || se(this, pi)[pi] >= this.limit || se(this, Ht)[Ht].length === 0) return;
  let i = se(this, Ht)[Ht].shift();
  if (i == null) throw new Error("Invariant violation: next is null");
  let e = se(this, Aa)[Aa](i.fn);
...
function L_(i, e) {
  ...
  return r === -1 ? se(this, Ht)[Ht].push(t) : se(this, Ht)[Ht].splice(r, 0, t), t;
}
o(L_, "_queue2");
function N_(i) {
...
o(ns, "filterFilesToEmitUploadStarted");
var {
    AbortController: Vu
  } = globalThis,
  {
  ...
  Wu = o(function (i, e) {
    ...
    return e != null && oi(e, "cause") && Object.defineProperty(t, "cause", {
      __proto__: null,
      configurable: !0,
      writable: !0,
      value: e.cause
...
o(j_, "ensureInt");
var Ia = Symbol("pausing upload, not an actual error"),
  Et = pt("abortController"),
  dt = pt("chunks"),
  $t = pt("chunkState"),
  fi = pt("data"),
  mi = pt("file"),
  La = pt("uploadHasStarted"),
  Ta = pt("onError"),
  Ys = pt("onSuccess"),
  Ur = pt("shouldUseMultipart"),
  Xs = pt("isRestoring"),
  Na = pt("onReject"),
  Ks = pt("maxMultipartParts"),
  ka = pt("minPartSize"),
  ip = pt("initChunks"),
  rp = pt("createUpload"),
  Ra = pt("resumeUpload"),
  Ua = pt("onPartProgress"),
  Da = pt("onPartComplete"),
  sp = pt("abortUpload"),
  op = class {
    static {
    ...
    constructor(e, t) {
      ...
      Object.defineProperty(this, sp, {
        ...
        writable: !0,
        value: n => n?.cause === Ia ? null : ee(this, Ta)[Ta](n)
        ...
        value: n => a => {
          ...
          ee(this, $t)[$t][n].uploaded = j_(a.loaded);
        ...
        writable: !0,
        value: n => a => {
          ee(this, dt)[dt][n] = null, ee(this, $t)[$t][n].etag = a, ee(this, $t)[$t][n].done = !0;
          let u = {
            PartNumber: n + 1,
            ETag: a
          };
        ...
        ...Wv,
        ...t
      }, (s = (r = this.options).getChunkSize) != null || (r.getChunkSize = Wv.getChunkSize), ee(this, fi)[fi] = e, ee(this, mi)[mi] = t.file, ee(this, Ys)[Ys] = this.options.onSuccess, ee(this, Ta)[Ta] = this.options.onError, ee(this, Ur)[Ur] = this.options.shouldUseMultipart, ee(this, Xs)[Xs] = t.uploadId && t.key, ee(this, ip)[ip]();
    }
    start() {
      ee(this, La)[La] ? (ee(this, Et)[Et].signal.aborted || ee(this, Et)[Et].abort(Ia), ee(this, Et)[Et] = new Vu(), ee(this, Ra)[Ra]()) : ee(this, Xs)[Xs] ? (this.options.companionComm.restoreUploadFile(ee(this, mi)[mi], {
        uploadId: this.options.uploadId,
        key: this.options.key
      }), ee(this, Ra)[Ra]()) : ee(this, rp)[rp]();
    }
    pause() {
      ee(this, Et)[Et].abort(Ia), ee(this, Et)[Et] = new Vu();
    }
    abort(e) {
      e != null && e.really ? ee(this, sp)[sp]() : this.pause();
    }
    get chunkState() {
      return ee(this, $t)[$t];
    }
...
function z_() {
  let i = ee(this, fi)[fi].size,
    e = typeof ee(this, Ur)[Ur] == "function" ? ee(this, Ur)[Ur](ee(this, mi)[mi]) : !!ee(this, Ur)[Ur];
  if (e && i > ee(this, ka)[ka]) {
    let t = Math.max(this.options.getChunkSize(ee(this, fi)[fi]), ee(this, ka)[ka]),
      r = Math.floor(i / t);
    r > ee(this, Ks)[Ks] && (r = ee(this, Ks)[Ks], t = i / ee(this, Ks)[Ks]), ee(this, dt)[dt] = Array(r);
    for (let s = 0, n = 0; s < i; s += t, n++) {
      ...
      if (ee(this, dt)[dt][n] = {
        getData: u,
        onProgress: ee(this, Ua)[Ua](n),
        onComplete: ee(this, Da)[Da](n),
    ...
    onProgress: ee(this, Ua)[Ua](0),
    onComplete: ee(this, Da)[Da](0),
    shouldUseMultipart: e
  }];
  ee(this, $t)[$t] = ee(this, dt)[dt].map(() => ({
    uploaded: 0
  }));
}
o(z_, "_initChunks2");
function H_() {
  this.options.companionComm.uploadFile(ee(this, mi)[mi], ee(this, dt)[dt], ee(this, Et)[Et].signal).then(ee(this, Ys)[Ys], ee(this, Na)[Na]), ee(this, La)[La] = !0;
}
o(H_, "_createUpload2");
function $_() {
  this.options.companionComm.resumeUploadFile(ee(this, mi)[mi], ee(this, dt)[dt], ee(this, Et)[Et].signal).then(ee(this, Ys)[Ys], ee(this, Na)[Na]);
}
o($_, "_resumeUpload2");
function q_() {
  ee(this, Et)[Et].abort(), this.options.companionComm.abortFileUpload(ee(this, mi)[mi]).catch(i => this.options.log(i));
}
o(q_, "_abortUpload2");
var Gv = op;
function wt(i) {
  if (i != null && i.aborted) throw Wu("The operation was aborted", {
    cause: i.reason
  });
}
o(wt, "throwIfAborted");
function V_(i) {
  let {
    ...
    a = Object.keys(s).map(u => u.toLowerCase()).sort();
  return [e, t, r, ...a.map(u => `${u}:${s[u]}`), "", a.join(";"), n].join(`
`);
}
o(V_, "createCanonicalRequest");
var np = new TextEncoder(),
  ap = {
    name: "HMAC",
    hash: "SHA-256"
  };
async function W_(i) {
  ...
  return e.digest(ap.hash, np.encode(i));
}
o(W_, "digest");
async function G_(i) {
  let {
  ...
  return e.importKey("raw", typeof i == "string" ? np.encode(i) : i, ap, !1, ["sign"]);
}
o(G_, "generateHmacKey");
function Kv(i) {
...
async function Ma(i, e) {
  ...
  return t.sign(ap, await G_(i), np.encode(e));
}
o(Ma, "hash");
async function lp(i) {
  let {
    ...
    d = "s3",
    p = `${s}.${d}.${a}.amazonaws.com`,
    y = `/${encodeURI(n).replace(/[;?:@&=+$,#!'()*]/g, Ee => `%${Ee.charCodeAt(0).toString(16).toUpperCase()}`)}`,
    b = "UNSIGNED-PAYLOAD",
    S = new Date().toISOString().replace(/[-:]|\.\d+/g, ""),
    T = S.slice(0, 8),
    O = `${T}/${a}/${d}/aws4_request`,
    _ = new URL(`https://${p}${y}`);
  _.searchParams.set("X-Amz-Algorithm", "AWS4-HMAC-SHA256"), _.searchParams.set("X-Amz-Content-Sha256", b), _.searchParams.set("X-Amz-Credential", `${e}/${O}`), _.searchParams.set("X-Amz-Date", S), _.searchParams.set("X-Amz-Expires", u), _.searchParams.set("X-Amz-Security-Token", r), _.searchParams.set("X-Amz-SignedHeaders", "host"), h && _.searchParams.set("partNumber", h), l && _.searchParams.set("uploadId", l), _.searchParams.set("x-id", h && l ? "UploadPart" : "PutObject");
  let R = V_({
      CanonicalUri: y,
...
`),
    ...
    q = await Ma(K, a),
    G = await Ma(q, d),
    te = await Ma(G, "aws4_request"),
    re = Kv(await Ma(te, W));
  return _.searchParams.set("X-Amz-Signature", re), _;
}
o(lp, "createSignedURL");
function ne(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
}
...
o(X_, "removeMetadataFromURL");
var Ba = qt("abortMultipartUpload"),
  Ot = qt("cache"),
  ja = qt("createMultipartUpload"),
  za = qt("fetchSignature"),
  qa = qt("getUploadParameters"),
  Ha = qt("listParts"),
  eo = qt("previousRetryDelay"),
  to = qt("requests"),
  Qs = qt("retryDelays"),
  Js = qt("sendCompletionRequest"),
  Zs = qt("setS3MultipartState"),
  io = qt("uploadPartBytes"),
  Ct = qt("getFile"),
  up = qt("shouldRetry"),
  $a = qt("nonMultipartUpload"),
  Gu = class {
    static {
    ...
    constructor(e, t, r, s) {
      Object.defineProperty(this, $a, {
        ...
        writable: !0,
        value: void 0
      }), ne(this, to)[to] = e, ne(this, Zs)[Zs] = r, ne(this, Ct)[Ct] = s, this.setOptions(t);
    }
    setOptions(e) {
      let t = ne(this, to)[to];
      if ("abortMultipartUpload" in e && (ne(this, Ba)[Ba] = t.wrapPromiseFunction(e.abortMultipartUpload, {
        priority: 1
      })), "createMultipartUpload" in e && (ne(this, ja)[ja] = t.wrapPromiseFunction(e.createMultipartUpload, {
        priority: -1
      })), "signPart" in e && (ne(this, za)[za] = t.wrapPromiseFunction(e.signPart)), "listParts" in e && (ne(this, Ha)[Ha] = t.wrapPromiseFunction(e.listParts)), "completeMultipartUpload" in e && (ne(this, Js)[Js] = t.wrapPromiseFunction(e.completeMultipartUpload, {
        priority: 1
      })), "retryDelays" in e) {
        var r;
        ne(this, Qs)[Qs] = (r = e.retryDelays) != null ? r : [];
      }
      "uploadPartBytes" in e && (ne(this, io)[io] = t.wrapPromiseFunction(e.uploadPartBytes, {
        priority: 1 / 0
      })), "getUploadParameters" in e && (ne(this, qa)[qa] = t.wrapPromiseFunction(e.getUploadParameters));
    }
    async getUploadId(e, t) {
      let r;
      for (; (r = ne(this, Ot)[Ot].get(e.data)) != null;) try {
        return await r;
      } catch {}
      let s = ne(this, ja)[ja](ne(this, Ct)[Ct](e), t),
        n = o(() => {
          s.abort(t.reason), ne(this, Ot)[Ot].delete(e.data);
        }, "abortPromise");
      return t.addEventListener("abort", n, {
        once: !0
      }), ne(this, Ot)[Ot].set(e.data, s), s.then(async a => {
        t.removeEventListener("abort", n), ne(this, Zs)[Zs](e, a), ne(this, Ot)[Ot].set(e.data, a);
      }, () => {
        t.removeEventListener("abort", n), ne(this, Ot)[Ot].delete(e.data);
      }), s;
    }
    async abortFileUpload(e) {
      let t = ne(this, Ot)[Ot].get(e.data);
      if (t == null) return;
      ne(this, Ot)[Ot].delete(e.data), ne(this, Zs)[Zs](e, Object.create(null));
      let r;
      try {
        r = await t;
      } catch {
      ...
      await ne(this, Ba)[Ba](ne(this, Ct)[Ct](e), r);
    }
    async uploadFile(e, t, r) {
      if (wt(r), t.length === 1 && !t[0].shouldUseMultipart) return ne(this, $a)[$a](e, t[0], r);
      let {
        uploadId: s,
        key: n
      ...
      wt(r);
      try {
        let a = await Promise.all(t.map((u, l) => this.uploadChunk(e, l + 1, u, r)));
        return wt(r), await ne(this, Js)[Js](ne(this, Ct)[Ct](e), {
          key: n,
          uploadId: s,
          parts: a,
          signal: r
        ...
        throw a?.cause !== Ia && a?.name !== "AbortError" && this.abortFileUpload(e), a;
      }
    }
    ...
    async resumeUploadFile(e, t, r) {
      if (wt(r), t.length === 1 && t[0] != null && !t[0].shouldUseMultipart) return ne(this, $a)[$a](e, t[0], r);
      let {
        uploadId: s,
        key: n
      } = await this.getUploadId(e, r);
      wt(r);
      let a = await ne(this, Ha)[Ha](ne(this, Ct)[Ct](e), {
        uploadId: s,
        key: n,
        signal: r
      }, r).abortOn(r);
      wt(r);
      let u = await Promise.all(t.map((l, h) => {
        let d = h + 1,
          p = a.find(y => {
            let {
              PartNumber: b
        ...
        return p == null ? this.uploadChunk(e, d, l, r) : (l == null || l.setAsUploaded == null || l.setAsUploaded(), {
          PartNumber: d,
          ETag: p.ETag
        });
      }));
      return wt(r), ne(this, Js)[Js](ne(this, Ct)[Ct](e), {
        key: n,
        uploadId: s,
        parts: u,
        signal: r
    ...
    async uploadChunk(e, t, r, s) {
      ...
      let {
        ...
        u = ne(this, Qs)[Qs].values(),
        l = ne(this, Qs)[Qs].values(),
        h = o(() => {
          let d = u.next();
      ...
      for (;;) {
        ...
        let d = r.getData(),
          ...
          b;
        try {
          b = await ne(this, za)[za](ne(this, Ct)[Ct](e), {
            uploadId: n,
            key: a,
            partNumber: t,
            body: d,
        ...
        try {
          ...
          if (!(await ne(this, up)[up](S, l))) throw S;
        }
      }
    }
  };
async function Y_(i, e) {
  var t;
  let r = ne(this, to)[to],
  ...
  if (s === 403 && i.message === "Request has expired") {
    if (!r.isPaused) {
      if (r.limit === 1 || ne(this, eo)[eo] == null) {
        let n = e.next();
        if (n == null || n.done) return !1;
        ne(this, eo)[eo] = n.value;
      }
      r.rateLimit(0), await new Promise(n => setTimeout(n, ne(this, eo)[eo]));
    }
  } else if (s === 429) {
    if (!r.isPaused) {
      let n = e.next();
...
o(Y_, "_shouldRetry2");
async function Q_(i, e, t) {
  let {
      method: r = "POST",
      url: s,
      fields: n,
      headers: a
    } = await ne(this, qa)[qa](ne(this, Ct)[Ct](i), {
      signal: t
    }).abortOn(t),
    u,
    l = e.getData();
  ...
  return "location" in p ? p : {
    location: X_(s),
    ...p
  };
}
o(Q_, "_nonMultipartUpload2");
var Yv;
function de(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
...
o(Ei, "_classPrivateFieldLooseKey");
var Z_ = {
  version: "3.12.0"
};
function Ko(i) {
...
var e5 = {
  ...
  so = Ei("companionCommunicationQueue"),
  et = Ei("client"),
  At = Ei("cachedTemporaryCredentials"),
  cp = Ei("getTemporarySecurityCredentials"),
  hp = Ei("setS3MultipartState"),
  oo = Ei("getFile"),
  dp = Ei("uploadLocalFile"),
  pp = Ei("getCompanionClientArgs"),
  Va = Ei("upload"),
  ro = Ei("setCompanionHeaders"),
  Dr = Ei("setResumableUploadsCapability"),
  Wa = Ei("resetResumableCapability");
Yv = Symbol.for("uppy test: getClient");
var no = class i extends Oe {
  static {
  ...
  constructor(e, t) {
    ...
    super(e, {
      ...
      value: (n, a) => {
        ...
        h != null && this.uppy.setFileState(n.id, {
          s3Multipart: {
            ...h.s3Multipart,
            key: u,
            uploadId: l
      ...
      value: async n => {
        ...
        let h = u.map(p => {
            if (p.isRemote) {
              ...
              let T = this.uppy.getRequestClientForFile(p).uploadRemoteFile(p, de(this, pp)[pp](p), {
                signal: b.signal,
                getQueue: y
              });
            ...
            return de(this, dp)[dp](p);
          }),
          d = await Promise.all(h);
        return de(this, Dr)[Dr](!0), d;
      }
    }), Object.defineProperty(this, ro, {
      writable: !0,
      value: () => {
        de(this, et)[et].setCompanionHeaders(this.opts.companionHeaders);
      }
    ...
    }), this.type = "uploader", this.id = this.opts.id || "AwsS3Multipart", this.title = "AWS S3 Multipart", de(this, et)[et] = new It(e, t);
    let s = {
    ...
    t?.prepareUploadParts != null && t.signPart == null && (this.opts.signPart = async (n, a) => {
      let {
          uploadId: u,
          key: l,
          partNumber: h,
    ...
    }), this.requests = (r = this.opts.rateLimitedQueue) != null ? r : new Jt(this.opts.limit), de(this, so)[so] = new Gu(this.requests, this.opts, de(this, hp)[hp], de(this, oo)[oo]), this.uploaders = Object.create(null), this.uploaderEvents = Object.create(null), this.uploaderSockets = Object.create(null);
  }
  [Yv]() {
    return de(this, et)[et];
  }
  setOptions(e) {
    de(this, so)[so].setOptions(e), super.setOptions(e), de(this, ro)[ro]();
  }
  ...
  createMultipartUpload(e, t) {
    ...
    return de(this, et)[et].post("s3/multipart", {
      filename: e.name,
      type: e.type,
      metadata: r
    }, {
  ...
  listParts(e, t, r) {
    ...
    return de(this, et)[et].get(`s3/multipart/${a}?key=${l}`, {
      signal: u
    }).then(Ko);
  }
  completeMultipartUpload(e, t, r) {
    ...
    (s = l) != null || (l = r), this.assertHost("completeMultipartUpload"), wt(l);
    let h = encodeURIComponent(n),
      d = encodeURIComponent(a);
    return de(this, et)[et].post(`s3/multipart/${d}/complete?key=${h}`, {
      parts: u
    }, {
      signal: l
    }).then(Ko);
  ...
  signPart(e, t) {
    ...
    if (this.assertHost("signPart"), wt(a), r == null || s == null || n == null) throw new Error("Cannot sign without a key, an uploadId, and a partNumber");
    let u = encodeURIComponent(s);
    return de(this, et)[et].get(`s3/multipart/${r}/${n}?key=${u}`, {
      signal: a
    }).then(Ko);
  }
  abortMultipartUpload(e, t, r) {
    ...
    return de(this, et)[et].delete(`s3/multipart/${h}?key=${l}`, void 0, {
      signal: u
    }).then(Ko);
  }
  getUploadParameters(e, t) {
    ...
    return de(this, et)[et].get(`s3/params?${u}`, t);
  }
  static async uploadPartBytes(e) {
    ...
    if (wt(d), t == null) throw new Error("Cannot upload to an undefined URL");
    return new Promise((p, y) => {
      let b = new XMLHttpRequest();
      b.open(n, t, !0), s && Object.keys(s).forEach(O => {
        b.setRequestHeader(O, s[O]);
      }), b.responseType = "text", typeof r == "number" && (b.timeout = r * 1e3);
      function S() {
        b.abort();
      }
      o(S, "onabort");
      ...
      o(T, "cleanup"), d?.addEventListener("abort", S), b.upload.addEventListener("progress", O => {
        l(O);
        ...
        if (T(), b.status === 403 && b.responseText.includes("<Message>Request has expired</Message>")) {
        ...
        let O = b.getAllResponseHeaders().trim().split(/[\r\n]+/),
          _ = {
            __proto__: null
          };
        for (let W of O) {
        ...
        if (n.toUpperCase() === "POST" && $ === null && console.warn("AwsS3/Multipart: Could not read the Location header. This likely means CORS is not configured correctly on the S3 Bucket. See https://uppy.io/docs/aws-s3-multipart#S3-Bucket-Configuration for instructions."), R === null) {
          y(new Error("AwsS3/Multipart: Could not read the ETag header. This likely means CORS is not configured correctly on the S3 Bucket. See https://uppy.io/docs/aws-s3-multipart#S3-Bucket-Configuration for instructions."));
          return;
        }
        h?.(R), p({
          ..._,
  ...
  install() {
    de(this, Dr)[Dr](!0), this.uppy.addPreProcessor(de(this, ro)[ro]), this.uppy.addUploader(de(this, Va)[Va]), this.uppy.on("cancel-all", de(this, Wa)[Wa]);
  }
  uninstall() {
    this.uppy.removePreProcessor(de(this, ro)[ro]), this.uppy.removeUploader(de(this, Va)[Va]), this.uppy.off("cancel-all", de(this, Wa)[Wa]);
  }
};
exports.AwsS3Multipart = no;
async function t5(i) {
  return wt(i?.signal), de(this, At)[At] == null && (this.opts.getTemporarySecurityCredentials === !0 ? (this.assertHost("getTemporarySecurityCredentials"), de(this, At)[At] = de(this, et)[et].get("s3/sts", i).then(Ko)) : de(this, At)[At] = this.opts.getTemporarySecurityCredentials(i), de(this, At)[At] = await de(this, At)[At], setTimeout(() => {
    de(this, At)[At] = null;
  }, (Qv(de(this, At)[At].credentials) || 0) * 500)), de(this, At)[At];
}
o(t5, "_getTemporarySecurityCredentials2");
function i5(i) {
  var e = this;
  return new Promise((t, r) => {
    let s = o((h, d) => {
      ...
      n = o(h => {
        this.uppy.log(h), this.uppy.emit("upload-error", i, h), this.resetUploaderReferences(i.id), r(h);
      }, "onError"),
      a = o(h => {
        let d = {
          body: {
          ...
          status: 200,
          uploadURL: h.location
        };
        this.resetUploaderReferences(i.id), this.uppy.emit("upload-success", de(this, oo)[oo](i), d), h.location && this.uppy.log(`Download ${i.name} from ${h.location}`), t();
      }, "onSuccess"),
      u = new Gv(i.data, {
        companionComm: de(this, so)[so],
        log: function () {
        ...
        onSuccess: a,
        onPartComplete: h => {
          this.uppy.emit("s3-multipart:part-uploaded", de(this, oo)[oo](i), h);
        },
        file: i,
    ...
    let l = new Tr(this.uppy);
    this.uploaderEvents[i.id] = l, l.onFileRemove(i.id, h => {
      u.abort(), this.resetUploaderReferences(i.id, {
        abort: !0
      }), t(`upload ${h} was removed`);
    }), l.onCancelAll(i.id, h => {
      h?.reason === "user" && (u.abort(), this.resetUploaderReferences(i.id, {
        abort: !0
...
o(r5, "_getCompanionClientArgs2");
no.VERSION = Z_.version;
function Ir(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
}
...
var Vt = Jv("uppy"),
  ...
  Ka = class {
    ...
    on(e, t) {
      return Ir(this, Ga)[Ga].push([e, t]), Ir(this, Vt)[Vt].on(e, t);
    }
    remove() {
      for (let [e, t] of Ir(this, Ga)[Ga].splice(0)) Ir(this, Vt)[Vt].off(e, t);
    }
    onFilePause(e, t) {
      this.on("upload-pause", (r, s) => {
        e === r && t(s);
    ...
    onCancelAll(e, t) {
      var r = this;
      this.on("cancel-all", function () {
        Ir(r, Vt)[Vt].getFile(e) && t(...arguments);
      });
    }
    onResumeAll(e, t) {
      this.on("resume-all", () => {
...
o(Oi, "_classPrivateFieldLooseBase");
var o5 = 0;
function Ku(i) {
  return "__private_" + o5++ + "_" + i;
}
o(Ku, "_classPrivateFieldLooseKey");
var Lr = Ku("aliveTimer"),
  ao = Ku("isDone"),
  Xa = Ku("onTimedOut"),
  lo = Ku("timeout"),
  fp = class {
    ...
    constructor(e, t) {
      Object.defineProperty(this, Lr, {
        ...
        writable: !0,
        value: void 0
      }), Oi(this, lo)[lo] = e, Oi(this, Xa)[Xa] = () => t(e);
    }
    progress() {
      Oi(this, ao)[ao] || Oi(this, lo)[lo] > 0 && (clearTimeout(Oi(this, Lr)[Lr]), Oi(this, Lr)[Lr] = setTimeout(Oi(this, Xa)[Xa], Oi(this, lo)[lo]));
    }
    done() {
      Oi(this, ao)[ao] || (clearTimeout(Oi(this, Lr)[Lr]), Oi(this, Lr)[Lr] = void 0, Oi(this, ao)[ao] = !0);
    }
  },
  Xu = fp;
function n5(i) {
...
var a5 = 0;
function tb(i) {
  return "__private_" + a5++ + "_" + i;
}
o(tb, "_classPrivateFieldLooseKey");
function eb(i, e) {
  if (uo(i)) return new Dt(e, i);
  let t = new pr("Upload error", {
    cause: e
  });
...
o(c5, "createFormDataUpload");
var h5 = o(i => i.data, "createBareUpload"),
  mp = tb("addEventHandlerForFile"),
  gp = tb("addEventHandlerIfFileStillExists"),
  Ya = class {
    static {
    ...
    constructor(e, t) {
      Object.defineProperty(this, gp, {
        ...
        ...t
      }, this.requests = t[ss], this.uploaderEvents = Object.create(null), this.i18n = t.i18n;
    }
    getOptions(e) {
      var t;
      let {
    ...
    uploadLocalFile(e) {
      ...
      return new Promise((r, s) => {
        let n = t.formData ? c5(e, t) : h5(e, t),
          a = new XMLHttpRequest();
        this.uploaderEvents[e.id] = new Ka(this.uppy);
        let u = new Xu(t.timeout, () => {
            a.abort(), h.done();
            let d = new Error(this.i18n("timedOut", {
              seconds: Math.ceil(t.timeout / 1e3)
            }));
        ...
        a.upload.addEventListener("loadstart", () => {
          ...
          this.uppy.log(`[AwsS3/XHRUpload] ${l} progress: ${d.loaded} / ${d.total}`), u.progress(), d.lengthComputable && this.uppy.emit("upload-progress", this.uppy.getFile(e.id), {
            uploader: this,
            bytesUploaded: d.loaded,
            bytesTotal: d.total
          });
        }), a.addEventListener("load", d => {
          if (this.uppy.log(`[AwsS3/XHRUpload] ${l} finished`), u.done(), h.done(), this.uploaderEvents[e.id] && (this.uploaderEvents[e.id].remove(), this.uploaderEvents[e.id] = null), t.validateStatus(d.target.status, a.responseText, a)) {
            ...
            return this.uppy.emit("upload-success", this.uppy.getFile(e.id), O), T && this.uppy.log(`Download ${e.name} from ${T}`), r(e);
          }
          let p = t.getResponseData(a.responseText, a),
          ...
          this.uppy.log(`[AwsS3/XHRUpload] ${l} errored`), u.done(), h.done(), this.uploaderEvents[e.id] && (this.uploaderEvents[e.id].remove(), this.uploaderEvents[e.id] = null);
          let d = eb(a, t.getResponseError(a.responseText, a));
          return this.uppy.emit("upload-error", e, d), s(d);
        }), a.open(t.method.toUpperCase(), t.endpoint, !0), a.withCredentials = !!t.withCredentials, t.responseType !== "" && (a.responseType = t.responseType), Object.keys(t.headers).forEach(d => {
          a.setRequestHeader(d, t.headers[d]);
        });
        let h = this.requests.run(() => (a.send(n), () => {
          u.done(), a.abort();
        }), {
          priority: 1
        });
        Zv(this, mp)[mp]("file-removed", e.id, () => {
          h.abort(), s(new Error("File removed"));
        }), Zv(this, gp)[gp]("cancel-all", e.id, function (d) {
          let {
            reason: p
          } = d === void 0 ? {} : d;
          p === "user" && h.abort(), s(new Error("Upload cancelled"));
        });
      });
    }
  };
...
o(p5, "_addEventHandlerIfFileStillExists2");
function f5(i) {
  return i.replace(/;.*$/, "");
}
o(f5, "removeMimeParameters");
function m5(i, e) {
  let t = e.headers ? e.headers["content-type"] : e.getResponseHeader("Content-Type");
  if (typeof t == "string") {
    let r = f5(t).toLowerCase();
...
o(S5, "defaultGetResponseError");
var rb = !1,
  gi = Xo("client"),
  Bi = Xo("requests"),
  co = Xo("uploader"),
  Qa = Xo("handleUpload"),
  Ja = Xo("setCompanionHeaders"),
  vp = Xo("getCompanionClientArgs");
sb = Symbol.for("uppy test: getClient");
var el = class extends Oe {
  static {
    o(this, "AwsS3");
  }
  constructor(e, t) {
    if (t?.shouldUseMultipart != null) return new no(e, t);
    super(e, t), Object.defineProperty(this, gi, {
      writable: !0,
      value: void 0
      ...
      value: async s => {
        ...
        let d = ft(this, Bi)[Bi].wrapPromiseFunction(y => this.opts.getUploadParameters(y)),
          p = s.length;
        return Promise.allSettled(s.map((y, b) => (n[y] = d(this.uppy.getFile(y)), n[y].then(S => {
          delete n[y];
          ...
          return $ && (W.headers = $), this.uppy.setFileState(T.id, {
            meta: {
              ...T.meta,
              ...R
            },
            xhrUpload: W
          }), this.uploadFile(T.id, b, p);
        }).catch(S => {
          delete n[y];
          let T = this.uppy.getFile(y);
          return this.uppy.emit("upload-error", T, S), Promise.reject(S);
        })))).finally(() => {
      ...
      writable: !0,
      value: () => (ft(this, gi)[gi].setCompanionHeaders(this.opts.companionHeaders), Promise.resolve())
    }), Object.defineProperty(this, vp, {
      writable: !0,
      value: s => {
        let n = ft(this, co)[co].getOptions(s),
          a = Array.isArray(n.allowedMetaFields) ? n.allowedMetaFields : Object.keys(s.meta);
        return {
          ...s.remote.body,
          protocol: "multipart",
          endpoint: n.endpoint,
    ...
    }), this.type = "uploader", this.id = this.opts.id || "AwsS3", this.title = "AWS S3", this.defaultLocale = ib;
    let r = {
      timeout: 30 * 1e3,
      limit: 0,
      allowedMetaFields: [],
    ...
    this.i18nInit(), ft(this, gi)[gi] = new It(e, t), ft(this, Bi)[Bi] = new Jt(this.opts.limit);
  }
  [sb]() {
  ...
  getUploadParameters(e) {
    ...
    return ft(this, gi)[gi].get(`s3/params?${n}`).then(b5);
  }
  uploadFile(e, t, r) {
    let s = this.uppy.getFile(e);
    if (this.uppy.log(`uploading ${t} of ${r}`), s.error) throw new Error(s.error);
    if (s.isRemote) {
      ...
      let l = this.uppy.getRequestClientForFile(s).uploadRemoteFile(s, ft(this, vp)[vp](s), {
        signal: a.signal,
        getQueue: n
      });
      return ft(this, Bi)[Bi].wrapSyncFunction(() => {
        this.uppy.off("file-removed", u);
      }, {
        priority: -1
      })(), l;
    }
    return ft(this, co)[co].uploadLocalFile(s, t, r);
  }
  install() {
    let {
      uppy: e
    } = this;
    e.addPreProcessor(ft(this, Ja)[Ja]), e.addUploader(ft(this, Qa)[Qa]);
    function t(s, n) {
      let a = this;
      return yp(s, n) ? {
        location: v5(n.responseURL, Za(s, "Location")),
        bucket: Za(s, "Bucket"),
        key: Za(s, "Key"),
        etag: Za(s, "ETag")
      } : a.method.toUpperCase() === "POST" ? (rb || (e.log("[AwsS3] No response data found, make sure to set the success_action_status AWS SDK option to 201. See https://uppy.io/docs/aws-s3/#POST-Uploads", "warning"), rb = !0), {
        location: null
      }) : n.responseURL ? {
    ...
    r.i18n = this.i18n, ft(this, co)[co] = new Ya(e, r);
  }
  uninstall() {
    this.uppy.removePreProcessor(ft(this, Ja)[Ja]), this.uppy.removeUploader(ft(this, Qa)[Qa]);
  }
};
exports.AwsS3 = el;
el.VERSION = y5.version;
var cb = "3.7.2",
  P5 = cb,
  _5 = typeof atob == "function",
  x5 = typeof btoa == "function",
  ...
  F5 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
  tl = Array.prototype.slice.call(F5),
  Yu = (i => {
    let e = {};
    return i.forEach((t, r) => e[t] = r), e;
  })(tl),
  E5 = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,
  Tt = String.fromCharCode.bind(String),
  ab = typeof Uint8Array.from == "function" ? Uint8Array.from.bind(Uint8Array) : (i, e = t => t) => new Uint8Array(Array.prototype.slice.call(i, 0).map(e)),
  hb = o(i => i.replace(/=/g, "").replace(/[+\/]/g, e => e == "+" ? "-" : "_"), "_mkUriSafe"),
  ...
  pb = o(i => {
    ...
    for (let u = 0; u < i.length;) {
      if ((t = i.charCodeAt(u++)) > 255 || (r = i.charCodeAt(u++)) > 255 || (s = i.charCodeAt(u++)) > 255) throw new TypeError("invalid character found");
      e = t << 16 | r << 8 | s, n += tl[e >> 18 & 63] + tl[e >> 12 & 63] + tl[e >> 6 & 63] + tl[e & 63];
    }
    return a ? n.slice(0, a - 3) + "===".substring(a) : n;
  }, "btoaPolyfill"),
  Sp = x5 ? i => btoa(i) : Qo ? i => Buffer.from(i, "binary").toString("base64") : pb,
  bp = Qo ? i => Buffer.from(i).toString("base64") : i => {
    let t = [];
    for (let r = 0, s = i.length; r < s; r += 4096) t.push(Tt.apply(null, i.subarray(r, r + 4096)));
    return Sp(t.join(""));
  },
  Qu = o((i, e = !1) => e ? hb(bp(i)) : bp(i), "fromUint8Array"),
  O5 = o(i => {
    if (i.length < 2) {
      var e = i.charCodeAt(0);
      return e < 128 ? i : e < 2048 ? Tt(192 | e >>> 6) + Tt(128 | e & 63) : Tt(224 | e >>> 12 & 15) + Tt(128 | e >>> 6 & 63) + Tt(128 | e & 63);
    } else {
      var e = 65536 + (i.charCodeAt(0) - 55296) * 1024 + (i.charCodeAt(1) - 56320);
      return Tt(240 | e >>> 18 & 7) + Tt(128 | e >>> 12 & 63) + Tt(128 | e >>> 6 & 63) + Tt(128 | e & 63);
    }
  }, "cb_utob"),
  C5 = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,
  fb = o(i => i.replace(C5, O5), "utob"),
  lb = Qo ? i => Buffer.from(i, "utf8").toString("base64") : nb ? i => bp(nb.encode(i)) : i => Sp(fb(i)),
  Yo = o((i, e = !1) => e ? hb(lb(i)) : lb(i), "encode"),
  ub = o(i => Yo(i, !0), "encodeURI"),
  A5 = /[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,
  T5 = o(i => {
    switch (i.length) {
      case 4:
      ...
      case 3:
        return Tt((15 & i.charCodeAt(0)) << 12 | (63 & i.charCodeAt(1)) << 6 | 63 & i.charCodeAt(2));
      default:
        return Tt((31 & i.charCodeAt(0)) << 6 | 63 & i.charCodeAt(1));
    }
  }, "cb_btou"),
  mb = o(i => i.replace(A5, T5), "btou"),
  gb = o(i => {
    if (i = i.replace(/\s+/g, ""), !E5.test(i)) throw new TypeError("malformed base64.");
    i += "==".slice(2 - (i.length & 3));
    let e,
      t = "",
      r,
      s;
    for (let n = 0; n < i.length;) e = Yu[i.charAt(n++)] << 18 | Yu[i.charAt(n++)] << 12 | (r = Yu[i.charAt(n++)]) << 6 | (s = Yu[i.charAt(n++)]), t += r === 64 ? Tt(e >> 16 & 255) : s === 64 ? Tt(e >> 16 & 255, e >> 8 & 255) : Tt(e >> 16 & 255, e >> 8 & 255, e & 255);
    return t;
  }, "atobPolyfill"),
  Pp = _5 ? i => atob(db(i)) : Qo ? i => Buffer.from(i, "base64").toString("binary") : gb,
  yb = Qo ? i => ab(Buffer.from(i, "base64")) : i => ab(Pp(i), e => e.charCodeAt(0)),
  vb = o(i => yb(bb(i)), "toUint8Array"),
  R5 = Qo ? i => Buffer.from(i, "base64").toString("utf8") : ob ? i => ob.decode(yb(i)) : i => mb(Pp(i)),
  bb = o(i => db(i.replace(/[-_]/g, e => e == "-" ? "+" : "/")), "_unURI"),
  wp = o(i => R5(bb(i)), "decode"),
  k5 = o(i => {
  ...
  Sb = o(function () {
    let i = o((e, t) => Object.defineProperty(String.prototype, e, wb(t)), "_add");
  ...
  Pb = o(function () {
    let i = o((e, t) => Object.defineProperty(Uint8Array.prototype, e, wb(t)), "_add");
    i("toBase64", function (e) {
      return Qu(this, e);
    }), i("toBase64URI", function () {
      return Qu(this, !0);
...
function Nb(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, W5(r.key), r);
  }
}
o(Nb, "_defineProperties");
function V5(i, e, t) {
  return e && Nb(i.prototype, e), t && Nb(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(V5, "_createClass");
...
o(W5, "_toPropertyKey");
function G5(i, e) {
  if (Jo(i) !== "object" || i === null) return i;
...
o(Y5, "_createSuper");
function Q5(i, e) {
  if (e && (Jo(e) === "object" || typeof e == "function")) return e;
  if (e !== void 0) throw new TypeError("Derived constructors may only return object or undefined");
  return J5(i);
}
o(Q5, "_possibleConstructorReturn");
function J5(i) {
  if (i === void 0) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  return i;
}
o(J5, "_assertThisInitialized");
function Ep(i) {
  var e = typeof Map == "function" ? new Map() : void 0;
  return Ep = o(function (r) {
    if (r === null || !Z5(r)) return r;
    ...
    function s() {
      return Zu(r, arguments, rl(this).constructor);
    }
  ...
  }, "_wrapNativeSuper"), Ep(i);
}
o(Ep, "_wrapNativeSuper");
function Zu(i, e, t) {
  return Mb() ? Zu = Reflect.construct.bind() : Zu = o(function (s, n, a) {
    var u = [null];
    u.push.apply(u, n);
    var l = Function.bind.apply(s, u),
      h = new l();
    return a && il(h, a.prototype), h;
  }, "_construct"), Zu.apply(null, arguments);
}
o(Zu, "_construct");
function Mb() {
...
o(Z5, "_isNativeFunction");
function il(i, e) {
  return il = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : o(function (r, s) {
    return r.__proto__ = s, r;
  }, "_setPrototypeOf"), il(i, e);
}
o(il, "_setPrototypeOf");
function rl(i) {
  return rl = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : o(function (t) {
    return t.__proto__ || Object.getPrototypeOf(t);
  }, "_getPrototypeOf"), rl(i);
}
o(rl, "_getPrototypeOf");
var ex = function (i) {
    X5(t, i);
    var e = Y5(t);
    function t(r) {
      var s,
        ...
        u = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null;
      if (K5(this, t), s = e.call(this, r), s.originalRequest = a, s.originalResponse = u, s.causingError = n, n != null && (r += ", caused by ".concat(n.toString())), a != null) {
        var l = a.getHeader("X-Request-ID") || "n/a",
          h = a.getMethod(),
          d = a.getURL(),
          p = u ? u.getStatus() : "n/a",
          y = u ? u.getBody() || "" : "n/a";
        r += ", originated from request (method: ".concat(h, ", url: ").concat(d, ", response code: ").concat(p, ", response text: ").concat(y, ", request id: ").concat(l, ")");
      }
      return s.message = r, s;
    }
    return o(t, "DetailedError"), V5(t);
  }(Ep(Error)),
  Zo = ex;
var tx = !1;
function as(i) {
...
function Cp() {
  ...
  var i,
    ...
    t = Object.prototype,
    r = t.hasOwnProperty,
    s = Object.defineProperty || function (C, P, E) {
      C[P] = E.value;
    },
  ...
  function d(C, P, E, L) {
    var z = P && P.prototype instanceof _ ? P : _,
  ...
  var G = $.prototype = _.prototype = Object.create(W);
  function te(C) {
  ...
  function re(C, P) {
    function E(z, B, D, A) {
      ...
      if (k.type !== "throw") {
        var N = k.arg,
          Y = N.value;
        return Y && ho(Y) == "object" && r.call(Y, "__await") ? P.resolve(Y.__await).then(function (Q) {
          E("next", Q, D, A);
        }, function (Q) {
          E("throw", Q, D, A);
        }) : P.resolve(Y).then(function (Q) {
          N.value = Q, D(N);
        }, function (Q) {
    ...
    s(this, "_invoke", {
      value: o(function (B, D) {
        function A() {
          return new P(function (k, N) {
            E(B, D, k, N);
          });
        }
        return o(A, "callInvokeWithMethodAndArg"), L = L ? L.then(A, A) : A();
      }, "value")
    });
  }
  o(re, "AsyncIterator");
  function Ee(C, P, E) {
    ...
    return function (z, B) {
      ...
      for (E.method = z, E.arg = B;;) {
        ...
        if (E.method === "next") E.sent = E._sent = E.arg;else if (E.method === "throw") {
        ...
        k.type === "throw" && (L = T, E.method = "throw", E.arg = k.arg);
      }
    };
  }
  o(Ee, "makeInvokeMethod");
  function Re(C, P) {
    var E = P.method,
      L = C.iterator[E];
    if (L === i) return P.delegate = null, E === "throw" && C.iterator.return && (P.method = "return", P.arg = i, Re(C, P), P.method === "throw") || E !== "return" && (P.method = "throw", P.arg = new TypeError("The iterator does not provide a '" + E + "' method")), O;
    var z = p(L, C.iterator, P.arg);
    if (z.type === "throw") return P.method = "throw", P.arg = z.arg, P.delegate = null, O;
    var B = z.arg;
    return B ? B.done ? (P[C.resultName] = B.value, P.next = C.nextLoc, P.method !== "return" && (P.method = "next", P.arg = i), P.delegate = null, O) : B : (P.method = "throw", P.arg = new TypeError("iterator result is not an object"), P.delegate = null, O);
  }
  ...
  function Le(C) {
    if (C || C === "") {
      ...
      if (!isNaN(C.length)) {
        var E = -1,
          L = o(function z() {
            for (; ++E < C.length;) if (r.call(C, E)) return z.value = C[E], z.done = !1, z;
            return z.value = i, z.done = !0, z;
          }, "next");
        return L.next = L;
      }
    }
    throw new TypeError(ho(C) + " is not iterable");
  }
  return o(Le, "values"), R.prototype = $, s(G, "constructor", {
    value: $,
    configurable: !0
  }), s($, "constructor", {
    value: R,
    configurable: !0
  }), R.displayName = h($, l, "GeneratorFunction"), e.isGeneratorFunction = function (C) {
    var P = typeof C == "function" && C.constructor;
    return !!P && (P === R || (P.displayName || P.name) === "GeneratorFunction");
  }, e.mark = function (C) {
    return Object.setPrototypeOf ? Object.setPrototypeOf(C, $) : (C.__proto__ = $, h(C, l, "GeneratorFunction")), C.prototype = Object.create(G), C;
  }, e.awrap = function (C) {
    return {
      __await: C
    };
  }, te(re.prototype), h(re.prototype, u, function () {
    return this;
  }), e.AsyncIterator = re, e.async = function (C, P, E, L, z) {
    z === void 0 && (z = Promise);
    var B = new re(d(C, P, E, L), z);
    return e.isGeneratorFunction(P) ? B : B.next().then(function (D) {
      return D.done ? D.value : B.next();
    });
  }, te(G), h(G, l, "Generator"), h(G, a, function () {
    return this;
    ...
    return E.reverse(), o(function z() {
      for (; E.length;) {
        var B = E.pop();
        if (B in P) return z.value = B, z.done = !1, z;
      }
      return z.done = !0, z;
    }, "next");
  }, e.values = Le, Pe.prototype = {
    constructor: Pe,
    reset: o(function (P) {
      if (this.prev = 0, this.next = 0, this.sent = this._sent = i, this.done = !1, this.delegate = null, this.method = "next", this.arg = i, this.tryEntries.forEach(we), !P) for (var E in this) E.charAt(0) === "t" && r.call(this, E) && !isNaN(+E.slice(1)) && (this[E] = i);
    }, "reset"),
    stop: o(function () {
      this.done = !0;
    ...
    dispatchException: o(function (P) {
      ...
      var E = this;
      function L(N, Y) {
        return D.type = "throw", D.arg = P, E.next = N, Y && (E.method = "next", E.arg = i), !!Y;
      }
      o(L, "handle");
    ...
    abrupt: o(function (P, E) {
      ...
      B && (P === "break" || P === "continue") && B.tryLoc <= E && E <= B.finallyLoc && (B = null);
      var D = B ? B.completion : {};
      return D.type = P, D.arg = E, B ? (this.method = "next", this.next = B.finallyLoc, O) : this.complete(D);
    }, "abrupt"),
    complete: o(function (P, E) {
      if (P.type === "throw") throw P.arg;
      return P.type === "break" || P.type === "continue" ? this.next = P.arg : P.type === "return" ? (this.rval = this.arg = P.arg, this.method = "return", this.next = "end") : P.type === "normal" && E && (this.next = E), O;
    }, "complete"),
    finish: o(function (P) {
      for (var E = this.tryEntries.length - 1; E >= 0; --E) {
        var L = this.tryEntries[E];
        if (L.finallyLoc === P) return this.complete(L.completion, L.afterLoc), we(L), O;
      }
    }, "finish"),
    catch: o(function (P) {
      for (var E = this.tryEntries.length - 1; E >= 0; --E) {
    ...
    delegateYield: o(function (P, E, L) {
      return this.delegate = {
        ...
        resultName: E,
        nextLoc: L
      }, this.method === "next" && (this.arg = i), O;
    }, "delegateYield")
  }, e;
}
o(Cp, "_regeneratorRuntime");
  ...
  if (t != null) {
    ...
    try {
      if (n = (t = t.call(i)).next, e === 0) {
        ...
        l = !1;
      } else for (; !(l = (r = n.call(t)).done) && (u.push(r.value), u.length !== e); l = !0);
    } catch (d) {
      h = !0, s = d;
    } finally {
      try {
...
o(ox, "_iterableToArrayLimit");
function nx(i) {
  if (Array.isArray(i)) return i;
}
o(nx, "_arrayWithHoles");
function ho(i) {
  "@babel/helpers - typeof";
...
function en(i) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? zb(Object(t), !0).forEach(function (r) {
      ax(i, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(t)) : zb(Object(t)).forEach(function (r) {
...
o(en, "_objectSpread");
function ax(i, e, t) {
  return e = Xb(e), e in i ? Object.defineProperty(i, e, {
    value: t,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function Hb(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, Xb(r.key), r);
  }
}
o(Hb, "_defineProperties");
function ux(i, e, t) {
  return e && Hb(i.prototype, e), t && Hb(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(ux, "_createClass");
...
o(Xb, "_toPropertyKey");
function cx(i, e) {
  if (ho(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
  ...
  Qb = function () {
    ...
    return o(i, "BaseUpload"), ux(i, [{
      ...
      value: o(function () {
        ...
        if (this.options.parallelUploads > 1) for (var n = 0, a = ["uploadUrl", "uploadSize", "uploadLengthDeferred"]; n < a.length; n++) {
          var u = a[n];
          if (this.options[u]) {
        ...
        this.options.fingerprint(r, this.options).then(function (l) {
          return l == null ? as("No fingerprint was calculated meaning that the upload cannot be stored in the URL storage.") : as("Calculated fingerprint: ".concat(l)), t._fingerprint = l, t._source ? t._source : t.options.fileReader.openFile(r, t.options.chunkSize);
        }).then(function (l) {
          if (t._source = l, t.options.uploadLengthDeferred) t._size = null;else if (t.options.uploadSize != null) {
      ...
      value: o(function () {
        ...
        var a = this._parallelUploadUrls != null ? this._parallelUploadUrls.length : this.options.parallelUploads,
          u = (t = this.options.parallelUploadBoundaries) !== null && t !== void 0 ? t : px(this._source.size, a);
        this._parallelUploadUrls && u.forEach(function (d, p) {
          d.uploadUrl = r._parallelUploadUrls[p] || null;
        }), this._parallelUploadUrls = new Array(u.length);
        var l = u.map(function (d, p) {
            var y = 0;
            return r._source.slice(d.start, d.end).then(function (b) {
              var S = b.value;
              return new Promise(function (T, O) {
                var _ = en(en({}, r.options), {}, {
                    ...
                    parallelUploadBoundaries: null,
                    metadata: {},
                    headers: en(en({}, r.options.headers), {}, {
                    ...
                    onUploadUrlAvailable: o(function () {
                      r._parallelUploadUrls[p] = R.url, r._parallelUploadUrls.filter(function (W) {
                        return !!W;
                      }).length === u.length && r._saveUploadInUrlStorage();
        ...
        Promise.all(l).then(function () {
          h = r._openRequest("POST", r.options.endpoint), h.setHeader("Upload-Concat", "final;".concat(r._parallelUploadUrls.join(" ")));
          var d = $b(r.options.metadata);
          return d !== "" && h.setHeader("Upload-Metadata", d), r._sendRequest(h, null);
        }).then(function (d) {
          if (!tn(d.getStatus(), 200)) {
            r._emitHttpError(h, d, "tus: unexpected response while creating upload");
            return;
          }
          var p = d.getHeader("Location");
          if (p == null) {
            r._emitHttpError(h, d, "tus: invalid or missing Location header");
            return;
          }
          r.url = Gb(r.options.endpoint, p), as("Created upload at ".concat(r.url)), r._emitSuccess();
        }).catch(function (d) {
          r._emitError(d);
        });
      ...
      value: o(function () {
        if (this._aborted = !1, this.url != null) {
          as("Resuming upload from previous URL: ".concat(this.url)), this._resumeUpload();
          return;
        }
        if (this.options.uploadUrl != null) {
          as("Resuming upload from provided URL: ".concat(this.options.uploadUrl)), this.url = this.options.uploadUrl, this._resumeUpload();
          return;
        }
        as("Creating a new upload"), this._createUpload();
      }, "_startSingleUpload")
    }, {
      key: "abort",
      value: o(function (t) {
      ...
      value: o(function (t, r, s, n) {
        this._emitError(new Zo(s, n, t, r));
      }, "_emitHttpError")
    }, {
      key: "_emitError",
      value: o(function (t) {
        ...
        if (!this._aborted) {
          if (this.options.retryDelays != null) {
            ...
            if (s && (this._retryAttempt = 0), Wb(t, this._retryAttempt, this.options)) {
          ...
          if (typeof this.options.onError == "function") this.options.onError(t);else throw t;
        }
      }, "_emitError")
    }, {
      key: "_emitSuccess",
      ...
      value: o(function () {
        ...
        var n;
        this.options.uploadDataDuringCreation && !this.options.uploadLengthDeferred ? (this._offset = 0, n = this._addChunkToRequest(r)) : n = this._sendRequest(r, null), n.then(function (a) {
          if (!tn(a.getStatus(), 200)) {
          ...
          if (t.url = Gb(t.options.endpoint, u), as("Created upload at ".concat(t.url)), typeof t.options.onUploadUrlAvailable == "function" && t.options.onUploadUrlAvailable(), t._size === 0) {
      ...
      value: o(function () {
        ...
        s.then(function (n) {
          ...
          if (!tn(a, 200)) {
            ...
            if (tn(a, 400) && t._removeFromUrlStorage(), !t.options.endpoint) {
      ...
      value: o(function (t) {
        ...
        return t.setProgressHandler(function (a) {
          ...
          var u = a.value,
            l = a.done,
            h = u && u.size ? u.size : 0;
          r.options.uploadLengthDeferred && l && (r._size = r._offset + h, t.setHeader("Upload-Length", r._size));
          var d = r._offset + h;
          return !r.options.uploadLengthDeferred && l && d !== r._size ? Promise.reject(new Error("upload was configured with a size of ".concat(r._size, " bytes, but the source is done after ").concat(d, " bytes"))) : u === null ? r._sendRequest(t) : (r._emitProgress(r._offset, r._size), r._sendRequest(t, u));
        });
      }, "_addChunkToRequest")
    }, {
      ...
      value: o(function (t) {
        var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
          s = qb("DELETE", t, r);
        return Vb(s, null, r).then(function (n) {
          if (n.getStatus() !== 204) throw new Zo("tus: unexpected response while terminating upload", null, s, n);
        }).catch(function (n) {
          if (n instanceof Zo || (n = new Zo("tus: failed to terminate upload", n, s, null)), !Wb(n, 0, r)) throw n;
...
function $b(i) {
  return Object.entries(i).map(function (e) {
    var t = Kb(e, 2),
      r = t[0],
      s = t[1];
    return "".concat(r, " ").concat(_b.encode(String(s)));
  }).join(",");
}
o($b, "encodeMetadata");
function tn(i, e) {
...
o(Vb, "sendRequest");
function Ap() {
  return Ap = ix(Cp().mark(o(function i(e, t, r) {
    var s;
    return Cp().wrap(o(function (a) {
  ...
  }, "_callee"))), Ap.apply(this, arguments);
}
o(Ap, "_sendRequest2");
function dx() {
  var i = !0;
...
o(dx, "isOnline");
function Wb(i, e, t) {
  return t.retryDelays == null || e >= t.retryDelays.length || i.originalRequest == null ? !1 : t && typeof t.onShouldRetry == "function" ? t.onShouldRetry(i, e, t) : Jb(i);
}
o(Wb, "shouldRetry");
function Jb(i) {
  var e = i.originalResponse ? i.originalResponse.getStatus() : 0;
  return (!tn(e, 400) || e === 409 || e === 423) && dx();
}
...
o(px, "splitSizeIntoParts");
Qb.defaultOptions = hx;
var ec = Qb;
function sl(i) {
  "@babel/helpers - typeof";
...
o(fx, "_classCallCheck");
function Zb(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, gx(r.key), r);
  }
}
o(Zb, "_defineProperties");
function mx(i, e, t) {
  return e && Zb(i.prototype, e), t && Zb(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(mx, "_createClass");
...
o(gx, "_toPropertyKey");
function yx(i, e) {
  if (sl(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
var e0 = function () {
  ...
  return o(i, "NoopUrlStorage"), mx(i, [{
    key: "listAllUploads",
    value: o(function () {
...
o(vx, "_classCallCheck");
function t0(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, wx(r.key), r);
  }
}
o(t0, "_defineProperties");
function bx(i, e, t) {
  return e && t0(i.prototype, e), t && t0(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(bx, "_createClass");
function wx(i) {
  var e = Sx(i, "string");
  return ol(e) === "symbol" ? e : String(e);
}
o(wx, "_toPropertyKey");
function Sx(i, e) {
  if (ol(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
var Rp = !1;
try {
  Rp = "localStorage" in window, tc = "tusSupport", Tp = localStorage.getItem(tc), localStorage.setItem(tc, Tp), Tp === null && localStorage.removeItem(tc);
} catch (i) {
  if (i.code === i.SECURITY_ERR || i.code === i.QUOTA_EXCEEDED_ERR) Rp = !1;else throw i;
}
var tc,
  Tp,
  i0 = Rp,
  r0 = function () {
    ...
    return o(i, "WebStorageUrlStorage"), bx(i, [{
      key: "findAllUploads",
      value: o(function () {
...
o(kp, "_classCallCheck");
function s0(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, Px(r.key), r);
  }
}
o(s0, "_defineProperties");
function Up(i, e, t) {
  return e && s0(i.prototype, e), t && s0(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(Up, "_createClass");
...
o(Px, "_toPropertyKey");
function _x(i, e) {
  if (nl(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
var xx = function () {
    function i(e, t) {
      kp(this, i), this._xhr = new XMLHttpRequest(), this._xhr.open(e, t, !0), this._method = e, this._url = t, this._headers = {};
    }
    return o(i, "Request"), Up(i, [{
      key: "getMethod",
      value: o(function () {
        return this._method;
      }, "getMethod")
  ...
  Fx = function () {
    function i(e) {
      kp(this, i), this._xhr = e;
    }
    return o(i, "Response"), Up(i, [{
      key: "getStatus",
      value: o(function () {
...
function Ax(i, e, t) {
  return e && a0(i.prototype, e), t && a0(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(Ax, "_createClass");
...
o(Tx, "_toPropertyKey");
function Rx(i, e) {
  if (al(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
var Lp = function () {
  function i(e) {
    Cx(this, i), this._file = e, this.size = e.size;
  }
  return o(i, "FileSource"), Ax(i, [{
    key: "slice",
    value: o(function (t, r) {
      if (n0()) return Ip(this._file.slice(t, r));
...
function Ux(i, e, t) {
  return e && l0(i.prototype, e), t && l0(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(Ux, "_createClass");
...
o(Dx, "_toPropertyKey");
function Ix(i, e) {
  if (ll(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
var c0 = function () {
  function i(e) {
    kx(this, i), this._buffer = void 0, this._bufferOffset = 0, this._reader = e, this._done = !1;
  }
  return o(i, "StreamSource"), Ux(i, [{
    key: "slice",
    value: o(function (t, r) {
    ...
    value: o(function (t, r) {
      ...
      return this._reader.read().then(function (l) {
        var h = l.value,
          d = l.done;
        return d ? s._done = !0 : s._buffer === void 0 ? s._buffer = h : s._buffer = Lx(s._buffer, h), s._readUntilEnoughDataOrDone(t, r);
      });
  ...
  function re(C, P) {
    function E(z, B, D, A) {
      ...
      if (k.type !== "throw") {
        var N = k.arg,
          Y = N.value;
        return Y && po(Y) == "object" && r.call(Y, "__await") ? P.resolve(Y.__await).then(function (Q) {
          E("next", Q, D, A);
        }, function (Q) {
          E("throw", Q, D, A);
        }) : P.resolve(Y).then(function (Q) {
...
o(Nx, "_asyncToGenerator");
function Mx(i, e) {
  if (!(i instanceof e)) throw new TypeError("Cannot call a class as a function");
}
o(Mx, "_classCallCheck");
function d0(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, jx(r.key), r);
  }
}
...
function jx(i) {
  var e = zx(i, "string");
  return po(e) === "symbol" ? e : String(e);
}
o(jx, "_toPropertyKey");
function zx(i, e) {
  if (po(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
var p0 = function () {
  ...
  return o(i, "FileReader"), Bx(i, [{
    key: "openFile",
    value: function () {
      var e = Nx(Np().mark(o(function r(s, n) {
        var a;
        return Np().wrap(o(function (l) {
          for (;;) switch (l.prev = l.next) {
            case 0:
              if (!(ic() && s && typeof s.uri < "u")) {
                l.next = 11;
                break;
              }
              return l.prev = 1, l.next = 4, Dp(s.uri);
            case 4:
              return a = l.sent, l.abrupt("return", new Lp(a));
            case 8:
            ...
            case 11:
              ...
              return l.abrupt("return", Promise.resolve(new Lp(s)));
            case 13:
            ...
            case 17:
              return l.abrupt("return", Promise.resolve(new c0(s, n)));
            case 18:
...
function Mp(i, e) {
  return ic() ? Promise.resolve(Hx(i, e)) : Promise.resolve(["tus-br", i.name, i.type, i.size, i.lastModified, e.endpoint].join("-"));
}
o(Mp, "fingerprint");
function Hx(i, e) {
  var t = i.exif ? $x(JSON.stringify(i.exif)) : "noexif";
  return ["tus-rn", i.name || "noname", i.size || "nosize", t, e.endpoint].join("/");
}
o(Hx, "reactNativeFingerprint");
function $x(i) {
  var e = 0;
...
o(qx, "_classCallCheck");
function f0(i, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(i, y0(r.key), r);
  }
}
o(f0, "_defineProperties");
function Vx(i, e, t) {
  return e && f0(i.prototype, e), t && f0(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
o(Vx, "_createClass");
...
o(Kx, "_possibleConstructorReturn");
function Xx(i) {
  if (i === void 0) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  return i;
}
o(Xx, "_assertThisInitialized");
function Yx() {
  if (typeof Reflect > "u" || !Reflect.construct || Reflect.construct.sham) return !1;
  if (typeof Proxy == "function") return !0;
  try {
...
o(Yx, "_isNativeReflectConstruct");
function rc(i) {
  return rc = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : o(function (t) {
    return t.__proto__ || Object.getPrototypeOf(t);
  }, "_getPrototypeOf"), rc(i);
}
o(rc, "_getPrototypeOf");
function m0(i, e) {
  var t = Object.keys(i);
  if (Object.getOwnPropertySymbols) {
    var r = Object.getOwnPropertySymbols(i);
...
function rn(i) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? m0(Object(t), !0).forEach(function (r) {
      Qx(i, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(t)) : m0(Object(t)).forEach(function (r) {
      Object.defineProperty(i, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return i;
...
o(rn, "_objectSpread");
function Qx(i, e, t) {
  return e = y0(e), e in i ? Object.defineProperty(i, e, {
    value: t,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
o(y0, "_toPropertyKey");
function Jx(i, e) {
  if (sn(i) !== "object" || i === null) return i;
  var t = i[Symbol.toPrimitive];
  if (t !== void 0) {
    var r = t.call(i, e || "default");
...
o(Jx, "_toPrimitive");
var sc = rn(rn({}, ec.defaultOptions), {}, {
    httpStack: new o0(),
    fileReader: new p0(),
  ...
  v0 = function (i) {
    ...
    function t() {
      ...
      return qx(this, t), s = rn(rn({}, sc), s), e.call(this, r, s);
    }
    return o(t, "Upload"), Vx(t, null, [{
      key: "terminate",
      value: o(function (s) {
        var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        return n = rn(rn({}, sc), n), ec.terminate(s, n);
      }, "terminate")
    }]), t;
  }(ec),
  b0 = window,
  Zx = b0.XMLHttpRequest,
  g0 = b0.Blob,
  lN = Zx && g0 && typeof g0.prototype.slice == "function";
function eF() {
  return typeof window < "u" && (typeof window.PhoneGap < "u" || typeof window.Cordova < "u" || typeof window.cordova < "u");
}
o(eF, "isCordova");
...
function jp(i) {
  return (e, t) => {
    if (eF() || tF()) return sc.fingerprint(e, t);
...
o(fo, "_classPrivateFieldLooseBase");
var iF = 0;
function hl(i) {
...
var rF = {
  ...
  sF = {
    limit: 20,
    retryDelays: S0.retryDelays,
    withCredentials: !1
  },
  cl = hl("retryDelayIterator"),
  Hp = hl("uploadLocalFile"),
  $p = hl("getCompanionClientArgs"),
  zp = hl("uploadFiles"),
  ul = hl("handleUpload"),
  ls = class extends Oe {
    static {
    ...
    constructor(e, t) {
      ...
      this.requests = (r = this.opts.rateLimitedQueue) != null ? r : new Jt(this.opts.limit), fo(this, cl)[cl] = (s = this.opts.retryDelays) == null ? void 0 : s.values(), this.uploaders = Object.create(null), this.uploaderEvents = Object.create(null), this.handleResetProgress = this.handleResetProgress.bind(this);
    }
    handleResetProgress() {
      let e = {
    ...
    install() {
      ...
      }), this.uppy.addUploader(fo(this, ul)[ul]), this.uppy.on("reset-progress", this.handleResetProgress);
    }
    uninstall() {
      this.uppy.setState({
        capabilities: {
      ...
      }), this.uppy.removeUploader(fo(this, ul)[ul]);
    }
  };
exports.Tus = ls;
function oF(i) {
  var e = this;
  return this.resetUploaderReferences(i.id), new Promise((t, r) => {
    let s,
      n,
      a,
      u = {
    ...
    p.fingerprint = jp(i), p.onBeforeRequest = async _ => {
      let R = _.getUnderlyingObject();
      R.withCredentials = !!u.withCredentials;
      let $;
      if (typeof h == "function" && ($ = h(_, i)), oi(s, "shouldBeRequeued")) {
        if (!s.shouldBeRequeued) return Promise.reject();
        let W,
          K = new Promise(q => {
            W = q;
          });
        s = this.requests.run(() => (i.isPaused && s.abort(), W(), () => {})), await Promise.all([K, $]);
        return;
      }
      return $;
    }, p.onError = _ => {
      var R;
      this.uppy.log(_);
      let $ = _.originalRequest != null ? _.originalRequest.getUnderlyingObject() : null;
      uo($) && (_ = new Dt(_, $)), this.resetUploaderReferences(i.id), (R = s) == null || R.abort(), this.uppy.emit("upload-error", i, _), typeof u.onError == "function" && u.onError(_), r(_);
    }, p.onProgress = (_, R) => {
      this.onReceiveUploadUrl(i, a.url), typeof u.onProgress == "function" && u.onProgress(_, R), this.uppy.emit("upload-progress", this.uppy.getFile(i.id), {
        uploader: this,
        bytesUploaded: _,
        bytesTotal: R
      });
      ...
      if (this.resetUploaderReferences(i.id), s.done(), this.uppy.emit("upload-success", this.uppy.getFile(i.id), R), a.url) {
        let {
          name: $
        } = a.file;
    ...
    let y = o(_ => {
      var R;
      let $ = _ == null || (R = _.originalResponse) == null ? void 0 : R.getStatus();
      if ($ === 429) {
        if (!this.requests.isPaused) {
          var W;
          let K = (W = fo(this, cl)[cl]) == null ? void 0 : W.next();
          if (K == null || K.done) return !1;
          this.requests.rateLimit(K.value);
        }
      } else {
        if ($ != null && $ > 400 && $ < 500 && $ !== 409 && $ !== 423) return !1;
    ...
    l != null ? p.onShouldRetry = (_, R) => l(_, R, u, y) : p.onShouldRetry = y;
    let b = o((_, R, $) => {
        oi(_, R) && !oi(_, $) && (_[$] = _[R]);
      }, "copyProp"),
      S = {};
    (Array.isArray(u.allowedMetaFields) ? u.allowedMetaFields : Object.keys(i.meta)).forEach(_ => {
      S[_] = String(i.meta[_]);
    }), b(S, "type", "filetype"), b(S, "name", "filename"), p.metadata = S, a = new v0(i.data, p), this.uploaders[i.id] = a;
    let O = new Tr(this.uppy);
    this.uploaderEvents[i.id] = O, n = o(() => (i.isPaused || a.start(), () => {}), "qRequest"), a.findPreviousUploads().then(_ => {
      let R = _[0];
      R && (this.uppy.log(`[Tus] Resuming upload of ${i.id} started at ${R.creationTime}`), a.resumeFromPreviousUpload(R));
    }), s = this.requests.run(n), O.onFileRemove(i.id, _ => {
      s.abort(), this.resetUploaderReferences(i.id, {
        abort: !!a.url
      ...
      R === "user" && (s.abort(), e.resetUploaderReferences(i.id, {
        abort: !!a.url
      })), t(`upload ${i.id} was canceled`);
    }), O.onResumeAll(i.id, () => {
...
async function aF(i) {
  ...
  this.uppy.emit("upload-start", t), await Promise.allSettled(e.map(r => {
    if (r.isRemote) {
      ...
      let u = this.uppy.getRequestClientForFile(r).uploadRemoteFile(r, fo(this, $p)[$p](r), {
        signal: n.signal,
        getQueue: s
      });
      return this.requests.wrapSyncFunction(() => {
    ...
    return fo(this, Hp)[Hp](r);
  }));
}
o(aF, "_uploadFiles2");
ls.VERSION = rF.version;
var _0 = be(Vp(), 1);
function Se(i, e) {
  if (!Object.prototype.hasOwnProperty.call(i, e)) throw new TypeError("attempted to use private field on non-instance");
  return i;
...
o(er, "_classPrivateFieldLooseKey");
var cF = "ASSEMBLY_UPLOADING",
  Xp = "ASSEMBLY_EXECUTING",
  Yp = "ASSEMBLY_COMPLETED",
  P0 = [cF, Xp, Yp];
function oc(i, e) {
  return P0.indexOf(i) >= P0.indexOf(e);
}
o(oc, "isStatus");
var go = er("rateLimitedQueue"),
  dl = er("fetchWithNetworkError"),
  mo = er("previousFetchStatusStillPending"),
  tt = er("sse"),
  Qp = er("onFinished"),
  Wp = er("connectServerSentEvents"),
  ji = er("onError"),
  Gp = er("beginPolling"),
  Nr = er("fetchStatus"),
  Kp = er("diffStatus"),
  Jp = class extends _0.default {
    static {
      o(this, "TransloaditAssembly");
    }
    constructor(e, t) {
      super(), Object.defineProperty(this, Kp, {
        value: gF
        ...
        writable: !0,
        value: void 0
      }), this.status = e, this.pollInterval = null, this.closed = !1, Se(this, go)[go] = t, Se(this, dl)[dl] = t.wrapPromiseFunction(xs);
    }
    connect() {
      Se(this, Wp)[Wp](), Se(this, Gp)[Gp]();
    }
    update() {
      return Se(this, Nr)[Nr]({
        diff: !0
      });
    }
    updateStatus(e) {
      Se(this, Kp)[Kp](this.status, e), this.status = e;
    }
    close() {
      this.closed = !0, Se(this, tt)[tt] && (Se(this, tt)[tt].close(), Se(this, tt)[tt] = null), clearInterval(this.pollInterval), this.pollInterval = null;
    }
  };
function hF() {
...
o(hF, "_onFinished2");
function dF() {
  Se(this, tt)[tt] = new EventSource(`${this.status.websocket_url}?assembly=${this.status.assembly_id}`), Se(this, tt)[tt].addEventListener("open", () => {
    clearInterval(this.pollInterval), this.pollInterval = null;
  }), Se(this, tt)[tt].addEventListener("message", i => {
    i.data === "assembly_finished" && Se(this, Qp)[Qp](), i.data === "assembly_uploading_finished" && this.emit("executing"), i.data === "assembly_upload_meta_data_extracted" && (this.emit("metadata"), Se(this, Nr)[Nr]({
      diff: !1
    }));
  }), Se(this, tt)[tt].addEventListener("assembly_upload_finished", i => {
    let e = JSON.parse(i.data);
    this.status.uploads.push(e), this.emit("upload", e);
  }), Se(this, tt)[tt].addEventListener("assembly_result_finished", i => {
    var e, t;
    let [r, s] = JSON.parse(i.data);
    ((t = (e = this.status.results)[r]) != null ? t : e[r] = []).push(s), this.emit("result", r, s);
  }), Se(this, tt)[tt].addEventListener("assembly_execution_progress", i => {
    let e = JSON.parse(i.data);
    this.emit("execution-progress", e);
  }), Se(this, tt)[tt].addEventListener("assembly_error", i => {
    try {
...
o(dF, "_connectServerSentEvents2");
function pF(i) {
...
async function mF(i) {
  ...
  if (!(this.closed || Se(this, go)[go].isPaused || Se(this, mo)[mo])) try {
    Se(this, mo)[mo] = !0;
    let t = await Se(this, dl)[dl](this.status.assembly_ssl_url);
    if (Se(this, mo)[mo] = !1, this.closed) return;
    if (t.status === 429) {
      Se(this, go)[go].rateLimit(2e3);
      return;
    }
    if (!t.ok) {
...
function gF(i, e) {
  ...
  let s = oc(r, Xp) && !oc(t, Xp);
  s && this.emit("executing"), Object.keys(e.uploads).filter(n => !oi(i.uploads, n)).forEach(n => {
  ...
  }), oc(r, Yp) && !oc(t, Yp) && this.emit("finished");
}
o(gF, "_diffStatus2");
var Zp = Jp;
function at(i, e) {
...
o(at, "_classPrivateFieldLooseBase");
var yF = 0;
function nc(i) {
  return "__private_" + yF++ + "_" + i;
}
o(nc, "_classPrivateFieldLooseKey");
var x0 = "/assemblies",
  ...
  fl = class {
    ...
    constructor(e) {
      ...
      }), this.opts = e, this.opts.client != null && (at(this, vi)[vi]["Transloadit-Client"] = this.opts.client), at(this, pl)[pl] = this.opts.rateLimitedQueue.wrapPromiseFunction(xs);
    }
    async createAssembly(e) {
      let {
        ...
        a = new FormData();
      a.append("params", typeof t == "string" ? t : JSON.stringify(t)), s && a.append("signature", s), Object.keys(r).forEach(l => {
        a.append(l, String(r[l]));
      }), a.append("num_expected_upload_files", String(n));
      let u = new URL(x0, `${this.opts.service}`).href;
      return at(this, Wt)[Wt](u, {
        method: "POST",
        headers: at(this, vi)[vi],
        body: a
      }).catch(l => at(this, zi)[zi](l, {
        url: u,
        type: "API_ERROR"
      }));
    }
    async reserveFile(e, t) {
      ...
      return at(this, Wt)[Wt](s, {
        method: "POST",
        headers: at(this, vi)[vi]
      }).catch(n => at(this, zi)[zi](n, {
        assembly: e,
        file: t,
        url: s,
        type: "API_ERROR"
    ...
    async addFile(e, t) {
      ...
      return at(this, Wt)[Wt](l, {
        method: "POST",
        headers: at(this, vi)[vi]
      }).catch(h => at(this, zi)[zi](h, {
        assembly: e,
        file: t,
        url: l,
        type: "API_ERROR"
    ...
    async cancelAssembly(e) {
      ...
      return at(this, Wt)[Wt](t, {
        method: "DELETE",
        headers: at(this, vi)[vi]
      }).catch(r => at(this, zi)[zi](r, {
        url: t,
        type: "API_ERROR"
      }));
    }
    async getAssemblyStatus(e) {
      return at(this, Wt)[Wt](e, {
        headers: at(this, vi)[vi]
      }).catch(t => at(this, zi)[zi](t, {
        url: e,
        type: "STATUS_ERROR"
      }));
    }
    async submitError(e, t) {
      ...
      return at(this, Wt)[Wt]("https://transloaditstatus.com/client_error", {
        method: "POST",
        body: JSON.stringify({
          endpoint: r,
          instance: s,
...
async function vF() {
  let i = await at(this, pl)[pl](...arguments);
  if (i.status === 429) return this.opts.rateLimitedQueue.rateLimit(2e3), at(this, Wt)[Wt](...arguments);
  if (!i.ok) {
    let e = new Error(i.statusText);
    return e.statusCode = i.status, `${arguments.length <= 0 ? void 0 : arguments[0]}`.endsWith(x0) ? i.json().then(t => {
      if (!t.error) throw e;
      let r = new ef(t.error, t.message, t);
...
function rf(i) {
  ...
  if (typeof i == "string") try {
    ...
    throw new pr("Transloadit: The `params` option is a malformed JSON string.", {
      cause: e
    });
  }
...
async function F0(i, e) {
  ...
  return Array.isArray(r) ? t.fields = i == null ? {} : Object.fromEntries(r.map(s => [s, i.meta[s]])) : r == null && (t.fields = {}), t;
}
...
var wF = 0;
function bi(i) {
  return "__private_" + wF++ + "_" + i;
}
o(bi, "_classPrivateFieldLooseKey");
var ml = bi("assemblyIDs"),
  vo = bi("remaining"),
  gl = bi("resolve"),
  sf = bi("reject"),
  ke = bi("uppy"),
  Mr = bi("watching"),
  yl = bi("onAssemblyComplete"),
  vl = bi("onAssemblyCancel"),
  bo = bi("onAssemblyError"),
  bl = bi("onImportError"),
  yo = bi("checkAllComplete"),
  nf = bi("removeListeners"),
  of = bi("addListeners"),
  af = class extends O0.default {
    static {
      o(this, "TransloaditAssemblyWatcher");
    }
    constructor(e, t) {
      super(), Object.defineProperty(this, of, {
        value: xF
        ...
        writable: !0,
        value: r => {
          pe(this, Mr)[Mr](r.assembly_id) && (pe(this, ke)[ke].log(`[Transloadit] AssemblyWatcher: Got Assembly finish ${r.assembly_id}`), this.emit("assembly-complete", r.assembly_id), pe(this, yo)[yo]());
        }
      }), Object.defineProperty(this, vl, {
        writable: !0,
        value: r => {
          pe(this, Mr)[Mr](r.assembly_id) && pe(this, yo)[yo]();
        }
      }), Object.defineProperty(this, bo, {
        writable: !0,
        value: (r, s) => {
          pe(this, Mr)[Mr](r.assembly_id) && (pe(this, ke)[ke].log(`[Transloadit] AssemblyWatcher: Got Assembly error ${r.assembly_id}`), pe(this, ke)[ke].log(s), this.emit("assembly-error", r.assembly_id, s), pe(this, yo)[yo]());
        }
      }), Object.defineProperty(this, bl, {
        writable: !0,
        value: (r, s, n) => {
          pe(this, Mr)[Mr](r.assembly_id) && pe(this, bo)[bo](r, n);
        }
      }), pe(this, ke)[ke] = e, pe(this, ml)[ml] = t, pe(this, vo)[vo] = t.length, this.promise = new Promise((r, s) => {
        pe(this, gl)[gl] = r, pe(this, sf)[sf] = s;
      }), pe(this, of)[of]();
    }
  };
function SF(i) {
  return pe(this, ml)[ml].indexOf(i) !== -1;
}
o(SF, "_watching2");
function PF() {
  pe(this, vo)[vo] -= 1, pe(this, vo)[vo] === 0 && (pe(this, nf)[nf](), pe(this, gl)[gl]());
}
o(PF, "_checkAllComplete2");
function _F() {
  pe(this, ke)[ke].off("transloadit:complete", pe(this, yl)[yl]), pe(this, ke)[ke].off("transloadit:assembly-cancel", pe(this, vl)[vl]), pe(this, ke)[ke].off("transloadit:assembly-error", pe(this, bo)[bo]), pe(this, ke)[ke].off("transloadit:import-error", pe(this, bl)[bl]);
}
o(_F, "_removeListeners2");
function xF() {
  pe(this, ke)[ke].on("transloadit:complete", pe(this, yl)[yl]), pe(this, ke)[ke].on("transloadit:assembly-cancel", pe(this, vl)[vl]), pe(this, ke)[ke].on("transloadit:assembly-error", pe(this, bo)[bo]), pe(this, ke)[ke].on("transloadit:import-error", pe(this, bl)[bl]);
}
o(xF, "_addListeners2");
var C0 = af;
var A0 = {
...
var EF = {
  ...
  T0 = o(i => e => {
    let t = new pr("Failed to send error to the client", {
      cause: e
    });
    console.error(t, i);
  }, "sendErrorToConsole"),
  Sf = "https://api2.transloadit.com/companion",
  Pf = /\.transloadit\.com$/,
  OF = /https?:\/\/api2(?:-\w+)?\.transloadit\.com\/companion/,
  CF = {
  ...
  Hi = Ke("rateLimitedQueue"),
  lf = Ke("getClientVersion"),
  vf = Ke("attachAssemblyMetadata"),
  uf = Ke("createAssembly"),
  wl = Ke("createAssemblyWatcher"),
  cf = Ke("shouldWaitAfterUpload"),
  hf = Ke("reserveFiles"),
  Sl = Ke("onFileUploadURLAvailable"),
  El = Ke("findFile"),
  bf = Ke("onFileUploadComplete"),
  wf = Ke("onResult"),
  Fl = Ke("onAssemblyFinished"),
  df = Ke("cancelAssembly"),
  pf = Ke("onCancelAll"),
  ff = Ke("getPersistentData"),
  mf = Ke("onRestored"),
  Pl = Ke("connectAssembly"),
  _l = Ke("prepareUpload"),
  wo = Ke("afterUpload"),
  gf = Ke("closeAssemblyIfExists"),
  xl = Ke("onError"),
  yf = Ke("onTusError"),
  tr = class extends Oe {
    static {
    ...
    constructor(e, t) {
      ...
      super(e, {
        ...CF,
        ...t
      }), r = this, Object.defineProperty(this, Pl, {
        value: jF
        ...
        value: u => {
          ...
          if (!(h != null && (l = h.transloadit) != null && l.assembly)) return;
          let {
              assemblies: d
            } = this.getPluginState(),
            p = d[h.transloadit.assembly];
          this.client.addFile(p, h).catch(y => {
            this.uppy.log(y), this.uppy.emit("transloadit:import-error", p, h.id, y);
          });
        }
        ...
        value: async function (u) {
          ...
          try {
            ...
            let {
              ...
              p = Object.values(h).flat(1).map(y => r.getAssembly(y));
            await Promise.all(p.map(y => me(r, df)[df](y)));
          } catch (h) {
            r.uppy.log(h);
          }
        }
        ...
        value: u => {
          ...
          let p = o(S => {
              let T = {},
                O = [];
              for (let [_, R] of Object.entries(S)) {
                R.uploads.forEach(W => {
                  let K = me(this, El)[El](W);
                  T[W.id] = {
                    id: K.id,
                    assembly: _,
                    uploadedFile: W
            ...
            y = o(() => {
              ...
              Object.keys(T).forEach(_ => {
                ...
                let R = new Zp(S[_], me(this, Hi)[Hi]);
                me(this, Pl)[Pl](R);
              });
            }, "restoreAssemblies"),
            b = o(() => {
              ...
              return Promise.all(Object.keys(S).map(T => this.activeAssemblies[T].update()));
            }, "updateAssemblies");
        ...
        writable: !0,
        value: async (u, l) => {
          let d = u.map(S => this.uppy.getFile(S)).filter(S => S.error ? !1 : (this.uppy.emit("preprocess-progress", S, {
              mode: "indeterminate",
            ...
            p = o(async S => {
              ...
              try {
                let _ = await me(this, uf)[uf](T, l, O);
                return this.opts.importFromUploadURLs && (await me(this, hf)[hf](_, T)), T.forEach(R => {
                ...
                throw T.forEach(R => {
                  let $ = this.uppy.getFile(R);
                  this.uppy.emit("preprocess-complete", $), this.uppy.emit("upload-error", $, _);
                }), _;
              }
            }, "createAssembly"),
            {
          ...
          }), await new E0(d, this.opts).build().then(S => Promise.all(S.map(p))).then(S => {
            let T = S.filter(Boolean),
              O = T.map(_ => _.status.assembly_id);
            return me(this, wl)[wl](O, l), Promise.all(T.map(_ => me(this, Pl)[Pl](_)));
          }).catch(S => {
            throw d.forEach(T => {
              this.uppy.emit("preprocess-complete", T), this.uppy.emit("upload-error", T, S);
            }), S;
          });
        }
        ...
        value: (u, l) => {
          let h = u.map(O => this.uppy.getFile(O)),
            ...
            p = this.getPluginState();
          if (this.restored) return this.restored.then(() => me(this, wo)[wo](d, l));
          let y = p.uploadsAssemblies[l],
            b = o(() => {
              y.forEach(O => {
                this.activeAssemblies[O].close(), delete this.activeAssemblies[O];
              });
            }, "closeSocketConnections");
          if (!me(this, cf)[cf]()) {
            b();
            let O = y.map(_ => this.getAssembly(_));
            return this.uppy.addResultData(l, {
              transloadit: O
            }), Promise.resolve();
          }
          return y.length === 0 ? (this.uppy.addResultData(l, {
            transloadit: []
          }), Promise.resolve()) : (h.filter(O => !oi(this.completedFiles, O.id)).forEach(O => {
            ...
            delete _[l], this.setPluginState({
              uploadsAssemblies: _
            }), this.uppy.addResultData(l, {
              transloadit: O
            });
          }));
        }
        ...
        value: (u, l) => {
          var h, d;
          if (me(this, gf)[gf](u == null || (h = u.transloadit) == null ? void 0 : h.assembly), l != null && (d = l.message) != null && d.startsWith("tus: ")) {
            var p;
            let y = (p = l.originalRequest) == null || (p = p.getUnderlyingObject()) == null ? void 0 : p.responseURL;
            this.client.submitError(l, {
              endpoint: y
            }).catch(T0(l));
          }
        }
      }), this.type = "uploader", this.id = this.opts.id || "Transloadit", this.defaultLocale = A0, (n = (s = this.opts).assemblyOptions) != null || (s.assemblyOptions = (a = this.opts.getAssemblyOptions) != null ? a : {
        params: this.opts.params,
        signature: this.opts.signature,
        fields: this.opts.fields
      }), t?.params != null && t.getAssemblyOptions == null && t.assemblyOptions == null && rf(this.opts.assemblyOptions.params), me(this, Hi)[Hi] = new Jt(this.opts.limit), this.i18nInit(), this.client = new fl({
        service: this.opts.service,
        client: me(this, lf)[lf](),
    ...
    install() {
      this.uppy.addPreProcessor(me(this, _l)[_l]), this.uppy.addPostProcessor(me(this, wo)[wo]), this.uppy.on("error", me(this, xl)[xl]), this.uppy.on("cancel-all", me(this, pf)[pf]), this.uppy.on("upload-error", me(this, yf)[yf]), this.opts.importFromUploadURLs ? this.uppy.on("upload-success", me(this, Sl)[Sl]) : this.uppy.use(ls, {
        storeFingerprintForResuming: !1,
        allowedMetaFields: ["assembly_url", "filename", "fieldname"],
        limit: this.opts.limit,
        rateLimitedQueue: me(this, Hi)[Hi],
        retryDelays: this.opts.retryDelays
      }), this.uppy.on("restore:get-data", me(this, ff)[ff]), this.uppy.on("restored", me(this, mf)[mf]), this.setPluginState({
        assemblies: {},
        uploadsAssemblies: {},
        files: {},
        results: []
    ...
    uninstall() {
      this.uppy.removePreProcessor(me(this, _l)[_l]), this.uppy.removePostProcessor(me(this, wo)[wo]), this.uppy.off("error", me(this, xl)[xl]), this.opts.importFromUploadURLs && this.uppy.off("upload-success", me(this, Sl)[Sl]);
      let {
        capabilities: e
      } = this.uppy.getState();
      this.uppy.setState({
...
exports.Transloadit = tr;
function AF() {
  let i = [`uppy-core:${this.uppy.constructor.VERSION}`, `uppy-transloadit:${this.constructor.VERSION}`, `uppy-tus:${ls.VERSION}`],
    e = o((t, r) => {
      let s = this.uppy.getPlugin(t);
      s && i.push(`${r}:${s.constructor.VERSION}`);
    }, "addPluginVersion");
  return this.opts.importFromUploadURLs && (e("XHRUpload", "uppy-xhr-upload"), e("AwsS3", "uppy-aws-s3"), e("AwsS3Multipart", "uppy-aws-s3-multipart")), e("Dropbox", "uppy-dropbox"), e("Box", "uppy-box"), e("Facebook", "uppy-facebook"), e("GoogleDrive", "uppy-google-drive"), e("GooglePhotos", "uppy-google-photos"), e("Instagram", "uppy-instagram"), e("OneDrive", "uppy-onedrive"), e("Zoom", "uppy-zoom"), e("Url", "uppy-url"), this.opts.clientName != null && i.push(this.opts.clientName), i.join(",");
}
o(AF, "_getClientVersion2");
function TF(i, e) {
  let t = {
      ...i.meta,
  ...
  if (i.remote && OF.test(i.remote.companionUrl)) {
...
function RF(i, e, t) {
  return this.uppy.log("[Transloadit] Create Assembly"), this.client.createAssembly({
    ...
    let p = o((y, b) => {
      var S;
      if (((S = n.status) == null ? void 0 : S.ok) === "ASSEMBLY_COMPLETED") {
        this.uppy.off("file-removed", p);
        return;
      }
      b === "cancel-all" && (n.close(), this.uppy.off("file-removed", p));
    }, "fileRemovedHandler");
    return this.uppy.on("file-removed", p), this.uppy.emit("transloadit:assembly-created", a, i), this.uppy.log(`[Transloadit] Created Assembly ${u}`), n;
  }).catch(r => {
    let s = new pr(`${this.i18n("creatingAssemblyFailed")}: ${r.message}`, {
      cause: r
    });
    throw "details" in r && (s.details = r.details), "assembly" in r && (s.assembly = r.assembly), s;
  });
}
o(RF, "_createAssembly2");
function kF(i, e) {
  let t = Array.isArray(i) ? i : [i],
    r = new C0(this.uppy, t);
  r.on("assembly-complete", s => {
    this.getAssemblyFiles(s).forEach(a => {
      this.completedFiles[a.id] = !0, this.uppy.emit("postprocess-complete", a);
    });
  }), r.on("assembly-error", (s, n) => {
    let a = this.getAssemblyFiles(s);
    a.forEach(l => {
      this.uppy.emit("upload-error", l, n), this.uppy.emit("postprocess-complete", l);
    });
    let u = {
      ...this.uppy.getState().files
    };
    a.forEach(l => delete u[l.id].tus), this.uppy.setState({
      files: u
    }), this.uppy.emit("error", n);
  }), this.assemblyWatchers[e] = r;
}
o(kF, "_createAssemblyWatcher2");
function UF() {
  return this.opts.waitForEncoding || this.opts.waitForMetadata;
}
o(UF, "_shouldWaitAfterUpload2");
function DF(i, e) {
...
function NF(i, e, t) {
  ...
  let a = this.activeAssemblies[i].status;
  this.uppy.emit("transloadit:result", e, t, a);
}
o(NF, "_onResult2");
function MF(i) {
...
function jF(i) {
  ...
  return this.activeAssemblies[t] = i, i.on("status", r => {
    ...
    if (this.uppy.emit("transloadit:execution-progress", r), r.progress_combined != null) for (let s of this.uppy.getFiles()) this.uppy.emit("postprocess-progress", s, {
      mode: "determinate",
    ...
    me(this, Fl)[Fl](i.status);
  }) : this.opts.waitForMetadata && i.on("metadata", () => {
    me(this, Fl)[Fl](i.status);
  }), i.ok === "ASSEMBLY_COMPLETE" || i.connect(), i;
}
o(jF, "_connectAssembly2");
tr.VERSION = EF.version;
tr.COMPANION = Sf;
tr.COMPANION_PATTERN = Pf;
var ac = o(() => {}, "noop");
function R0(i, e) {
  e === void 0 && (e = {});
  let {
      ...
      headers: r = {},
      method: s = "GET",
      onBeforeRequest: n = ac,
      onUploadProgress: a = ac,
    ...
    T = o(R => .3 * 2 ** (R - 1) * 1e3, "delay"),
    O = new Xu(b, h);
  function _(R) {
    return R === void 0 && (R = 0), new Promise(async ($, W) => {
      let K = new XMLHttpRequest();
      K.open(s, i, !0), K.withCredentials = S, d && (K.responseType = d), y?.addEventListener("abort", () => {
        K.abort(), W(new DOMException("Aborted", "AbortError"));
      }), K.onload = async () => {
        await l(K, R), K.status >= 200 && K.status < 300 ? (O.done(), $(K)) : u(K) && R < p ? setTimeout(() => {
          _(R + 1).then($, W);
        }, T(R)) : (O.done(), W(new Dt(K.statusText, K)));
      }, K.onerror = () => {
        u(K) && R < p ? setTimeout(() => {
          _(R + 1).then($, W);
        }, T(R)) : (O.done(), W(new Dt(K.statusText, K)));
      ...
      }), await n(K, R), K.send(t);
    });
  }
  return o(_, "requestWithRetry"), _();
}
o(R0, "fetcher");
var k0 = {
  strings: {
...
o(on, "_classPrivateFieldLooseKey");
var HF = {
  version: "3.6.7"
};
function $F(i, e) {
  ...
  return t || (t = new Error("Upload error")), typeof t == "string" && (t = new Error(t)), t instanceof Error || (t = Object.assign(new Error("Upload error"), {
    data: t
  })), uo(i) ? (t = new Dt(t, i), t) : (t.request = i, t);
}
o($F, "buildResponseError");
function U0(i) {
  return i.data.slice(0, i.data.size, i.meta.type);
}
o(U0, "setTypeInBlob");
var qF = {
  ...
  So = on("getFetcher"),
  Ff = on("uploadLocalFile"),
  _f = on("uploadBundle"),
  Ef = on("getCompanionClientArgs"),
  xf = on("uploadFiles"),
  Ol = on("handleUpload"),
  Cl = class extends Oe {
    static {
    ...
    constructor(e, t) {
      if (super(e, {
        ...
        value: async r => {
          ...
          if (this.uppy.emit("upload-start", a), this.opts.bundle) {
            ...
            await Br(this, _f)[_f](n);
          } else await Br(this, xf)[xf](n);
        }
      }), this.type = "uploader", this.id = this.opts.id || "XHRUpload", this.defaultLocale = k0, this.i18nInit(), ss in this.opts ? this.requests = this.opts[ss] : this.requests = new Jt(this.opts.limit), this.opts.bundle && !this.opts.formData) throw new Error("`opts.formData` must be true when `opts.bundle` is enabled.");
      ...
      this.uploaderEvents = Object.create(null), Br(this, So)[So] = r => async (s, n) => {
        try {
          var a;
          let u = await R0(s, {
            ...n,
            method: n == null || (a = n.method) == null ? void 0 : a.toUpperCase(),
            onTimeout: d => {
              let p = Math.ceil(d / 1e3),
                y = new Error(this.i18n("uploadStalled", {
                  seconds: p
                }));
              this.uppy.emit("upload-stalled", y, r);
            },
            onUploadProgress: d => {
              if (d.lengthComputable) for (let p of r) this.uppy.emit("upload-progress", p, {
                uploader: this,
                bytesUploaded: d.loaded / d.total * p.size,
                bytesTotal: p.size
              });
            }
          });
          if (!this.opts.validateStatus(u.status, u.responseText, u)) throw new Dt(u.statusText, u);
          let l = this.opts.getResponseData(u.responseText, u),
            h = l?.[this.opts.responseUrlFieldName];
          for (let d of r) this.uppy.emit("upload-success", d, {
            status: u.status,
            body: l,
            uploadURL: h
          });
          ...
          if (u instanceof Dt) {
            let l = u.request,
              h = $F(l, this.opts.getResponseError(l.responseText, l));
    ...
    addMetadata(e, t, r) {
      (Array.isArray(r.allowedMetaFields) ? r.allowedMetaFields : Object.keys(t)).forEach(n => {
        let a = t[n];
    ...
    createBundledUpload(e, t) {
      ...
      return this.addMetadata(r, s, t), e.forEach(n => {
        let a = this.getOptions(n),
          u = U0(n);
        n.name ? r.append(a.fieldName, u, n.name) : r.append(a.fieldName, u);
      }), r;
    }
    install() {
      if (this.opts.bundle) {
      ...
      this.uppy.addUploader(Br(this, Ol)[Ol]);
    }
    uninstall() {
      if (this.opts.bundle) {
        let {
      ...
      this.uppy.removeUploader(Br(this, Ol)[Ol]);
    }
  };
exports.XHRUpload = Cl;
async function VF(i) {
  let e = new Tr(this.uppy),
  ...
  e.onFileRemove(i.id, () => t.abort()), e.onCancelAll(i.id, s => {
    let {
      reason: n
    } = s;
    n === "user" && t.abort();
...
function GF(i) {
  ...
  let t = this.getOptions(i),
    r = Array.isArray(t.allowedMetaFields) ? t.allowedMetaFields : Object.keys(i.meta);
  return {
    ...((e = i.remote) == null ? void 0 : e.body),
    protocol: "multipart",
    endpoint: t.endpoint,
...
async function KF(i) {
  await Promise.allSettled(i.map(e => {
    if (e.isRemote) {
      ...
      this.uppy.on("file-removed", s);
      let n = this.uppy.getRequestClientForFile(e).uploadRemoteFile(e, Br(this, Ef)[Ef](e), {
        signal: r.signal,
        getQueue: t
      });
      return this.requests.wrapSyncFunction(() => {
    ...
    return Br(this, Ff)[Ff](e);
  }));
}
o(KF, "_uploadFiles2");
Cl.VERSION = HF.version;
var Af = be(gn(), 1),
  N0 = be(D0(), 1);
var I0 = {
  strings: {
...
var XF = 0;
function YF(i) {
  return "__private_" + XF++ + "_" + i;
}
o(YF, "_classPrivateFieldLooseKey");
var Al = YF("RateLimitedQueue"),
  lc = class extends Oe {
    static {
      o(this, "Compressor");
    }
    constructor(e, t) {
      super(e, t), Object.defineProperty(this, Al, {
        writable: !0,
        value: void 0
      }), this.id = this.opts.id || "Compressor", this.type = "modifier", this.defaultLocale = I0;
      let r = {
        quality: .6,
        limit: 10
      };
      this.opts = {
        ...r,
        ...t
      }, L0(this, Al)[Al] = new Jt(this.opts.limit), this.i18nInit(), this.prepareUpload = this.prepareUpload.bind(this), this.compress = this.compress.bind(this);
    }
    compress(e) {
      return new Promise((t, r) => {
        new N0.default(e, {
    ...
    async prepareUpload(e) {
      let t = 0,
        r = [],
        s = L0(this, Al)[Al].wrapPromiseFunction(async a => {
          try {
            let u = await this.compress(a.data),
              l = a.data.size - u.size;
            this.uppy.log(`[Image Compressor] Image ${a.id} compressed by ${(0, Af.default)(l)}`), t += l;
            let {
                name: h,
                type: d,
                size: p
              ...
              y = Wi(h),
              S = `${Wi(a.meta.name).name}.${y.extension}`;
            ...
            this.uppy.log(`[Image Compressor] Failed to compress ${a.id}:`, "warning"), this.uppy.log(u, "warning");
          }
        }),
        n = e.map(a => {
          var u;
          ...
          }), l.isRemote || (l.data.type || (l.data = l.data.slice(0, l.data.size, l.type)), !((u = l.type) != null && u.startsWith("image/"))) ? Promise.resolve() : s(l);
        });
...
exports.Compressor = lc;
function uc() {
  return uc = Object.assign || function (i) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e];
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (i[r] = t[r]);
    }
...
function cc(i, e) {
  ...
  for (var t = {}, r, s = [], n = {}, a = 0, u = i.elements.length; a < u; a++) {
    var l = i.elements[a];
    JF[l.type] || l.disabled && !e.includeDisabled || (r = l.name || l.id, r && !n[r] && (s.push(r), n[r] = !0));
  }
...
function j0(i, e, t) {
  ...
  if (!e && M0.call(e) !== "[object String]") throw new Error("A field name is required by getFieldData, was given fieldName=" + e);
  t = uc({
    includeDisabled: !1,
    trim: !1
  }, t);
  ...
  if (!QF[M0.call(r)]) return B0(r, t.trim);
  for (var s = [], n = !0, a = 0, u = r.length; a < u; a++) if (!(r[a].disabled && !t.includeDisabled)) {
...
function B0(i, e) {
  ...
  return r === "file" && "files" in i ? (i.multiple ? (t = tE.call(i.files), t.length === 0 && (t = null)) : t = i.files[0], t) : (ZF[r] ? i.checked && (r === "checkbox" && !i.hasAttribute("value") ? t = !0 : t = i.value) : t = e ? i.value.replace(eE, "") : i.value, t);
}
...
o(Tf, "_classPrivateFieldLooseBase");
var iE = 0;
function rE(i) {
  return "__private_" + iE++ + "_" + i;
}
o(rE, "_classPrivateFieldLooseKey");
var sE = {
    version: "3.2.1"
  },
  oE = {
...
var Po = rE("completed"),
  Tl = class extends Oe {
    ...
    handleUploadStart() {
      Tf(this, Po)[Po] = !1, this.opts.getMetaFromForm && this.getMetaFromForm();
    }
    handleSuccess(e) {
      Tf(this, Po)[Po] = !0, this.opts.addResultToForm && this.addResultToForm(e), this.opts.submitOnSuccess && this.form.requestSubmit();
    }
    handleFormSubmit(e) {
      if (this.opts.triggerUploadOnSubmit && !Tf(this, Po)[Po]) {
        e.preventDefault();
        let t = nt(e.target.elements),
          r = [];
        t.forEach(s => {
    ...
    install() {
      this.form = nE(iu(this.opts.target)), this.form.addEventListener("submit", this.handleFormSubmit), this.uppy.on("upload", this.handleUploadStart), this.uppy.on("complete", this.handleSuccess);
    }
    uninstall() {
...
var aE = 0;
function lE(i) {
  return "__private_" + aE++ + "_" + i;
}
o(lE, "_classPrivateFieldLooseKey");
var z0 = typeof navigator < "u" && "serviceWorker" in navigator;
function uE() {
  return new Promise((i, e) => {
    z0 ? navigator.serviceWorker.controller ? i() : navigator.serviceWorker.addEventListener("controllerchange", () => {
      i();
    }) : e(new Error("Unsupported"));
  });
}
o(uE, "waitForServiceWorker");
var Gt = lE("ready"),
  hc = class {
    static {
    ...
    constructor(e) {
      Object.defineProperty(this, Gt, {
        writable: !0,
        value: void 0
      }), _o(this, Gt)[Gt] = uE().then(t => {
        _o(this, Gt)[Gt] = t;
      }), this.name = e.storeName;
    }
    get ready() {
      return Promise.resolve(_o(this, Gt)[Gt]);
    }
    set ready(e) {
      _o(this, Gt)[Gt] = e;
    }
    async list() {
      return await _o(this, Gt)[Gt], new Promise((e, t) => {
        let r = o(s => {
    ...
    async put(e) {
      await _o(this, Gt)[Gt], navigator.serviceWorker.controller.postMessage({
        type: "uppy/ADD_FILE",
        store: this.name,
        file: e
      });
...
var cE = 0;
function hE(i) {
  return "__private_" + cE++ + "_" + i;
}
o(hE, "_classPrivateFieldLooseKey");
var G0 = typeof window < "u" && (window.indexedDB || window.webkitIndexedDB || window.mozIndexedDB || window.OIndexedDB || window.msIndexedDB),
  dE = !!G0,
  $0 = "uppy-blobs",
  ei = "files",
  K0 = 24 * 60 * 60 * 1e3,
...
function V0(i) {
  ...
  return new Promise((t, r) => {
    e.onupgradeneeded = s => {
      ...
      if (s.oldVersion < 2 && n.createObjectStore(ei, {
        keyPath: "id"
      }).createIndex("store", "store", {
        unique: !1
      }), s.oldVersion < 3) {
        let u = a.objectStore(ei);
        u.createIndex("expires", "expires", {
          unique: !1
        }), fE(u);
      }
      a.oncomplete = () => {
  ...
  pc = class i {
    ...
    constructor(e) {
      ...
      let t = o(async () => {
        ...
        return ir(this, it)[it] = r, r;
      }, "createConnection");
      W0 ? ir(this, it)[it] = t() : (W0 = !0, ir(this, it)[it] = i.cleanup().then(t, t));
    }
    get ready() {
      return Promise.resolve(ir(this, it)[it]);
    }
    set ready(e) {
      ir(this, it)[it] = e;
    }
    ...
    async list() {
      let s = (await ir(this, it)[it]).transaction([ei], "readonly").objectStore(ei).index("store").getAll(IDBKeyRange.only(this.name)),
        n = await dc(s);
      return Object.fromEntries(n.map(a => [a.fileID, a.data]));
    }
    async get(e) {
      let s = (await ir(this, it)[it]).transaction([ei], "readonly").objectStore(ei).get(this.key(e)),
        {
          data: n
        } = await dc(s);
      return {
    ...
    async getSize() {
      let s = (await ir(this, it)[it]).transaction([ei], "readonly").objectStore(ei).index("store").openCursor(IDBKeyRange.only(this.name));
    ...
    async put(e) {
      ...
      let n = (await ir(this, it)[it]).transaction([ei], "readwrite").objectStore(ei).add({
        id: this.key(e.id),
        fileID: e.id,
        store: this.name,
    ...
    async delete(e) {
      let s = (await ir(this, it)[it]).transaction([ei], "readwrite").objectStore(ei).delete(this.key(e));
      return dc(s);
    }
    static async cleanup() {
      let e = await V0($0),
        s = e.transaction([ei], "readwrite").objectStore(ei).index("expires").openCursor(IDBKeyRange.upperBound(Date.now()));
  ...
  us = class i {
    ...
    constructor(e) {
      this.opts = {
        ...
        ...e
      }, this.name = `uppyState:${e.storeName}`, Q0 || (Q0 = !0, i.cleanup());
    }
    load() {
...
var gE = {
  ...
  Rl = class extends Oe {
    ...
    constructor(e, t) {
      ...
      }, this.type = "debugger", this.id = this.opts.id || "GoldenRetriever", this.MetaDataStore = new us({
        expires: this.opts.expires,
        storeName: e.getID()
      }), this.ServiceWorkerStore = null, this.opts.serviceWorker && (this.ServiceWorkerStore = new H0({
        storeName: e.getID()
      })), this.IndexedDBStore = new X0({
        expires: this.opts.expires,
        ...(this.opts.indexedDB || {}),
        storeName: e.getID()
      }), this.saveFilesStateToLocalStorage = (0, J0.default)(this.saveFilesStateToLocalStorage.bind(this), 500, {
        leading: !0,
        trailing: !0
...
exports.GoldenRetriever = Rl;
Rl.VERSION = gE.version;
var vE = {
    version: "3.0.3"
  },
  kl = class extends ae {
...
exports.ReduxDevTools = kl;
kl.VERSION = vE.version;
function HM() {
