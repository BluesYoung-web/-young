...
import { useAutoLoad } from "../index.mjs";
export default defineComponent({
  ...
  setup(props, { emit, attrs, slots }) {
    ...
    return () => /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement(
      ...
      tableHead_1.value.map((head, index) => /* @__PURE__ */ React.createElement(
        ElTableColumn,
        {
          key: index,
          prop: head.prop,
            ...
            header: (scope) => {
              if (tableHead_1.value[index].tool_content) {
                return /* @__PURE__ */ React.createElement(
                  ...
                  /* @__PURE__ */ React.createElement("span", null, scope.column.label),
      ...
      slots.switch?.(),
      slots.operate?.()
    ), props.enableCustomHead && /* @__PURE__ */ React.createElement(ElPopover, { trigger: "click", placement: "bottom-end", width: 200 }, {
      reference: () => /* @__PURE__ */ React.createElement(
        "div",
        {
      ...
      default: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "10px", textAlign: "center", fontWeight: "bold" } }, "\u81EA\u5B9A\u4E49\u5C55\u793A\u7684\u8868\u5934"), /* @__PURE__ */ React.createElement(
        ElCheckboxGroup,
        {
          style: {
            maxHeight: "350px",
        ...
        props.tableHead.filter((item) => !item.only_export).map((item, index) => (
          // @ts-ignore
          /* @__PURE__ */ React.createElement(ElCheckbox, { label: item.prop, key: index, title: item.label }, item.label)
        ))
      ))
    }));
  }
