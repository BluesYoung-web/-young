...
var _CustomHead = _interopRequireDefault(require("./sub/CustomHead"));
...
var _default = (0, _vue.defineComponent)({
  ...
  setup(props, {
    ...
    const tableHeadCheck_1 = (0, _vue.ref)([]);
    (0, _vue.watchEffect)(() => {
    ...
    const historyHead = (0, _core.useLocalStorage)(`table_pro_tableHead_${props.historyId || location.href.replace(location.origin, "")}`, {});
    const initHead = () => {
      ...
      if (props.history) {
        ...
        heads.forEach((head, index) => {
          ...
          heads[index] = (0, _defu.defu)(ori, head);
        });
    ...
    const initDefaultData = () => {
      tableHead_1.value = (0, _utils.deepClone)(props.tableHead);
      tableHeadCheck_1.value = props.tableHeadCheck?.length ? (0, _utils.deepClone)(props.tableHeadCheck) : props.tableHead.map(t => t.prop);
    };
    const initData = (0, _vue.computed)(() => {
      return tableHead_1.value.map(t => {
        t.check = tableHeadCheck_1.value.includes(t.prop);
        return t;
      });
    });
    const filterHeader = (0, _vue.computed)(() => {
    ...
    const saveTableHead = () => {
      ...
      _elementPlus.ElMessage.success("\u4FDD\u5B58\u6210\u529F");
    };
    const resetTableHead = () => {
      _elementPlus.ElMessageBox.confirm("\u786E\u5B9A\u91CD\u7F6E\u8868\u5934\u5417\uFF1F", "\u63D0\u793A", {
        confirmButtonText: "\u786E\u5B9A",
        cancelButtonText: "\u53D6\u6D88",
        type: "warning"
      }).then(() => {
        historyHead.value = {};
        _elementPlus.ElMessage.success("\u91CD\u7F6E\u6210\u529F");
        (0, _vue.nextTick)(() => {
          initHead();
        });
      });
    };
    const randomKey = (0, _utils.randomId)();
    expose({
      saveTableHead,
      resetTableHead
    });
    return () => /* @__PURE__ */React.createElement(React.Fragment, null, /* @__PURE__ */React.createElement("style", null, `
          ...
          `), /* @__PURE__ */React.createElement("div", null, props.saveTableHead && /* @__PURE__ */React.createElement(_CustomHead.default, {
      ...
      type: "selection",
      width: "55"
    }), filterHeader.value.map((item, index) => /* @__PURE__ */React.createElement(_elementPlus.ElTableColumn, {
      ...
      header: scope => {
        if (tableHead_1.value[index].tool_content) {
          return /* @__PURE__ */React.createElement("div", {
            ...
            class: "nowarp",
            title: item.label
          }, scope.column.label), /* @__PURE__ */React.createElement(_elementPlus.ElTooltip, {
            placement: "bottom",
            "v-slots": {
