...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => /* @__PURE__ */ React.createElement("div", { class: "young-drap-list" }, /* @__PURE__ */ React.createElement("style", null, `
          .young-drag-list {
            list-style: none;
          }
          ...
          `), props.list.map((item, index) => /* @__PURE__ */ React.createElement("div", { class: `young-drag-list-item ${item.check ? "active" : ""}`, key: item.label }, /* @__PURE__ */ React.createElement("div", { class: "draggable", title: "\u62D6\u52A8\u53EF\u6392\u5E8F" }, /* @__PURE__ */ React.createElement(
      "svg",
      {
        class: "icon",
      ...
      /* @__PURE__ */ React.createElement(ElSwitch, { modelValue: item.check })
    ))));
  }
});
