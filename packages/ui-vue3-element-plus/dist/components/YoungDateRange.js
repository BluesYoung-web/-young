...
var _default = (0, _vue.defineComponent)({
  ...
  setup(props, {
    ...
    return () => /* @__PURE__ */React.createElement(_elementPlus.ElDatePicker, {
      ...attrs,
      modelValue: datePicker.value,
      type: props.second ? "datetimerange" : "daterange",
      "start-placeholder": "\u5F00\u59CB\u65E5\u671F",
      "end-placeholder": "\u7ED3\u675F\u65E5\u671F",
      "default-time": (0, _utils.recentDay)(),
      shortcuts: props.shortcuts ? (0, _utils.isArray)(props.shortcuts) ? props.shortcuts : shortcuts : void 0,
      clearable: true,
