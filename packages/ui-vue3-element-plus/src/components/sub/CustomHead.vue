<!--
 * @Author: zhangyang
 * @Date: 2023-09-20 16:08:55
 * @LastEditTime: 2023-09-20 17:32:58
 * @Description: 
-->
...
const emit = defineEmits<{
  (e: 'drag-end', v: TableHeadItemPro[]): void;
...
<template>
  <div v-bind="$attrs" class="headctrl">
    <ElTooltip content="自定义表头设置">
      <svg xmlns='http://www.w3.org/2000/svg' width='1.5rem' height='1.5rem' viewBox='0 0 24 24' style="cursor: pointer;"
  ...
  <ElDrawer v-model="showPopover" :with-header="false" :size="ltSm ? '75%' : '30%'">
    <div>
