 ...
 * @LastEditTime: 2023-05-11 18:57:50
 * @Description:
 */
...
import { ElTable, ElTableColumn, ElTooltip, ElPopover, ElCheckboxGroup, ElCheckbox } from 'element-plus';
...
export default defineComponent({
  ...
  setup(props, { emit, attrs, slots }) {
    ...
    const changeHead = (heads: string[]) => {
      // @ts-ignore
      tableHead_1.value = props.tableHead.filter((item) => !item.only_export && heads.includes(item.prop as string));
    };
